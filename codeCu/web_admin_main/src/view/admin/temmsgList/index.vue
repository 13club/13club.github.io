<template>
  <div class="block">
    <div class="block control-box">
      <el-input v-model="pageData.name" placeholder="模板名称" size="middle" clearable></el-input>
      <el-input v-model="pageData.appName" placeholder="店铺名称" size="middle" clearable></el-input>
      <el-select v-model="pageData.scope" placeholder="模板用途" clearable>
      ...
      <el-button type="primary" @click="add" class="permission" data-py="xjmbxx">新建模板消息</el-button>
    </div>
    ...
    <div class="block">
      <el-table :data="formData.list" style="width: 100%">
        ...
        <el-table-column prop="name" label="模板消息名称"></el-table-column>
...
<script lang="ts" src="./TemmsgList.ts"></script>

<style lang="scss" scoped type="text/css" src="./TemmsgList.scss"></style>
