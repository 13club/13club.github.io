<template>
  <div class="access">
      ...
      <div class="control-box">
          课程名称：
        <el-input v-model="pageData.title" placeholder="请输入课程完整名称" clearable size="middle" />
          渠道名称：
        <el-input v-model="pageData.channelName" placeholder="请输入课程渠道名称" clearable size="middle" />
        统计时间： <el-date-picker
          v-model="time"
          type="daterange"
          align="right"
        ...
        访客：
          ...
          <el-radio-group v-model="sortField" @change="changeSortField">
            <el-radio-button label="userProfit">利润</el-radio-button>
       ...
       <el-table :data="pageData.tableData" border style="width: 100%; font-size: 12px; color: #000;">
        ...
        <el-table-column prop="providerName" label="课程来源"></el-table-column>
        ...
        <el-table-column prop="userProfit" label="利润">
          <template scope="scope">
            {{(scope.row.userProfit/100).toFixed(2)}}
          </template>
        </el-table-column>
      </el-table>
