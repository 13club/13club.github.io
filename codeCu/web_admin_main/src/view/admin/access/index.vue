<template>
  <div class="access">
      <p class="remark">数据明细 <span class="blue"> 数据截止到一小时前</span></p>
      ...
      <div class="control-box">
       ...
       <el-table :data="summary" border style="width: 100%">
      ...
      <el-table :data="pageData.tableData" border style="width: 100%; font-size: 12px; color: #000;">
            ...
            <el-table-column prop="orderedUserNum" label="下单访客" />
            <el-table-column prop="paidUserNum" label="付款访客" />
            <el-table-column prop="paidOrderNum" label="付款订单数" />
            <el-table-column prop="paidFee" label="付款金额" >
                <template scope="scope">
                    {{(scope.row.paidFee/100).toFixed(2)}}
                </template>
            ...
            <el-table-column prop="arpu" label="用户ARPU值" >
                <template scope="scope">
