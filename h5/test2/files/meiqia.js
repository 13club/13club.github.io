!function(e) {
    ...
    i(14))
      ...
      , ae = function(e, t, i) {
        ...
        te["default"])() : t.manualInit ? i.init && (0,
        b["default"])() : (0,
        b["default"])()
    };
    window._MEIQIA_KNOCKOFF || !function() {
        ...
        H["default"])(),
        (0,
        Z.InitBlacklist)().then(function() {
            (0,
            Z.throttle)("/visit/init").timeout(500).then(function() {
                ae(!0, v["default"], e)
            }, function(t) {
                ae(!1, v["default"], e)
            })
        ...
        e.showPanel && G["default"].on("ready", function() {
            var t = "callWidget^@#"
        ...
        ,
        e.hidePanel && G["default"].on("ready", function() {
            (0,
            N["default"])("hide"),
            (0,
            S["default"])()
        ...
        ,
        e.metadata && G["default"].on("ready", function() {
        ...
        v["default"].messenger.listen(function(t) {
            ...
            !function() {
                ...
                case "cookies":
                    ...
                    ne.getTrackId)("MEIQIA_EXTRA_TRACK_ID"),
                    v["default"].panelVisibility = n.panelVisibility,
                    n.trackId && (v["default"].history = !0),
                    (0,
                    U["default"])(),
                    v["default"].clientId ? q["default"].getBinding() : (0,
                    y["default"])();
                    break;
                case "chatReady":
                    ...
                    if (v["default"].trackId && a) {
                        var o = {
                            ...
                            isTrackTrusted: v["default"].isTrackTrusted
                        };
                        ...
                        C["default"])(v["default"].initData.visitor_status_agent_token),
                        ...
                        (0,
                        w["default"])(v["default"].initData.servability),
                        G["default"].emit("ready")
                    } else
                        (0,
                        b["default"])();
                    break;
                ...
                case "hidePanel":
                    ...
                    break;
                case "showPanel":
                    "invisible" !== v["default"].panelVisibility && "force" !== t[1] || ((0,
                    S["default"])("hide"),
                    (0,
                    N["default"])());
                    break;
                case "conversation":
                    ...
                    J["default"])() : "yes" === v["default"].conversation && (0,
                    K["default"])();
                    break;
                case "newMsg":
                    if ("invisible" === v["default"].panelVisibility) {
                        ...
                        v["default"].messenger.targets.iframe1.send("handleUnread^@#" + JSON.stringify(c)),
                        (0,
                        M["default"])(t[1])
                    }
                    break;
                case "inviting":
                    ...
                    C["default"])(t[1]) : (v["default"].agentToken = t[1],
                ...
                case "pinScroll":
                    ...
                    p["default"])(t[1], "bottom", d) : (0,
                    p["default"])(t[1], "bottom", d);
                    break;
                ...
                case "akjSaveInfo":
                    (0,
                    ie.saveVisitInfo)(v["default"], window.location.hostname);
                    break;
                case "akjDelCookies":
                    (0,
                    ie.delAkjCookie)(window.location.hostname);
                    break;
                case "compHeight":
                    ...
                    setTimeout(function() {
                        var e = window.innerHeight
                          , t = Math.abs(u - e);
                        t < 200 && t > 0 ? (v["default"].messenger.targets.iframe1.send("scrollFix^@#300"),
                        setTimeout(function() {
                            window.scrollTo(0, 0)
                        }, 200)) : v["default"].messenger.targets.iframe1.send("scrollFix^@#10")
                    }, 300);
                    break;
                case "fixWxScroll":
                    window.scrollTo(0, 0)
...
, function(e, t, i) {
    ...
    !function(o, r) {
        ...
        var e, t, i = Array, n = i.prototype, a = Object, r = a.prototype, s = Function, l = s.prototype, c = String, p = c.prototype, d = Number, u = d.prototype, f = n.slice, v = n.splice, h = n.push, g = n.unshift, m = n.concat, b = n.join, I = l.call, y = l.apply, x = Math.max, E = Math.min, _ = r.toString, w = "function" == typeof Symbol && "symbol" === o(Symbol.toStringTag), k = Function.prototype.toString, T = /^\s*class /, A = function(e) {
            try {
                var t = k.call(e)
                  , i = t.replace(/\/\/.*\n/g, "")
                  , n = i.replace(/\/\*[.\s\S]*\*\//g, "")
        ...
        var _e = !K({
          ...
          , Me = function() {
            ...
            for (var e in window)
                try {
                    !Ae["$" + e] && H(window, e) && null !== window[e] && "object" === o(window[e]) && Te(window[e])
                } catch (t) {
                    return !0
                }
            return !1
        ...
        var $e, De, Ve = 0 !== new Date((-0xc782b5b342b24)).getUTCMonth(), Pe = new Date((-0x55d318d56a724)), Ue = new Date(14496624e5), Fe = "Mon, 01 Jan -45875 11:59:59 GMT" !== Pe.toUTCString(), He = Pe.getTimezoneOffset();
        He < -720 ? ($e = "Tue Jan 02 -45875" !== Pe.toDateString(),
        De = !/^Thu Dec 10 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(Ue.toString())) : ($e = "Mon Jan 01 -45875" !== Pe.toDateString(),
        De = !/^Wed Dec 09 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(Ue.toString()));
        ...
        (Ve || De) && (Date.prototype.toString = function() {
            if (!(this && this instanceof Date))
                throw new TypeError("this is not a Date object.");
            var e = this.getDay()
              , t = this.getDate()
                ...
                if (!i("json")) {
                        ...
                        var N = {
                          ...
                          , R = function W(e, t, i, n, a, r, s) {
                            ...
                            if ("object" == ("undefined" == typeof l ? "undefined" : o(l)) && l)
                                if (c = I.call(l),
                                c != _ || h.call(l, "toJSON"))
                                    "function" == typeof l.toJSON && (c != w && c != k && c != T || h.call(l, "toJSON")) && (l = l.toJSON(e));
                                else if (l > -1 / 0 && l < 1 / 0) {
                                    if (Q) {
                                        for (f = B(l / 864e5),
                        ...
                        t.stringify = function(e, t, i) {
                            ...
                            if (i)
                                if ((s = I.call(i)) == w) {
                                    ...
                                    s == k && (n = i.length <= 10 ? i : i.slice(0, 10));
                            return R("", (c = {},
                            c[""] = e,
                            c), a, r, n, "", [])
                        }
                    ...
                    if (!i("json-parse")) {
                        var $, D, V = a.fromCharCode, P = {
                            ...
                            for (var e, t, i, n, a, o = D, r = o.length; $ < r; )
...
, function(e, t, i) {
    ...
    t["default"] = function() {
        document.getElementById("MEIQIA-PANEL-HOLDER") || d["default"].jsonp({
            ...
            data: {
                ent_id: b["default"].entId,
                track_id: b["default"].trackId || "",
                title: b["default"].title,
                url: b["default"].url,
                referrer_url: b["default"].referrer
            },
            callback: "jsonp_cb",
            success: function(e) {
                if (e.success && !e.black) {
                    b["default"].visitId = e.visit_id,
                    b["default"].browserId = e.browser_id,
                    e.track_id && (b["default"].trackId = e.track_id,
                    b["default"].isTrackTrusted = !0);
                    var t = new Date;
                    ...
                    (0,
                    O.setTrackId)(b["default"], "MEIQIA_EXTRA_TRACK_ID"),
                    b["default"].clientId && !b["default"].clientBind && N["default"].getBinding(),
                    b["default"].initData = e,
                    b["default"].assign && (b["default"].initData.agentTokens = b["default"].assign.agentToken);
                    var i = (0,
                    g["default"])("icon-css", {
                        cdn: o["default"].cdn,
                        tail: o["default"].tail
                    });
                    s["default"].isMobile() ? (b["default"].panelVisibility = "invisible",
                    (0,
                    M["default"])("invisible"),
                    (0,
                    y["default"])("init"),
                    "round" !== e.widget_settings.mobile.btn.type && "call" !== e.widget_settings.mobile.btn.type || (i = (0,
                    g["default"])("icon-round-css", {
                        cdn: o["default"].cdn,
                        tail: o["default"].tail
                    }))) : (4 === e.visitor_status || e.in_queue || (b["default"].panelVisibility = "invisible",
                    (0,
                    M["default"])("invisible")),
                    ...
                    (0,
                    E["default"])(),
                    b["default"].withoutBtn || (0,
                    w["default"])(),
                    "function" != typeof b["default"].getInviting && (0,
                    T["default"])(),
                    b["default"].metadata && (0,
                    C["default"])(),
                    "overseas" === b["default"].initData.enterprise_info.location && (b["default"].initData.widget_settings.removeBrand = "open")
                }
            }
        })
    }
...
, function(e, t, i) {
    ...
    t["default"] = function() {
        ...
        t || (n = s["default"].isIE(6) || s["default"].isIE(7) || s["default"].isIE(8) || s["default"].isIE(9) ? "zh" !== h["default"].language && h["default"].language ? o["default"].widget + "/desktop-" + i.desktop.panel.type + "-basic-" + h["default"].language + ".html?" + o["default"].tail : o["default"].widget + "/desktop-" + i.desktop.panel.type + "-basic.html?" + o["default"].tail : "zh" !== h["default"].language && h["default"].language ? o["default"].widget + "/desktop-" + i.desktop.panel.type + "-" + h["default"].language + ".html?" + o["default"].tail : o["default"].widget + "/desktop-" + i.desktop.panel.type + ".html?" + o["default"].tail,
                ...
                "open" === t.auto.accept.status && (window._MEIQIA_AUTO_ACCEPT_INVITATION_TIMEOUT = setTimeout(function() {
                    if ("no" === o["default"].conversation) {
                        var e = {
                            ...
                            groupToken: null,
                            inviteFrom: "sys_invite_sys_accept"
                        };
            ...
            "manual" === o["default"].inviteType && clearTimeout(window._MEIQIA_ACCEPT_INVITE_TIMEOUT)) : "none" === e ? i.style.display = "none" : "invisible" === o["default"].panelVisibility && "no" === o["default"].conversation && ("manual" === o["default"].inviteType && "open" === t.manual.accept.status && (window._MEIQIA_ACCEPT_INVITE_TIMEOUT = setTimeout(function() {
                if ("invisible" === o["default"].panelVisibility && "no" === o["default"].conversation) {
                    var e = {
                        ...
                        agentToken: o["default"].agentToken,
                        groupToken: null,
                        inviteFrom: "agent_invite_sys_accept"
                    };
                    o["default"].messenger.targets.iframe1.send("callWidget^@#" + JSON.stringify(e))
                }
        ...
        var b = function() {
            ...
            6 === a ? document.getElementById("MEIQIA-INVITE").addEventListener("click", function(e) {
                ...
                "meiqiaInviteAccept" === e.target.name) {
                    ...
                    g.groupToken = null);
                    var t = {
                        auto: "sys_invite_cutomer_accept",
                        manual: "agent_invite_cutomer_accept"
                    };
                    if (g.inviteFrom = t[m["default"].inviteType],
                    "callwidget" === (0,
                    I["default"])(m["default"]))
                        return;
            ...
            window._MEIQIA_INVITATION_TIMEOUT = setTimeout(function() {
                ...
                "open" === t.auto.accept.status && (window._MEIQIA_AUTO_ACCEPT_INVITATION_TIMEOUT = setTimeout(function() {
                    ...
                    g.inviteFrom = "sys_invite_sys_accept",
                    m["default"].assign && (m["default"].assign.agentToken && (g.agentToken = m["default"].assign.agentToken),
                    m["default"].assign.groupToken && (g.groupToken = m["default"].assign.groupToken)),
                    m["default"].messenger.targets.iframe1.send("callWidget^@#" + JSON.stringify(g)))
                }, 1e3 * parseInt(t.auto.accept.countdown)))
...
, function(e, t, i) {
    ...
    t.setTrackId = t.getTrackId = void 0;
    var a = i(12)
      , o = n(a)
      , r = i(13)
      , s = n(r)
      , l = function(e) {
        return (0,
        s["default"])("get", e) || o["default"].get(e) || ""
    }
      , c = function(e, t) {
        e.isTrackTrusted && (o["default"].set(t, e.trackId, {
            expires: 1 / 0
        }),
        (0,
        s["default"])("set", t, e.trackId))
    };
    t.getTrackId = l,
    t.setTrackId = c
}
...
, function(e, t, i) {
    ...
    !function() {
        ...
        o("akj-leave-msg", function(e, t) {
            ...
            i.$escape)
              , r = "";
            return r += '<div id="ticketV2" class="active akj-wrap"> <p class="akj-text">算算我家装修多少钱?</p> <ul class="akj-order"> <li> <select placeholder="请输入您的城市" value="" id="akj-city-ticket"> ',
            n(a, function(e, t) {
                r += ' <option value="',
                r += o(e.key),
                r += '">',
            ...
            r += ' </select> </li> <li> <input type="text" value="" placeholder="您的称呼" id="akj-name-ticket" /> </li> <li> <input type="tel" value="" placeholder="联系方式，以便给您报价" id="akj-tel-ticket" /> </li> <li> <button id="akj-sub">立即获取报价</button> </li> </ul> </div>',
            new h(r)
        }),
        o("akj-order", function(e, t) {
            ...
            c += o(r),
            c += ' </div> <p class="akj-text">算算我家装修多少钱?</p> <ul class="akj-order"> <li> <select placeholder="请输入您的城市" id="akj-city"> ',
            s(l, function(e, t) {
                c += ' <option value="',
                c += n(e.key),
                c += '">',
            ...
            c += ' </select> </li> <li> <input type="text" placeholder="您的称呼" id="akj-name" /> </li> <li> <input type="tel" placeholder="联系方式，以便给您报价" id="akj-tel" /> </li> <li> <button id="akj-sub">立即获取报价</button> </li> </ul> </div>',
            new h(c)
        }),
...
, function(e, t, i) {
    ...
    !function() {
        ...
        o("features", function(e, t) {
            ...
            return n && (s += ' <a id="emojiBtn" class="feature-btn" title="表情"> <i class="icon icon-emoji"></i> </a> '),
            s += " ",
            a && (s += ' <label id="photoBtn" for="photoFile" class="feature-btn" title="发送图片"> <i class="icon icon-photo"></i> <input id="photoFile" type="file" accept="image/*"> </label> '),
            s += " ",
            o && (s += ' <label id="uploadBtn" class="feature-btn" title="发送文件"> <i class="icon-desktop icon-upload"></i> <input id="uploadFile" type="file"> </label> '),
            s += " ",
            r && (s += ' <a id="evaluationBtn" class="feature-btn" title="评价"> <i class="icon icon-evaluation"></i> </a> '),
            s += " ",
            new h(s)
        ...
        o("msg", function(e, t) {
            ...
            c += a(n.extra.convert_size),
            c += '</span> </div> <div class="sub"> ',
            n.uploading ? (c += ' <span id="progress',
            c += a(n.id),
            c += '" class="progress-holder"> <span class="progress-bg"> <span id="progressBar',
            c += a(n.id),
            c += '" class="progress-bar"></span> </span> </span> <a id="cancelUpload',
            c += a(n.id),
            c += '" class="btn-cancel-upload"> <i class="icon icon-cancel-upload"></i> </a> <span id="fileState',
            c += a(n.id),
            c += '" class="file-state">上传中&nbsp;<span id="speed',
            c += a(n.id),
            c += '"></span></span> ') : (c += " ",
        ...
        o("icon-css", function(e, t) {
            ...
            r += n(o),
            r += "'); background-size: 44px auto; background-repeat: no-repeat; } .icon-desktop { background-image: url('",
            r += n(a),
            r += "/images/icon-desktop.png?v=",
            r += n(o),
            r += "'); background-size: 44px auto; background-repeat: no-repeat; } .emoji-control { background-image: url('",
...
, function(e, t, i) {
    ...
    !function() {
        ...
        o("features", function(e, t) {
            ...
            return n && (s += ' <a id="emojiBtn" class="feature-btn" title="Emoji"> <i class="icon icon-emoji"></i> </a> '),
            s += " ",
            a && (s += ' <label id="photoBtn" for="photoFile" class="feature-btn" title="Picture"> <i class="icon icon-photo"></i> <input id="photoFile" type="file" accept="image/*"> </label> '),
            s += " ",
            o && (s += ' <label id="uploadBtn" class="feature-btn" title="发送文件"> <i class="icon-desktop icon-upload"></i> <input id="uploadFile" type="file"> </label> '),
            s += " ",
            r && (s += ' <a id="evaluationBtn" class="feature-btn" title="Service evaluation"> <i class="icon icon-evaluation"></i> </a> '),
        ...
        o("msg", function(e, t) {
            ...
            c += '" class="btn-cancel-upload"> <i class="icon icon-cancel-upload"></i> </a> <span id="fileState',
            c += a(n.id),
            c += '" class="file-state">uploading&nbsp;<span id="speed',
            c += a(n.id),
            c += '"></span></span> ') : (c += " ",
...
, function(e, t, i) {
    ...
    !function() {
        ...
        o("features", function(e, t) {
            ...
            return n && (s += ' <a id="emojiBtn" class="feature-btn" title="表情"> <i class="icon icon-emoji"></i> </a> '),
            s += " ",
            a && (s += ' <label id="photoBtn" for="photoFile" class="feature-btn" title="發送圖片"> <i class="icon icon-photo"></i> <input id="photoFile" type="file" accept="image/*"> </label> '),
            s += " ",
            o && (s += ' <label id="uploadBtn" class="feature-btn" title="发送文件"> <i class="icon-desktop icon-upload"></i> <input id="uploadFile" type="file"> </label> '),
            s += " ",
            r && (s += ' <a id="evaluationBtn" class="feature-btn" title="評價"> <i class="icon icon-evaluation"></i> </a> '),
        ...
        o("msg", function(e, t) {
            ...
            return n(a, function(e, t) {
                ...
                l += "</div> "),
                l += " ",
                "welcome" === e.content_type ? (l += ' <div class="bubble rich-text-bubble"> <span class="arrow-bg"></span> <span class="arrow"></span> <div class="text"> ',
                l += r(e.content),
                l += " </div> </div> ") : "text" === e.content_type || "bot" === e.content_type ? (l += ' <div class="bubble rich-text-bubble"> <span class="arrow-bg"></span> <span class="arrow"></span> ',
                e.content_robot && e.content_robot.length ? (l += " ",
                n(e.content_robot, function(e, t) {
                    l += " ",
                    "text" === e.type ? (l += " ",
                    e.rich_text ? (l += ' <div class="text rich-text">',
                    l += r(e.rich_text),
                    l += "</div> ") : (l += ' <div class="text">',
                    l += r(e.text),
                    l += "</div> "),
                    l += " ") : "menu" !== e.type && "related" !== e.type || (l += ' <div class="menu"> ',
                    e.text_before && (l += ' <div class="menu-tips">',
                    l += o(e.text_before),
                    l += "</div> "),
                    l += " ",
                ...
                l += " </div> ") : "agent" === e.from_type && (l += ' <div id="',
                l += o(e.id),
                l += '" class="msg-agent"> <div class="agent-avatar"> <img src="',
                l += o(e.agent.avatar),
                l += '" /> </div> ',
                e.displayDate && (l += ' <div id="date',
                l += o(e.id),
                ...
                "welcome" === e.content_type ? (l += ' <div class="bubble rich-text-bubble"> <span class="arrow-bg"></span> <span class="arrow"></span> <div class="text">',
                l += r(e.content),
                l += "</div> </div> ") : "text" === e.content_type ? (l += ' <div class="bubble rich-text-bubble"> <span class="arrow-bg"></span> <span class="arrow"></span> <div class="text">',
                l += r(e.content),
                l += "</div> </div> ") : "rich_text" === e.content_type ? (l += ' <div class="bubble rich-text-bubble"> <span class="arrow-bg"></span> <span class="arrow"></span> <div class="text rich_text">',
                l += r(e.extra.content),
                l += "</div> </div> ") : "photo" === e.content_type ? (l += ' <div class="photo"> <a href="',
                ...
                l += "</div> "),
                l += " ",
                "text" === e.content_type ? (l += ' <div class="bubble rich-text-bubble"> <span class="arrow"></span> <div class="text">',
                l += r(e.content),
                l += "</div> ",
                "sending" === e.status && (l += ' <span id="status',
                l += o(e.id),
    ...
    (function(t) {
        ...
        e.exports = function() {
            ...
            o.prototype._settlePromise = function(e, t, i, a) {
                ...
                O(t).call(i, a) === N && e._reject(N.e)) : t === d ? e._fulfill(d.call(i)) : i instanceof n ? i._promiseCancelled(e) : r || e instanceof k ? e._cancel() : i.cancel()) : "function" == typeof t ? r ? (l && e._setAsyncGuaranteed(),
...
, function(e, t, i) {
    (function(t, n) {
        ...
        function s(e) {
            return "function" == typeof e || "object" === ("undefined" == typeof e ? "undefined" : A(e)) && null !== e
        }
        function l(e) {
        ...
        function b(e) {
            return e instanceof Error || null !== e && "object" === ("undefined" == typeof e ? "undefined" : A(e)) && "string" == typeof e.message && "string" == typeof e.name
        }
        function I(e) {
            try {
                d(e, "isOperational", !0)
        ...
        , M = i(61), B = "undefined" == typeof navigator, C = {
            e: {}
        ...
        if ("undefined" != typeof Symbol && Symbol.iterator) {
            ...
            ;
            $ = function(e) {
                return M.isArray(e) ? e : null != e && "function" == typeof e[Symbol.iterator] ? D(e) : null
            }
        }
        var V = "undefined" != typeof n && "[object process]" === E(n).toLowerCase()
...
, function(e, t, i) {
    ...
    ).call(t, i(64).setImmediate, i(64).clearImmediate)
}
, function(e, t) {
    "use strict";
...
, function(e, t, i) {
    ...
    var o, r, s = i(61), l = s.freeze, c = i(60), p = c.inherits, d = c.notEnumerableProp, u = n("Warning", "warning"), f = n("CancellationError", "cancellation error"), v = n("TimeoutError", "timeout error"), h = n("AggregateError", "aggregate error");
    try {
        o = TypeError,
        r = RangeError
    } catch (g) {
        ...
        e.exports = function(e, a) {
            ...
            function s(e, t, i) {
                ...
                try {
                    e(t, i, function(e) {
                        if ("function" != typeof e)
                            throw new TypeError("onCancel must be a function, got: " + V.toString(e));
            ...
            function g(e, t) {
                if (P(e)) {
                    ...
                    void 0 !== i)
                        ...
                        var n = k(e);
                        V.notEnumerableProp(e, "stack", n.message + "\n" + n.stack.join("\n")),
            ...
            var S, j, L, R = e._getDomain, $ = e._async, D = i(66).Warning, V = i(60), P = V.canAttachTrace, U = /[\\\/]bluebird[\\\/]js[\\\/](release|debug|instrumented)/, F = /\((?:timers\.js):\d+:\d+\)/, H = /[\/<\(](.+?):(\d+):(\d+)\)?\s*$/, z = null, q = null, W = !1, G = !(0 == V.env("BLUEBIRD_DEBUG") || !V.env("BLUEBIRD_DEBUG") && "development" !== V.env("NODE_ENV")), Y = !(0 == V.env("BLUEBIRD_WARNINGS") || !G && !V.env("BLUEBIRD_WARNINGS")), J = !(0 == V.env("BLUEBIRD_LONG_STACK_TRACES") || !G && !V.env("BLUEBIRD_LONG_STACK_TRACES")), X = 0 != V.env("BLUEBIRD_W_FORGOTTEN_RETURN") && (Y || !!V.env("BLUEBIRD_W_FORGOTTEN_RETURN"));
            ...
            e.prototype._notifyUnhandledRejectionIsHandled = function() {
                A("rejectionHandled", S, void 0, this)
            }
            ,
            ...
            e.onUnhandledRejectionHandled = function(e) {
                var t = R();
                S = "function" == typeof e ? null === t ? e : V.domainBind(t, e) : void 0
            }
            ;
            var K = function() {};
                ...
                try {
                    if ("function" == typeof CustomEvent) {
                        ...
                        function(e, t) {
                            ...
                            return !V.global.dispatchEvent(i)
                        }
                    }
              ...
              , ee = function() {
                ...
                : V.global ? function(e) {
                    var t = "on" + e.toLowerCase()
                      , i = V.global[t];
                    return !!i && (i.apply(V.global, [].slice.call(arguments, 1)),
                    !0)
                }
                : function() {
                    return !1
            ...
            e.config = function(t) {
                ...
                "warnings"in t) {
                    ...
                    se.warnings = !!i,
                    X = se.warnings,
                    V.isObject(i) && "wForgottenReturn"in i && (X = !!i.wForgottenReturn)
                }
            ...
            O.prototype.attachExtraTrace = function(e) {
                if (!e.__stackCleaned__) {
                    this.uncycle();
                    for (var t = k(e), i = t.message, n = [t.stack], a = this; void 0 !== a; )
                        n.push(_(a.stack.split("\n"))),
                        a = a._parent;
                    E(n),
                    x(n),
                    V.notEnumerableProp(e, "stack", y(i, n)),
                    V.notEnumerableProp(e, "__stackCleaned__", !0)
                }
            }
            ;
            ...
            ,
            V.isNode && t.stderr.isTTY ? L = function(e, t) {
                var i = t ? "[33m" : "[31m";
                console.warn(i + e + "[0m\n")
            }
            : V.isNode || "string" != typeof (new Error).stack || (L = function(e, t) {
...
, function(e, t, i) {
    ...
    e.exports = function(e, t, n, a, o, r) {
        var s, l = i(60), c = l.canEvaluate, p = l.tryCatch, d = l.errorObj;
        if (c) {
...
, function(e, t, i) {
    ...
    e.exports = function(e) {
        ...
        var l, c, p = i(60), d = p.canEvaluate, u = p.isIdentifier, f = function(e) {
...
, function(e, t, i) {
    ...
    e.exports = function(e, t) {
        ...
        function p(e, t, i, n, a) {
            for (var o = new RegExp(k(t) + "$"), r = l(e, t, o, i), s = 0, c = r.length; s < c; s += 2) {
                var p = r[s]
                  , d = r[s + 1]
                  , u = p + t;
                if (n === C)
        ...
        var u, f = {}, v = i(60), h = i(73), g = v.withAppended, m = v.maybeWrapAsError, b = v.canEvaluate, I = i(66).TypeError, y = "Async", x = {
            __isPromisified__: !0
...
, function(e, t, i) {
    ...
    e.exports = function(e, t, n, a) {
        ...
        var s, l = i(60), c = l.isObject, p = i(61);
