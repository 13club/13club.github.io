var rrxCommConfig = {
  ...
  , appConfig = {
    ...
    copyright: {
        content: "免费制作 → liao",
        textAlign: "center",
        channelUrl: "https://mp.weixin.qq.com/s/mwchBzbgreIg9A848yPG_w",
        url: "https://www.rrxiu.net/#waph",
        color: "#fff",
        bgColor: "#000"
    },
    shareInfo: {
...
$(function() {
    function a(e) {
        Cool.util.loadJs([e], function(e) {
            try {
                if ("1" !== wsiteInfo.mamfm && "1" !== wsiteInfo.mamcg && "1" !== wsiteInfo.mamsp && "0" === wsiteInfo.wxp.newReview && (coolData = {
                    result: 403,
                    msg: "审核不通过"
                }),
                "" === coolData && B === !1)
                    ...
                    if (0 === coolData.result) {
                        var g = Cool.util.getUrlParameterByName("from_code")
                          , h = Cool.util.getUrlParameterByName("qrc_code")
                          , i = c();
                        C = new WePlusLog(i,l,g,h,n,i);
                        var k = d(coolData);
                        !k.pageList || null !== k.pageList[0] && void 0 !== k.pageList[0] || (console.log(404),
                        coolData.result = 404,
                        coolData.msg = "活动不存在")
                    } else
                        403 === coolData.result && (Cool.util.checkIsPcWithoutIframe() || (window.location.href = "https://mp.weixin.qq.com/s?__biz=MzIzMzE1ODQ3Mw==&mid=100000690&idx=1&sn=af76434cc323cf7fc1ffbf2143abe0b8&chksm=6888a1945fff2882bcd93264c7019c926027614aca0910a61efc350dd3480f25b31b82d0edba#rd"));
                    $("#main").css({
                        width: width,
                        height: height
                    }),
                    "1" === m && (coolData.showVisitCount = !1);
                    var o = b()
                      , p = new RRXTachograph(c(),l,n);
                    j = new CoolApp,
                    j.createApp(o, $("#main"), coolData, Cool.util.checkIsPcWithoutIframe(), v, C, !1, "1" === n ? !0 : !1, "1" === m ? !0 : !1, {}, q, p),
                    f()
                }
            } catch (r) {
                a(x),
    ...
    function b() {
        ...
        return rrxgpara.renb && rrxgpara.rdn && (a = "https://" + rrxgpara.rdn + "/"),
        wsiteInfo.flhtps || wsiteInfo.httpsEnabled ? a.indexOf("https://") > -1 ? a : a.replace("http://", "https://") : a
    }
    function c() {
        if (appConfig.dev)
            return appConfig.interactServiceHost;
        if (q)
            return appConfig.interactServiceHost;
        var a = appConfig.interactServiceHost;
        return rrxgpara.renb && rrxgpara.rdn && (a = "https://" + rrxgpara.rdn + "/"),
        void 0 === a || null === a ? "" : wsiteInfo.flhtps || wsiteInfo.httpsEnabled ? a.indexOf("https://") > -1 ? a : a.replace("http://", "https://") : a
    }
    function d(a) {
        if (a.hasOwnProperty("pageList") && a.pageList.constructor === Object) {
            var b = [];
            for (var c in a.pageList)
                b.push(a.pageList[c]);
            a.pageList = b
        }
        return a
    ...
    function e() {
        if (appConfig.dev)
            return appConfig.cloudHost;
        if (q)
            return appConfig.cloudHost;
        if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
            return appConfig.cloudHost.replace("http://", "https://");
        var a = appConfig.cloudHost
          , b = Cool.util.isSpecDomain(a);
        if (b) {
            var c = Cool.util.getUrlSubDomain(a);
            c && (a = a.replace("://" + c, "://ns" + c),
    ...
    function f() {
        var a = function(a) {
            ...
            if ("" !== c) {
                ...
                if ("next" === c.filpType)
                    j.getAllowFlip() && j.nextPage();
                else if ("pre" === c.filpType)
                    j.getAllowFlip() && j.prePage();
                    ...
                    for (var h in f)
                        e[h] = f[h];
                    void 0 !== g && ("customer" === g.from && (e.copyright = appConfig.copyright),
                    e.copyright.from = g.from),
                    e.showVisitCount = !1,
                    j = new CoolApp;
                    var i = e.pageList[e.pageList.length - 1].id;
                    j.getApiHelper().setStartPage(i),
                    $("#main").find(".pt-wrapper .pt-pagelist").html("");
                    var l = {
                        copyrightFrom: e.copyright.from
                    };
                    j.createApp(b(), $("#main"), e, k, v, C, !1, !1, !0, l, q, tach)
                }
            }
        };
    ...
    function g() {
        for (var a = window.location.href, b = a, c = !1, d = 0; d < r.length; d++)
            a.indexOf(r[d] + "=") > -1 && (c = !0,
            b = Cool.util.removeUrlPara(b, r[d]));
        c && window.history.pushState({}, 0, b)
    }
    function h() {
        if (appConfig.dev)
            return appConfig.libHost;
        if (q)
            return appConfig.libHost;
        if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
            return appConfig.libHost.replace("http://", "https://");
    ...
    var i = h();
    "undefined" != typeof AmdLoader && AmdLoader.config({
        urlArgs: "?v=" + appConfig.version,
        baseUrl: i,
        paths: {
            "rrxiu/pluginUtils": i + "rrxiu/pluginUtils.js"
        }
    });
    var j, k = Cool.util.checkIsPc(), l = wsiteInfo.wsiteGuid, m = Cool.util.getUrlParameterByName("setting"), n = Cool.util.getUrlParameterByName("preview"), o = Cool.util.getUrlParameterByName("tpl"), p = Cool.util.getUrlParameterByName("mwa"), q = window.rrxWxMin = "1" === p ? !0 : !1;
    (window.location.href.indexOf(rrxCommConfig.wxMinDomain) > -1 || 2 === wsiteInfo.rrxfp) && !q && (window.location.href = appConfig.viewDomainFormat.replace("{guid}", wsiteInfo.wsiteGuid)),
    window.rrxDanmuJump = "danmu" === Cool.util.getUrlParameterByName("clickType"),
    window.rrxBrowserParams = {};
    for (var r = ["orderNo", "checkpay", "uid", "stid", "eid"], s = 0; s < r.length; s++)
        window.rrxBrowserParams[r[s]] = Cool.util.getUrlParameterByName(r[s]);
    if (window.startPageId = Cool.util.getUrlParameterByName("stid"),
    void 0 === window.startPageId || null === window.startPageId || "" === window.startPageId) {
        var t = "rfstid" + l
          , u = Cool.cookie.get(t);
        u && (window.startPageId = u,
        Cool.cookie.clear(t))
    }
    g(),
    k || (document.addEventListener("touchmove", function(a) {
        a.preventDefault()
    }, !1),
    $("#main").on("touchmove", function(a) {
        a.preventDefault()
    }));
    var v = Cool.util.checkIsWeixin()
      , w = ""
      , x = b() + "view/data?id=" + l + "&preview=" + n;
    "1" === wsiteInfo.mamfm && (x += "&mamfm=1"),
    "1" === wsiteInfo.mamcg && (x += "&mamcg=1"),
    "1" === wsiteInfo.mamsp && (x += "&mamsp=1",
    x = x + "&mamsphis=" + wsiteInfo.mamsphis);
    var y = e() + l + ".js"
      , z = wsiteInfo.ver;
    if (o)
        x = x + "&tpl=" + o,
        y = e() + "tpl_" + l + ".js?v=" + z,
        a(appConfig.enabledCloud ? y : x);
    else {
        y = "" === w ? y + "?v=" + z : y + "?timestamp=" + w + "&v=" + z;
        var A = appConfig.enabledCloud && 1 !== parseInt(n) && "1" !== wsiteInfo.mamfm && "1" !== wsiteInfo.mamcg && "1" !== wsiteInfo.mamsp;
        a(A ? y : x)
    }
    var B = !appConfig.enabledCloud
      , C = null
});
var CssAnimationEngine = function() {
    ...
    function f(f, g, h, i, j, k, l, m) {
        if ("" !== g) {
            (void 0 === h || null === h || isNaN(parseFloat(h))) && (h = 0),
            (void 0 === i || null === i || isNaN(parseFloat(i))) && (i = 1),
            (void 0 === j || null === j || isNaN(parseFloat(j))) && (j = 0),
            (void 0 === k || null === k || isNaN(parseFloat(k))) && (k = 0),
            l = l || !1;
            var n = f.attr("class");
            c(f, g),
            f.removeClass(g),
            ...
            setTimeout(function() {
                ...
                -1 == j ? (q = "linear",
                r = "infinite") : r = 0 === j || "0" === j ? 1 : j,
                m && "infinite" == r && (r = 1),
                l !== !1 && (h = 0);
                var o = e(i, q, h, r, p, g);
                f.css("-webkit-animation", o),
                f.css("animation", o),
                f.css("-webkit-animation-name", o + " !important"),
                f.css("animation-name", o + " !important"),
                m === !0 && f.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                    a(f, g)
                })
            }, o)
        }
    ...
    function g(f, g, h) {
        function i(f, g, h) {
            if (j < g.length) {
                ...
                f.addClass(l);
                var s = e(n, q, m, r, p, l);
                f.css("-webkit-animation", s),
                f.css("animation", s),
                f.css("-webkit-animation-name", s + " !important"),
                f.css("animation-name", s + " !important"),
                f.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                    h && a(f, l),
                    j++,
                    i(f, g, h)
                })
    ...
    function h(a, b, c, d, e, f, g, h, i) {
        ...
        d = 1e3 * parseFloat(d),
        i = i || 0,
        a.find(".textanimation").addClass(b);
        var l = a.find(".textanimation").length;
        1e3 === d && l > 30 && (d *= Math.ceil(l / 30)),
        d /= l,
        a.find(".textanimation").each(function(a, b) {
            var e = 0;
            "0" == i ? e = c + a * d : "1" == i ? e = c + (l - a - 1) * d : "2" == i && (e = c + parseInt(Math.random() * l) * d),
            $(this).removeClass("textOut"),
            $(b).css({
                webkitAnimationDelay: e + "ms",
                animationDelay: e + "ms",
                animationDuration: d + "ms",
                webkitAnimationDuration: d + "ms"
            })
        });
        ...
        a.find(".textanimation").unbind(m).bind(m, function(c) {
            ...
            h ? a.find(".element-last").empty().html(j.dom).attr("style", j.style) : b.indexOf("Out") >= 0 && $(this).addClass("textOut")
        })
    }
    function i(a) {
        var b = {};
            ...
            if ("textanimation" != e.className)
                if (e.nodeType == Node.TEXT_NODE) {
                    var f = e.nodeValue
                      , g = $(e).parent()
                      , h = i(g.attr("style"));
                    h["background-color"] && (b += "background-color:" + h["background-color"] + ";",
                    h["background-color"] = ""),
                    h["text-decoration"] && (b += "text-decoration:" + h["text-decoration"] + ";",
                    h["text-decoration"] = ""),
                    h["text-decoration-line"] && (b += "text-decoration:" + h["text-decoration-line"] + ";",
                    h["text-decoration-line"] = "");
                    var k = "";
                    b && (k = 'style="' + b + '"',
                    g.css(h)),
                    f = c(f, k),
...
!function() {
    function a(a, b) {
        ...
        for (var d = 0; d < a.length; d++)
            -1 === a[d].indexOf("?") && (a[d] = a[d] + "?v=" + appConfig.version);
        var e = new c(a,b);
        e.load()
    }
    function b() {
    ...
    window.require = a,
    window.clearRequieModuleList = b;
    var e = [];
    c.prototype = {
        load: function() {
            for (var a = this, b = function(b) {
                var c = new d(b,function() {
                    a.tempCount++,
                    a.tempCount === a.allCount && void 0 !== a.callback && a.callback()
                }
                );
                c.load()
            }, c = 0; c < a.allCount; c++)
    ...
    d.prototype = {
        ...
        getModuleInfo: function() {
            for (var a = 0; a < e.length; a++)
                if (this.moduleName == e[a].name)
                    return e[a];
            return null
        }
    }
}(window),
window.UseAmdLoaderPlugin = function(a, b, c) {
    function d(a) {
        return "3" === a || "4" === a
    }
    var e = ["演示插件11", "卡片10", "照片投票12", "秒杀10", "商品秒杀10", "定时抽奖10", "拼团抽奖10", "集赞送礼10", "助力宝箱10", "送礼10", "7天打卡10", "助力10", "PK答题10", "积分商城10", "日历签到10", "闯关答题10", "任务宝10"];
    return e.indexOf(a + b) > -1 ? !0 : d(c) && b > 10 ? !0 : !1
}
;
var Cool = {
    share: {
    ...
    util: {
        ...
        getUrlName: function() {
            ...
            results = regex.exec(location),
            (null === results || "view" === results[1]) && (regex = new RegExp(".*/([^&#?/]*)"),
            results = regex.exec(location)),
        ...
        getUrlParaObject: function(a) {
            ...
            for (var c = b[1], d = c.split("&"), e = {}, f = 0, g = d.length; g > f; f++) {
                ...
                if ((h = h.split("="))[0]) {
                    ...
                    void 0 !== j && (j = decodeURIComponent(j)),
                    i in e ? (e[i].constructor != Array && (e[i] = [e[i]]),
                    e[i].push(j)) : e[i] = j
                }
            }
            return e
        ...
        loadJs: function(a, b) {
            if (appConfig.dev)
                ...
                var c = [];
                a.constructor === String && (a = [a]),
                wsiteInfo.flhtps || wsiteInfo.httpsEnabled ? ($.each(a, function(a, b) {
                    var d = b.replace("http://", "https://");
                    c.push(d)
                }),
                require(c, b)) : ($.each(a, function(a, b) {
                    var d = b;
                    d = b.replace("https://", "http://"),
                    c.push(d)
                }),
                require(c, b))
            }
        ...
        loadCss: function(a) {
            ...
            if (appConfig.dev)
                ;
            else if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
        ...
        checkIsPc: function() {
            ...
            return b.win = 0 === c.indexOf("Win"),
            b.mac = 0 === c.indexOf("Mac"),
            b.x11 = "X11" == c || 0 === c.indexOf("Linux"),
            b.win || b.mac || b.xll ? !0 : !1
        },
        ...
        currentIsWxMinDomain: function() {
            return window.rrxCommConfig && window.rrxCommConfig.wxMinDomain && window.location.href.indexOf(window.rrxCommConfig.wxMinDomain) > -1 ? !0 : !1
        },
        ...
        loadImage: function(a, b, c) {
            ...
            try {
                ...
                var g = new Image;
                if (-1 === a.indexOf("data:image") && (g.crossOrigin = "Anonymous"),
                g.src = c ? Cool.util.hostStamp(a) : a,
                g.complete)
                    return void (void 0 !== b && b(g));
                g.onload = function() {
                    void 0 !== b && b(g)
                }
                ,
        ...
        parseJson: function(a) {
            var b = {};
            return a.constructor === String ? "" !== a && (b = JSON.parse(a)) : b = a,
            b
        },
        getPluginDomain: function(a, b) {
            ...
            if (appConfig.dev)
                ...
                d;
            if (c.currentIsWxMinDomain())
                return d;
            var e = c.removeHostName(d)
              , f = "/" + e;
            if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
                return d = wsiteInfo.assetscdn ? "https://" + wsiteInfo.assetscdn + f : appConfig.assetsHost + e;
            d = wsiteInfo.assetscdn ? "http://" + wsiteInfo.assetscdn + f : appConfig.assetsHost + e;
            var g = c.isSpecDomain(d);
            if (g) {
                var h = c.getUrlSubDomain(d);
                h && -1 === d.indexOf("://ns") && (d = d.replace("://" + h, "://ns" + h))
            }
            return d
        },
        parsePluginTheme: function(a, b, c) {
            ...
            function f(a) {
                return location.href.indexOf("https://") > -1 && (a.indexOf("://assets") > -1 ? a = wsiteInfo && wsiteInfo.assetsHost ? wsiteInfo.assetsHost + h(a) : appConfig.assetsHost + h(a) : a.indexOf("://image") > -1 ? a = appConfig.imageHost + h(a) : a.indexOf("://file") > -1 && (a = appConfig.imageHost + h(a))),
                a
            }
            function g(a) {
                var b = a.indexOf("://");
            ...
            if (!a)
                return null;
            void 0 === a.length && (a = [a]),
            b && (b += "d2" + (new Date).getDay());
            for (var i = [], j = [], k = [], l = 0; l < a.length; l++) {
                var m = []
                  , n = a[l];
                if (!n.list)
                    return;
                for (var o = 0; o < n.list.length; o++) {
                    ...
                    case "text":
                        if (p.hasOwnProperty("content")) {
                            for (var q = [], r = 0; r < p.content.length; r++) {
                                var s = p.content[r];
                                q[s.key] = s
                            }
                            m[p.key] = {
                            ...
                            p.color && (m[p.key].color = p.color)
                        } else
                            m[p.key] = p.backgroundColor;
                        break;
                    case "image":
                        d(p.key, p.src);
                        break;
                    ...
                    case "group":
                        if (p.hasOwnProperty("content"))
                            for (var t = 0; t < p.content.length; t++) {
                                var u = p.content[t];
                                switch (u.type) {
                                case "img":
                                    d(u.key, u.value);
        ...
        getBrowserUrl: function(arg, arg_val, sl) {
            ...
            if (url.match(pattern)) {
                ...
                newUrl = url.match("[?]") ? url + "&" + replaceText : url + "?" + replaceText;
            return newUrl
        },
        getImageThumb: function(a, b, c) {
            ...
            0 >= a || isNaN(a))
                return d + "700x1";
            var e = Math.ceil(a / 100);
            return "imggroup" === b && Cool.util.checkIsIphone() && (e = Math.floor(a / 100),
            e > 3 && (e = 3)),
            10 >= e ? d + 100 * e + "x1" : d + "1000x1"
        },
        getNowTimeString: function() {
            var a = new Date;
            return this.formateDate(a, "dayfull")
        },
        ...
        isHave: function(a) {
            if (this.storage) {
                for (var b = 0; b < this.storage.length; b++)
                    if (this.storage.key(b) === this.getMd5Key(a))
                        return !0;
                return !1
            }
            return !1
    ...
    cookie: {
        ...
        clear: function(a, b) {
            ...
            document.cookie = void 0 !== b && null !== b ? a + "=a; expires=" + c.toGMTString() + ";path=/;domain=" + b : a + "=a; expires=" + c.toGMTString() + ";path=/"
        },
        set: function(a, b, c) {
            var d = new Date;
            d.setTime(d.getTime() + 864e5),
            document.cookie = void 0 !== c && null !== c ? a + "=" + b + ";expires=" + d.toGMTString() + ";path=/;domain=" + c : a + "=" + b + ";expires=" + d.toGMTString() + ";path=/"
        },
        setWithoutTime: function(a, b, c, d) {
            (void 0 === c || null === c) && (c = 3650);
            var e = new Date;
            e.setTime(e.getTime() + 24 * c * 60 * 60 * 1e3),
            document.cookie = void 0 !== d && null !== d ? a + "=" + b + ";expires=" + e.toGMTString() + ";path=/;domain=" + d : a + "=" + b + ";expires=" + e.toGMTString() + ";path=/"
        },
...
window.rrxOpenWsiteTime = (new Date).getTime(),
window.userReadDepth = 1,
window.rrxdebug = !1,
window.CoolApp = {},
window.qqMapCallback = function() {
    window.isLoadQQMap = !0,
    console.log("window.qqMapCallback", window.isLoadQQMap)
}
,
function() {
    CoolApp = function() {
        function wxinit(a) {
            return Cool.util.checkIsWeixin() === !1 ? (setTimeout(handleShareUrl, 2e3),
        ...
        function getImageHost() {
            if (appConfig.dev)
                return appConfig.imageHost;
            if (_isWxMin)
                return appConfig.imageHost;
            if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
                return appConfig.imageHost.replace("http://", "https://");
        ...
        function getWxJsSign(a, b, c, d) {
            console.log("raw url", a),
            getWxJsSignTry += 1,
            getWxJsSignTry > 2 || $.get(_host + "wechat/getWxJsSign", {
                url: a,
                error: b,
                wsiteGuid: c
            }, function(a) {
                if (console.info("getWxJsSign ret", a),
                0 === a.result) {
                    var b = "2rq4nw" === c ? !0 : !1;
                    b && alert(a.sign.appId),
                    wx.config({
                        debug: b,
                        appId: a.sign.appId,
                    ...
                    wx.ready(function() {
                        checkWxMinWhenWxReady(),
                        console.info("wx.ready"),
                        registerShareNickName(),
                        setWxShareInfo(_dataObj.showShareCount ? d : d),
                        (_isPreview || getForbidShare() || "1" === wsiteInfo.mamfm) && wx.hideOptionMenu(),
                        console.info("wx.ready end")
                    }),
                    wx.error(function(a) {
                        ...
                        wsiteInfo && wsiteInfo.authBehind && wsiteInfo.wxauthedInfo && (b += wsiteInfo.wxauthedInfo.nickname);
                        var e = (Cool.util.checkIsIphone() ? "iphone" : "android",
                        formatShareUrl(getOriginUrl()));
                        getWxJsSign(e, b, c, d)
                    })
                } else
                    handleShareUrl()
            }, "json").fail(function() {
                console.info("getWxJsSign fail"),
                handleShareUrl()
            }).always(function() {})
        }
        ...
        function pushStateForReadDepth() {
            if (shareUrl && _log) {
                ...
                "" !== b && (shareUrl = Cool.util.getBrowserUrl("from_code", b, shareUrl),
                a = shareUrl),
                !Cool.util.checkIsAndroid(),
                setTimeout(function() {
                    listenPopStateEvent()
                }, 500)
            }
        ...
        function handleShareUrl() {
            if (shareUrl) {
                ...
                wsiteInfo && wsiteInfo.shareLink && (shareUrl = Cool.util.getBrowserUrl("rwslk", 1, shareUrl),
                console.log(shareUrl)),
                shareUrl = shareUrl.replace("mode=official_accounts", "mode="),
                window.rrxDanmuJump ? (shareUrl = Cool.util.removeUrlParaMutil(shareUrl, ["rrxsrc", "uid", "clickType", "clickValue", "stid"]),
                console.log(shareUrl)) : shareUrl = Cool.util.removeUrlParaMutil(shareUrl, ["rrxsrc", "uid", "clickType", "clickValue", "stid"]),
                window.hasOwnProperty("_rrxiu_pushsale") && (shareUrl = window._rrxiu_pushsale.updateShareUrl(shareUrl),
                console.log("_rrxiu_pushsale_updateshareurl", shareUrl))
            }
        }
        function getWxOpenIdByShare() {
            var a = "";
            return wsiteInfo && wsiteInfo.authBehind && wsiteInfo.wxauthedInfo && wsiteInfo.wxp && wsiteInfo.wxp.canUserShare && (a = wsiteInfo.wxauthedInfo.id),
            a
        }
            ...
            if (0 === _dataObj.result) {
                ...
                if (void 0 !== a)
                    for (var b = 0; b < a.length; b++)
                        (a[b].openShareShow === !0 || "true" === a[b].openShareShow) && dialogOpen(currentPageId, a[b].id)
            }
        }
        function setWxShareInfoWithUrl() {
            getWxJsSignTry = 0,
            getWxJsSign(formatShareUrl(), "", _dataObj.guid, !0)
        }
        function setWxShareInfo(a) {
            a === !0 || handleShareUrl(),
            console.log("ss", shareUrl),
            wx.onMenuShareTimeline({
                ...
                success: function(a) {
                    ...
                    void 0 !== _log && _log.doShare(2, getWxOpenIdByShare(), showDialogPageByShareCallback)
                },
                cancel: function(a) {
                    triggerPageEvent(currentPageId, "sysShareCallBack", {
                        method: "onMenuShareTimeline",
            ...
            wx.onMenuShareAppMessage({
                ...
                success: function(a) {
                    ...
                    void 0 !== _log && _log.doShare(3, getWxOpenIdByShare(), showDialogPageByShareCallback)
                },
                cancel: function(a) {
                    triggerPageEvent(currentPageId, "sysShareCallBack", {
                        method: "onMenuShareAppMessage",
        ...
        function checkWeixinAlert(a) {
            return Cool.util.checkIsWeixin() || appConfig.dev === !0 || a !== !0 && checkIsThirdAppLogined() ? !0 : (winAlert(getWsiteNoAuthedMsg(a)),
            !1)
        }
        function checkIsThirdAppLogined() {
            return wsiteInfo && wsiteInfo.thirdAuthLogined
        }
        function checkIsThirdAppNoLogin() {
            return wsiteInfo && wsiteInfo.thirdAuthNoLogin
        }
        function getWsiteNoAuthedMsg(a) {
            var b = "请在微信里打开";
            return wsiteInfo && wsiteInfo.noAuthedMsg && a !== !0 && (b = wsiteInfo.noAuthedMsg),
            b
        }
        function reloveTwoClickByISroll() {
            if ($page && 1 != $page.data("long"))
                return !0;
            if (null === _timeOne)
                _timeOne = (new Date).getTime();
            else {
        ...
        function createQQMap(a, b) {
            ...
            initQQMap(),
            qqMapLoadCallBack(function(c) {
                0 !== c && "0" !== c ? _isEditing && alert("地图服务加载失败，请刷新浏览器重试！") : loadQQMap(a, b)
            })
        }
        function qqMapLoadCallBack(a) {
            if (window.isLoadQQMap)
                a(0);
            else
                var b = 0
                  , c = setInterval(function() {
                    "undefined" == typeof qq || void 0 === typeof qq ? (console.info("地图服务正在加载中..."),
                    b > 1e3 && (console.info("地图服务加载失败"),
                    clearInterval(c),
                    a(1))) : (console.log("qq", qq),
                    qq && qq.maps && qq.maps.LatLng ? (window.isLoadQQMap = !0,
                    console.info("地图服务加载成功！"),
                    clearInterval(c),
                    a(0)) : console.info("qq对象加载成功，qq.maps.LatLng对象正在加载...")),
                    b++
                }, 500)
        }
        ...
        function getWCTime() {
            var a = "";
            return _isEditing ? a = window.rrxiuWsiteCrateTime : wsiteInfo.loading && (a = wsiteInfo.loading.createTime),
            a
        }
        ...
        function parseElement(a, b) {
            ...
            _isEditing ? "plugin" == a.type && (pluginIsFull(a.content.sizeType) ? g = 1240 : "菜单" == a.content.name && (e = 1240 - a.height - 2)) : "video" == a.type && a.content.isFullPlay && (a.width = f = canvasDefaultWidth,
            a.height = g = canvasRealHeight),
            c = c + "left:" + d + "px;top:" + e + "px;width:" + f + "px;",
            -1 != g && (c = c + "height:" + g + "px;"),
            void 0 !== a.zIndex && (c = c + "z-index:" + a.zIndex + ";");
            var i = 0
              , j = ""
              , k = null
              , l = null
            ...
            var o = ""
              , p = "";
            _isEditing && (o = " ele-drag ele-resize ele-rotate element-edit ",
            p = " elem-resize elem-rotate "),
            _isEditing || a.hasOwnProperty("filter") && (c += "-webkit-filter:" + a.filter.filter + ";filter:" + a.filter.filter + ";"),
            a.hasOwnProperty("display") && a.display === !1 && (c += "display:none;");
            var q = "element_" + a.id
              , r = "element ";
            _isPageThumb && (o = "",
            p = "",
            ...
            s.attr("eletype", a.type),
            _isPageThumb || s.attr("data-id", a.id),
            "img" == a.type) {
                ...
                v.attr("src", handleImgUrl(a.content.src)),
                v.css({
                ...
                if (v.css("transform", w),
                v.css("-webkit-transform", w),
                u.append(v),
                a.content.showImageBorder) {
                    if ("" !== a.content.border) {
                        var x = $("<img class='element-border'>");
                        x.attr("src", handleImgUrl(a.content.border)),
                        t.append(x)
                    }
                ...
                if (!_isEditing) {
                    ...
                    if (1 === parseInt(a.content.imageType)) {
                        if (void 0 !== a.content.imageList && 1 === a.content.imageList.length) {
                            y = parseInt(a.width, 10),
                            z = parseInt(a.height, 10);
                            for (var A = a.content.imageList[0].src, B = a.content.imageCount, C = parseInt(y, 10), D = [], E = 0; B > E; E++)
                                D.push(C * E + "px 0");
                            $.each(D, function(a, b) {
                                var c = $("<span/>");
                                c.css({
                        ...
                        void 0 !== a.content.imageList && $.each(a.content.imageList, function(a, b) {
                            var c = $("<span/>");
                            c.css({
                                width: y,
                                height: z,
                ...
                if ("" !== F) {
                    var G = "";
                    if (isLoadedSvg(F) && (G = getLoadedSvgXml(F)),
                    "" !== G) {
                        var H = handleSvgDocument(G, a.content);
                        H && s.html(wrapElement(H, a))
                    } else
                        !function(b) {
                            loadSvg(b).then(function(c, d, e) {
                                if (4 == e.readyState && 200 == e.status) {
                                    isLoadedSvg(b) || pushLoadedSvgKey(b),
                                    saveLoadedSvgXml(b, e.responseText);
                                    var f = handleSvgDocument(e.responseText, a.content);
                                    f && s.html(wrapElement(f, a))
                                }
                            }, function(a) {
                                console.error(a)
                            })
                ...
                s.html($("<canvas class='element-last' style='width:100%;height:100%;' ></canvas>"));
            else if ("div" == a.type) {
                getWCTime() > "2016-12-19 00:00:00" && (a.content = filterXSS(a.content)),
                ("[removed]" === a.content || "[/removed]" === a.content || "" === a.content) && (a.content = '<div class="element-last" style="width:100%;min-height:inherit;padding: 0 5px;word-wrap: break-word;font-size:32px;line-height:1.25"></div>'),
                _isPageThumb || s.attr("id", "inner_text_eidtor_" + a.id);
                var I = wrapElement(a.content, a)
                  , J = !1;
                a.isLongText && !_isEditing && (J = !0),
                J ? (s.html(I),
                s.css({
                    overflow: "hidden"
                })) : s.html(I);
                var K = null;
                a.isLongText && (_isEditing ? s.find(".element-box").css({
                    overflow: "auto"
                }) : (K = s.find(".element-last"),
                K.css({
                    overflow: ""
                }))),
                a.textStroke && (K || (K = s.find(".element-last")),
                a.textStroke.display ? K.css("-webkit-text-stroke", a.textStroke.width + "px " + a.textStroke.color) : K.css("-webkit-text-stroke", "0")),
                _isEditing && /Safari/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent) && (console.log("browser:safari"),
                K || (K = s.find(".element-last")),
                K.css("-webkit-user-select", "auto"))
            } else if ("input" == a.type) {
                s.attr("inputType", void 0 === a.inputType ? 1 : a.inputType),
                s.attr("required", void 0 === a.required ? !1 : a.required),
                s.attr("unique", void 0 === a.unique ? !1 : a.unique);
                var L = ""
                  , M = parseInt(a.height, 10) > 60 ? 60 : a.height;
                if (_isEditing)
                    L = "<div class='input-outer element-last' data-id=\"" + a.id + '" ',
                    L += ' style="line-height:' + M + "px;padding-left: 15px;height:" + a.height + "px;width:" + a.width + 'px;"',
                    L += ">" + a.content + "</div>";
                else {
                    L = "<div class='input-outer'>";
                    var N = "<textarea class='input-query element-last' title=\"" + a.content + '" data-id="' + a.id + '" placeholder="' + a.content + '"';
                    N += ' style="resize:none;line-height:' + M + "px;height:" + a.height + "px;width:" + a.width + 'px;"',
                    void 0 !== a.required && a.required && (N += " data-required=true "),
                    void 0 !== a.unique && a.unique && (N += " data-unique=true "),
                    N += "></textarea>",
                    L = L + N + "</div>"
                }
                ...
                if (_isEditing) {
                    ...
                    O = $('<div class="uploadImage-query uploadImage-outer element-last" data-id=' + a.id + ">"),
                    O.attr({
                ...
                if (_isEditing) {
                    ...
                    T = $('<div class="smsCheck-query smsCheck-outer element-last" data-id=' + a.id + ">"),
                    T.attr({
                        title: a.content.title,
                        "data-required": a.content.required
                    });
                ...
                a.showJoin) {
                    ...
                    _isEditing ? s.append(ha) : $.ajax({
                        ...
                        (appConfig.dev || 0 === a.result && a.data.join > 0) && (ha.html("目前已有" + a.data.join + "人参与活动"),
                        s.append(ha))
                    })
                }
            } else if ("video" == a.type) {
                var ia = parseInt(a.content.touchType)
                  , ja = ""
                  , ka = isLiveVideo(a.content.code)
                  , la = parseInt(a.content.type)
                  , ma = 1 === la && a.content.embed || 0 === la && ka;
                if (ma && !_isEditing) {
                    Cool.util.checkIsAndroid() && 1 === ia && (a.content.touchType = 0,
                    ia = 0);
                    var na = a.content.url;
                    0 === la && ka && (na = a.content.code);
                    var oa = ka ? "" : 'type="video/mp4"';
                    ja = $('<video style="object-fit: fill;" x-webkit-airplay="true" y-webkit-airplay="true" webkit-playsinline playsinline x5-video-player-type="h5" x5-video-player-fullscreen="true" class="element-last" width="' + a.width + '" height="' + a.height + '">您的浏览器不支持 video 标签。<source src="' + na + '" ' + oa + "></video>"),
                    1 === ia ? ja.attr("preload", "auto") : 0 === ia ? (ja.attr("controls", "controls"),
                    ja.attr("preload", "metadata")) : ja.attr("preload", "metadata"),
                    ja.get(0).style["object-position"] = "0px 0px",
                    void 0 === a.content.poster || ka || ja.attr("poster", a.content.poster),
                    a.click && ("loop" === a.click.type ? ja.attr("loop", "loop") : "" !== a.click.value && ja.on("ended", function() {
                        bindElementEvent(b, a)
                    }))
                } else
                    ja = $('<div class="video element-last" style="width:100%;height:100%;"/>'),
                    ma && _isEditing ? (ja.css("background-color", "#000"),
                    void 0 === a.content.poster || 0 === la && ka ? (ja.html("嵌入视频区域"),
                    ja.css("color", "#FFF"),
                    ja.css("text-align", "center"),
                    ja.css("line-height", a.height + "px")) : ja.css("background-image", "url(" + a.content.poster + ")")) : "" !== a.content.icon && ja.css("background-image", a.content.icon);
                s.html(wrapElement(ja, a))
            } else if ("tel" == a.type || "sms" == a.type) {
                var pa = $('<a  class="anchor element-last" style="cursor: default;width:100%;"/>');
                pa.css("height", a.height + "px"),
                pa.css("line-height", a.height + "px"),
                pa.attr("href", createHref(a.type, a.content.value)),
                pa.html(a.content.text),
                s.html(wrapElement(pa, a))
                ...
                _isEditing || qa.attr("id", "slider" + a.id),
                ra > 0 && qa.css("background", "url(" + handleImgUrl(a.content[0].src) + ") center center / cover"),
                qa.attr("eletype", a.eletype),
                qa.attr("autoplay", a.autoPlay),
                qa.attr("playstyle", a.playStyle),
                qa.attr("showarrow", a.showArrow),
                qa.attr("leftarrow", a.leftArrow),
                qa.attr("rightarrow", a.rightArrow);
                for (var sa = 0; ra > sa; sa++)
                    if (!_isEditing) {
                        var ta = $("<img/>");
                        ta.attr("src", handleImgUrl(a.content[sa].src)),
                        ta.attr("alt", a.content[sa].title),
                        ta.attr("elemId", a.id),
                        ta.attr("color", a.color),
                        ta.css("width", "100%"),
                        ta.css("height", "100%"),
                        ta.css("display", "none"),
                        qa.append(ta)
                ...
                if ("line" == a.content.type) {
                    ...
                    Ba.css("-webkit-mask-image", "url('" + getShape(a.content.type) + "')"),
                    Ba.css("background-color", a.content.backgroundColor),
                    Ba.css("-webkit-mask-size", "100% 100%"),
                    s.html(wrapElement(Ba, a))
                }
            else if ("html" === a.type) {
                var Ca = ""
                  , Da = "";
                a.content.scroll || _isEditing || (Ca = 'style="overflow:inherit"',
                Da = "height:100%;");
                var Ea = /iphone|ipad/gi.test(navigator.appVersion);
                a.content.fullscreen && Ea && (Da += "overflow-y:auto;"),
                "" !== Da && (Da = 'style="' + Da + '"');
                ...
                Fa += '<div class="we-canvas" ' + Ca + ">",
                Fa += '<div class="iscroll_html" ' + Da + ">",
                Fa += "<style>" + getPrefixCss(".we-canvas", a.content.css) + "</style>",
                Fa += a.content.html,
                Fa += "</div>",
                s.html(wrapElement(Fa, a))
            } else if ("audio" === a.type) {
                var Ga = $('<div class="audio element-last" style="width:100%;height:100%;"/>');
                "" !== a.content.icon && Ga.css("background-image", a.content.icon),
                "" !== a.content.url && createAudioElement(b, a.id, a),
                s.html(wrapElement(Ga, a))
            } else if ("map" === a.type) {
                var Ha = "";
                a.content.embed ? (Ha = $('<div id="qqmap-' + a.id + '" style="width: 100%;height:100%"></div>'),
                _isEditing && Ha.css("pointer-events", "none"),
                createQQMap(Ha.get(0), a.content)) : (Ha = $('<a href="javascript:void(0)" target="_blank" class="map element-last" style="width:100%;height:100%;"/>'),
                "" !== a.content.icon && Ha.css("background-image", a.content.icon),
                "" === a.content.url || _isEditing || (_isWxMin ? Ha.click(function() {
                    navigateToWxMinMap(a.content.address, a.content.title, a.content.latlng.lat, a.content.latlng.lng)
                }) : Ha.attr("href", a.content.url))),
                s.html(wrapElement(Ha, a))
            } else if ("interact" === a.type) {
                var Ia = ""
                  , Ja = a.width / 2 - 10;
                if (Ia = $("upload" === a.content.type ? "<div class='element-last'><div class='interact-entry' style='top:0px;left:" + Ja + "px'> +1</div><div class='interactIcon'><img src='" + handleImgUrl(a.content.imageUrl) + "'><div class='interactCount'>" + a.content.count + "</div></div></div>" : "<div class='element-last'><div class='interact-entry' style='top:0px;left:" + Ja + "px'> +1</div><div class='interactIcon'><i class='" + a.content.type + "'></i><div class='interactCount'>" + a.content.count + "</div></div></div>"),
                s.html(wrapElement(Ia, a)),
                !_isEditing) {
                    var Ka = getRrxiuFontCssHost() + "font_" + _dataObj.guid + ".css";
                    Cool.util.loadCss(Ka);
                    var La = _dataObj.guid + b + a.id;
                    "" !== Cool.cookie.get(La) && s.children().css("color", a.content.selectedColor || "#47B859"),
                    Ia.unbind().bind(clickEventType, function(c) {
                        return reloveTwoClickByISroll() ? void 0 === _dataObj.guid ? (winAlert("请发布系统后再操作！"),
                        !1) : ("" === Cool.cookie.get(La) && (Cool.cookie.set(La, "1"),
                        Ia.find(".interact-entry").animate({
                            top: -20,
                            opacity: 1
                        }, 800, function() {
                            $(this).fadeOut(400).remove()
                        }),
                        addInteractCount(a, b)),
                        !1) : void 0
                    })
                }
                ...
                var Pa = s.children()
                  , Qa = Pa.css("borderStyle") || "solid"
                  , Ra = Pa.css("borderWidth") || "1px"
                  , Sa = 0;
                if (!a.content.options)
                    return;
                if ($.each(a.content.options, function(b, c) {
                    var d = Ra + " " + Qa + " " + a.content.theme;
                    b === a.content.options.length - 1 && (a.content.hasOther || (d = "none"));
                    var e = "";
                    e = "checkbox" === a.type ? "<input title='" + c.value + "' class='option' data-id='" + c.id + "' type='checkbox'>" : "<input name='radioname" + a.id + "' title='" + c.value + "' class='option' data-id='" + c.id + "' type='radio'>",
                    Oa.append("<div class='option-group' style='border-bottom:" + d + "'><label class='option-label'>" + e + "<span class='span-title'>" + c.value + "</span></label></div>"),
                    Sa = c.id
                }),
                a.content.hasOther) {
                    var Ta = ""
                      , Ua = Sa + 1;
                    if (Ta = "checkbox" === a.type ? "<input title='' class='option' data-id='" + Ua + "' type='checkbox'><input class='custom-input ' style='width:80%;height:60px;background: transparent;border: none;' data-id=\"" + Ua + "\"  placeholder='请输入'/>" : "<input name='radioname" + a.id + "' title='' class='option' data-id='" + Ua + "' type='radio'><input class='custom-input ' style='width:80%;height:60px;background: transparent;border: none;' data-id=\"" + Ua + "\"  placeholder='请输入'/>",
                    Oa.append("<div class='option-group' style='border-bottom:none;'><label class='option-label' style='width:100%;'>" + Ta + "</label></div>"),
                    _isEditing)
                        Oa.css("pointer-events", "none");
                    else {
                ...
                Na.append(Oa),
                void 0 !== a.content.required && a.content.required && Na.attr("data-required", !0),
                Pa.css("borderWidth", Ra),
                Pa.css("borderStyle", Qa),
                Pa.css("borderColor", a.content.theme),
                Na.find(".option-group").off("click").on("click", function(a) {
                    if (reloveTwoClickByISroll()) {
                        a.stopPropagation();
                        var b = $(this).find(".option")
                          ...
                          , d = b.get(0).checked;
                        if ("checkbox" === c)
                            b.get(0).checked = d === !0 || "true" === d ? !1 : !0;
                        else if ("radio" === c) {
                            var e = b.attr("name");
                            $("input:radio[name='" + e + "']:checked").removeAttr("checked"),
                            b.prop("checked", !0)
                        }
                    }
                })
                ...
                if (!_isEditing) {
                    ...
                    Za.unbind().bind(clickEventType, function() {
                        if (reloveTwoClickByISroll())
                            for (var b = parseInt($(this).data("id")) - 1, c = null, d = 0; 5 > d; d++)
                                c = $(Za[d]),
                                d > b ? c.is(".selected") && (c.css("color", "inherit"),
                                c.removeClass("selected")) : (c.css("color", a.content.selectedColor),
                                c.addClass("selected"))
                    })
                }
                void 0 !== a.content.required && a.content.required && Xa.attr("data-required", !0),
                s.html(wrapElement(Xa, a)),
                s.children().css("lineHeight", a.height - 6 + "px")
            } else if ("select" === a.type) {
                if (k = $("<div style='padding-left:15px;' class='select-outer'></div>"),
                _isEditing)
                    k.html("<div class='editSelect' style='line-height:" + a.height + "px'>" + a.content.title + "<span>▼</span></div>");
                else {
                    var $a = a.content.title || "请选择"
                      , _a = "<option>" + $a + "</option>";
                    $.each(a.content.options, function(a, b) {
                        _a += "<option>" + b.value + "</option>"
                    }),
                    i = (a.height - (k.children().css("font-size") || 18)) / 2 - 4,
                    k.html("<select title='" + a.content.title + "' data-id='" + a.id + "' class='select-query element-last'>" + _a + "</select><span style='top:" + i + "px'>▼</span>")
                }
                void 0 !== a.content.required && a.content.required && k.children().attr("data-required", !0),
                s.html(wrapElement(k, a))
            } else if ("date" === a.type) {
                var ab = ""
                  , bb = Cool.util.formateDate(a.content.date) || "年-月-日";
                if (_isEditing)
                    ab = "<div class='input-outer element-last'  data-id=\"" + a.id + '" ',
                    ab += ' style="line-height:' + a.height + "px;padding-left: 15px;height:" + a.height + "px;width:" + a.width + 'px;"',
                    ab += ">" + bb + "</div>";
                else {
                    ...
                    cb += ' style="overflow: hidden;-webkit-appearance: none;-moz-appearance: none;-ms-appearance: none;appearance: none;line-height:' + a.height + "px;height:" + a.height + "px;width:" + a.width + 'px;"',
                    void 0 !== a.content.required && a.content.required && (cb += " data-required=true "),
                    cb += "></input>",
                    ab = ab + cb + "</div>"
                }
                ...
                console.log("time", a),
                k = "";
                var db = parseFloat(a.height)
                  , eb = ""
                  , fb = a.content.precise
                  , gb = "32%"
                  , hb = "32%"
                  , ib = "32%";
                if (l = "2%",
                ...
                _isEditing) {
                    ...
                    j = "<div class='time-cap editSelectTime' style='margin-right:{{marginRight}};width:{{width}};" + a.style + ";height:" + db + "px;line-height:" + db + "px'>{{options}}<span>▼</span></div>",
                    eb = compileHtml(j, {
                        options: jb,
                        width: gb,
                        marginRight: l
                    ...
                    var mb = 0
                      , nb = ""
                      , ob = '<option value="-1">时</option>'
                      , pb = '<option value="-1">分</option>'
                      , qb = '<option value="-1">秒</option>';
                    for (mb = 0; 24 > mb; mb++)
                        nb = 10 > mb ? "0" + mb : mb.toString(),
                        ob += "<option>" + nb + "时</option>";
                    for (mb = 0; 60 > mb; mb++)
                        nb = 10 > mb ? "0" + mb : mb.toString(),
                        pb += "<option>" + nb + "分</option>",
                        qb += "<option>" + nb + "秒</option>";
                    i = (db - (k.children().css("font-size") || 18)) / 2 - 5,
                    j = "<div class='time-select' style='margin-right:{{marginRight}};width:{{width}};" + a.style + ";'><select class='element-last'>{{options}}</select><span style='top:" + i + "px'>▼</span></div>",
                    eb = compileHtml(j, {
                        options: ob,
                        width: gb,
                        marginRight: l
                    ...
                    k.html(eb),
                    void 0 !== a.content.required && a.content.required && k.attr("data-required", !0)
                }
                s.html(wrapElement(k, a))
            } else if ("city" === a.type) {
                var rb = ""
                  ...
                  , tb = "0%"
                  , ub = 0;
                a.content.province.show && ub++,
                a.content.city.show && ub++,
                a.content.area.show && ub++,
                1 === ub ? tb = 100 : (2 === ub || 3 === ub) && (tb = 50);
                var vb = 0;
                _isEditing ? (k = $("<div class='select-outer'></div>"),
                j = "<div class='editSelectTime city-cap' style='{{style}};margin-right:{{marginRight}};margin-top: {{marginTop}};width:{{width}};height:{{height}};line-height:{{height}}'>{{selectName}}<span>▼</span></div>",
                a.content.province.show && (vb = a.content.city.show ? 2 : 0,
                rb = compileHtml(j, {
                ...
                a.content.city.show && (vb = !a.content.province.show && a.content.area.show ? 2 : 0,
                rb += compileHtml(j, {
                ...
                a.content.other.show && (rb += "<div class='editSelectTime city-cap' style='margin-top: 2%;width:100%;" + a.style + ";height:" + sb + "px;line-height:" + sb + "px'>" + a.content.other.value || "详细地址</div>"),
                k.html(rb)) : (k = $("<div style='padding-left: 0;' class='timeSelect-outer formCitySelect city-query' data-id='" + a.id + "' title='" + a.content.title + "' ></div>"),
                i = "20px",
                j = "<div class='time-select' style='{{style}};margin-right:{{marginRight}};margin-top: {{marginTop}};height:{{height}};width: {{width}};'><select name='{{selectName}}' class='element-last'></select><span style='top:{{top}}'>▼</span></div>",
                a.content.province.show && (vb = a.content.city.show ? 2 : 0,
                rb += compileHtml(j, {
                    selectName: "province",
                    marginTop: 0,
                ...
                a.content.other.show && (rb += "<div class='input-cap' style='border:none;margin-top: 2%;width:100%;" + a.style + ";height:" + sb + "px;line-height:" + sb + "px'><input placeholder='详细地址' value='" + a.content.other.value + "' type='text' style='background-color: inherit;padding-left: 15px;border:none;width:100%;height:94%;'></div>"),
                k.html(rb),
                void 0 !== a.content.required && a.content.required && k.attr("data-required", !0),
                Cool.util.loadJs(appConfig.libHost + "citys/jquery.citys-1.js", function() {
                    k.citys({
                ...
                var wb = $('<a  href="javasript:void(0)" class="file-element-box element-last" style="font-size:inherit;color: inherit;height:100%;cursor: default;width:100%;"/>')
                  , xb = "";
                xb = _isEditing ? "" : "<input data-id='" + a.id + "' title='" + a.content.title + "' class='file-query' type='file'/>",
                wb.html(xb + "<div class='file-content' style='pointer-events:none;height:" + a.height + "px;line-height:" + a.height + "px;'><span class='fb_plus'>+</span><p class='fb_text'>上传文件（需小于10MB）</p></div>"),
                !_isEditing && void 0 !== a.content.required && a.content.required && wb.find(".file-query").attr("data-required", !0),
                s.html(wrapElement(wb, a))
            } else if ("multiselect" === a.type) {
                k = $("<div class='timeSelect-outer formCitySelect multiselect-query' data-id='" + a.id + "' title='" + a.content.title + "' ></div>"),
                i = 20;
                var yb = 68
                  , zb = 50
                  , Ab = ""
                  , Bb = a.content.threeCount > 0;
                l = 2,
                m = 0,
                Bb && (l = 0,
                zb = 32,
                m = 2),
                _isEditing ? (k = $("<div class='select-outer'></div>"),
                j = "<div class='editSelectTime  multiselect-cap' style='" + a.style + ";margin-right:{{marginRight}};width:{{width}};height:" + yb + "px;line-height:" + yb + "px'>{{selectName}}<span>▼</span></div>",
                Ab += j.replace("{{width}}", zb - l + "%").replace("{{marginRight}}", "2%").replace("{{selectName}}", multiSelectObj.getTipValue(a.content, "one")),
                Ab += j.replace("{{width}}", zb + "%").replace("{{marginRight}}", m + "%").replace("{{selectName}}", multiSelectObj.getTipValue(a.content, "two")),
                Bb && (Ab += j.replace("{{width}}", zb + "%").replace("{{marginRight}}", 0).replace("{{selectName}}", multiSelectObj.getTipValue(a.content, "three")))) : (j = "<div class='time-select' style='" + a.style + ";margin-right:{{marginRight}};height:" + yb + "px;width:{{width}};'><select name='{{name}}'  class='element-last'>{{options}}</select><span style='top:" + i + "px'>▼</span></div>",
                Ab += compileHtml(j, {
                    name: "one",
                ...
                Cb.html(Db),
                void 0 !== a.content.required && a.content.required && Cb.attr("data-required", !0);
                var Eb = Cb.find(".goods-query")
                  , Fb = Eb.css("background-color");
                Eb.find(".gd-price-number").css("background-color", Fb),
                Eb.css("background-color", "");
                var Gb = Eb.css("border-color");
                Eb.find(".number-container").css("border-color", Gb),
                Eb.find(".number-container .num-minus").css("border-color", Gb),
                Eb.find(".number-container .num-add").css("border-color", Gb),
                s.html(wrapElement(Cb, a))
                ...
                s.html(wrapElement(Hb, a)),
                $wePluginClient.render(a, Hb, b, _isPageThumb)
            ...
            _isEditing && a.hasOwnProperty("filter") && ($(s.find(".element-box")).css("-webkit-filter", a.filter.filter),
            $(s.find(".element-box")).css("filter", a.filter.filter)),
            _isEditing || _isPageThumb || a.hasOwnProperty("sensor") && a.sensor.show && (s.children(0).css("overflow", "visible"),
            s.children(0).attr("data-depth", a.sensor.depth),
            s.children(0).addClass("layer")),
            !_isEditing && window.wxInputFocusEvent && (window.wxInputFocusEvent(s.find("input[type=text],input[type=tel]")),
            window.wxInputFocusEvent(s.find("textarea")),
            window.wxInputFocusEvent(s.find("select"))),
            s
        }
        ...
        function bindGoodsEvent(a) {
            ...
            a.find(".goods-box .num-minus").off().on("click", function() {
                reloveTwoClickByISroll() && (c = $(this).parent().find("input"),
                "readonly" !== c.attr("readonly") && (b = parseInt(c.val(), 10) - 1,
                0 > b || $(this).parent().find("input").val(b)))
            }),
            a.find(".goods-box .num-add").off().on("click", function() {
                reloveTwoClickByISroll() && (c = $(this).parent().find("input"),
                "readonly" !== c.attr("readonly") && (b = parseInt(c.val(), 10) + 1,
                $(this).parent().find("input").val(b)))
            })
        }
        ...
        function getSvgFullUrl(a) {
            return null === a || void 0 === a || "" === a ? "" : handleImgUrl(a)
        }
        function handleSvgDocument(a, b) {
            ...
            c.removeAttribute("baseProfile"),
            c.setAttribute("class", "element-last"),
            c.getAttribute("viewBox") || c.setAttribute("viewBox", g);
            for (var h = $(c), i = h.find("[fill], [style*='fill:']"), j = 0; j < b.fillColorList.length; j++)
                i.eq(j).css({
                ...
                var e = getServiceHostIfHttps()
                  , f = {
                    ...
                    onSelected: function(b, e) {
                        d.content.isForm ? (fnShowUploadImage(a, d, b),
                        c.html(d.content.title)) : e.upload()
                    },
                    onSuccess: function(b) {
                        var e = handleImgUrl(b.url);
                        fnShowUploadImage(a, d, e),
                        c.html(d.content.title),
                        !d.content.isForm && d.content.noteValue && triggerPageEvent(currentPageId, d.content.noteValue, e)
                    },
                    onFailure: function(a) {
                        c.html("加载失败"),
                        !d.content.isForm && d.content.noteValue && triggerPageEvent(currentPageId, d.content.noteValue, "")
                    }
                }
        ...
        function getRrxiuFontCssHost() {
            if (appConfig.dev)
                return appConfig.rrxiuFontCssHost;
            if (_isWxMin)
                return appConfig.rrxiuFontCssHost;
            if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
                return appConfig.rrxiuFontCssHost.replace("http://", "https://");
        ...
        function getAssetsHost() {
            if (appConfig.dev || _isEditing)
                return appConfig.assetsHost;
            if (_isWxMin)
                return appConfig.assetsHost;
            if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
                return appConfig.assetsHost.replace("http://", "https://");
            var a = appConfig.assetsHost
              , b = Cool.util.isSpecDomain(a);
            if (b) {
                var c = Cool.util.getUrlSubDomain(a);
                c && -1 === a.indexOf("://ns") && (a = a.replace("://" + c, "://ns" + c),
        ...
        function getWebFontHost() {
            if (appConfig.dev)
                return appConfig.webFontHost;
            if (_isWxMin)
                return appConfig.webFontHost;
            if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
                return appConfig.webFontHost.replace("http://", "https://");
        ...
        function getVrHost() {
            if (appConfig.dev)
                return appConfig.vrHost;
            if (_isWxMin)
                return appConfig.vrHost;
            if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
                return appConfig.vrHost.replace("http://", "https://");
        ...
        function getDataHost() {
            if (appConfig.dev)
                return appConfig.dataHost;
            if (_isWxMin)
                return appConfig.dataHost;
            var a = appConfig.dataHost;
            if (wsiteInfo && wsiteInfo.datacdn && (a = wsiteInfo.datacdn,
            a = wsiteInfo.flhtps || wsiteInfo.httpsEnabled ? "https://" + wsiteInfo.datacdn + "/" : "http://" + wsiteInfo.datacdn + "/"),
            wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
        ...
        function startTimedCount(a, b) {
            timer_count = 60,
            a.html(timer_count + "s"),
            timer_instance = setInterval(function() {
                console.log("timer_instance", 1),
                timer_count -= 1,
                0 === timer_count ? resetSMSButton(a, b) : a.html(timer_count + "s")
            }, 1e3)
        }
        ...
        function fnBindSMSEvent(a, b, c, d) {
            c.unbind().bind("click", function() {
                if (reloveTwoClickByISroll()) {
                    if (void 0 === _dataObj.guid)
                        return void winAlert("请发布系统后再操作！");
                    if (!b.data("smsAuth")) {
                        var e = a.val();
                        if (!e)
                            return void winAlert(d.content.title + "不能为空！");
                        var f = /^0?1[3|4|5|6|7|8|9][0-9]\d{8}$/;
                        return f.test(e) ? void verifyAlert(_host, _dataObj.guid, e, "", function(a) {
                            a.isVerify && (c.val("发送中..."),
                            b.data("smsAuth", a.data.guid),
                            startTimedCount(c, b))
            ...
            $.post(_host + "interactData/add", {
                ...
                if (0 === c.result) {
                    ...
                    if (d.length > 0) {
                        ...
                        e.html(f),
                        d.children().css("color", a.content.selectedColor || "#47B859"),
                        bindElementEvent(b, a)
                    }
                }
            }, "json")
        ...
        function getAllPageInteractData(a) {
            if (void 0 === _dataObj.guid || _isSetting || wsiteInfo.wsiteType > 1)
                return void a();
            var b = _dataObj.pageList;
            _dataObj.dialogList && _dataObj.dialogList.length > 0 && (b = b.concat(_dataObj.dialogList));
            for (var c = "", d = 0; d < b.length; d++) {
                var e = b[d].elementList;
                if (e)
                    for (var f = 0; f < e.length; f++)
                        "interact" === e[f].type && (c += b[d].id + "," + e[f].id + "|")
            }
            "" !== c ? (c = c.substr(0, c.length - 1),
            $.post(_host + "interactData/get", {
                form: {
                    wsiteGuid: _dataObj.guid,
                    pageElemIds: c
                }
        ...
        function getFormUseGoods(a) {
            ...
            for (var c = !1, d = 0; d < b.length && !c; d++) {
                var e = b[d].elementList;
                if (e)
                    for (var f = 0; f < e.length && !c; f++)
                        if ("goods" === e[f].type) {
                            if (c)
                                break;
                            for (var g = e[f].content.list, h = 0; h < g.length; h++)
                                1 == g[h].useStock && (c = !0)
                        }
            }
            c ? $.ajax({
                ...
                0 === c.result && updateGoodsStock(b, c.data),
                a()
            }).fail(function(b) {
                console.error(b),
                a()
        ...
        function bindElementEvent(a, b, c) {
            if (void 0 !== b.click && "" !== b.click && _isEditing === !1)
                if (c) {
                    ...
                    "share" === b.click.type || "menu" === b.click.type || "focus" === b.click.type || "closeDialog" === b.click.type ? _excuteElementEvent(a, b) : void 0 !== b.click.type && void 0 !== b.click.value && "" !== b.click.value && _excuteElementEvent(a, b)
        }
        function _excuteElementEvent(a, b) {
            if (console.log("_excuteElementEvent", b.click),
            "url" == b.click.type)
                b.click.value.length > 8 && (apiHelper.getAppInstance().interactHit("link", ""),
                setTimeout(function() {
                ...
                dialogCloseAll();
                var c = !1;
                $page && 1 == $page.data("long") && (c = !0),
                c ? setTimeout(function() {
                    goToPageById(b.click.value)
                }, 500) : goToPageById(b.click.value)
            } else if ("event" == b.click.type)
                dialogCloseAll(),
                triggerPageEvent(a, b.click.value);
            else if ("share" === b.click.type)
                dialogCloseAll(),
                apiHelper.getAppInstance().showShareDialog("");
            else if ("alert" === b.click.type)
                winAlert(b.click.value);
            else if ("focus" === b.click.type)
                dialogCloseAll(),
                showFocusWechat();
            else if ("menu" === b.click.type)
                dialogCloseAll(),
                showTopMenu();
            else if ("tel" === b.click.type)
                window.location.href = "tel:" + $.trim(b.click.value);
            else if ("sms" === b.click.type)
                window.location.href = "sms:" + $.trim(b.click.value);
            else if ("openDialog" === b.click.type)
                dialogOpen(a, b.click.value);
            else if ("closeDialog" === b.click.type)
                dialogClose(a);
            else if ("danmu" === b.click.type && (dialogCloseAll(),
            isShowDanmu()))
                if (getCommentLikeCount(),
                getCommentList(),
                wsiteInfo.authBehind) {
                    var d = apiHelper.getAppInstance().weixinStrong.getAuthedInfo();
                    "" !== d.id && null !== d.id && void 0 !== d.id && (authUserInfo = d),
                    setTimeout(function() {
                        showDanmuEvent()
                    }, 300)
        ...
        function dialogOpen(a, b) {
            ...
            setTimeout(function() {
                regPageEndEvent(b),
                pageCodeLoad(b, apiHelper.getAppInstance()),
                _isEditing || loadPluginEvent(b)
            }, 1e3)
        }
        function dialogClose(a) {
            ...
            triggerPluginLeaveEvent(a),
            triggerPageEvent(currentPageId, "sys_dialogClose", a),
            pausePageAudio(a)
        }
        ...
        function viewLinkImage(a, b) {
            "img" === a.type && a.click && "" !== a.click.image && void 0 !== a.click.image && (b.on("touchstart", function(c) {
                b.find(".element-last").attr("src", handleImgUrl(a.click.image))
            }),
            b.on("touchend", function(c) {
                setTimeout(function() {
                    b.find(".element-last").attr("src", handleImgUrl(a.content.src))
                }, 600)
            }))
        }
        function playLinkAudio(a, b, c, d) {
            c.click && "" !== c.click.audio && (d.on("mousedown touchstart", function(d) {
                ...
                f ? f.play() : (f = document.createElement("audio"),
                f.setAttribute("id", e),
                f.setAttribute("style", "opacity:0;width:1px;height:1px"),
                f.setAttribute("src", apiHelper.getAppInstance().musicPreFix(c.click.audio)),
                f.setAttribute("preload", !0),
                $("#main").append(f),
                f.play())
            }),
        ...
        function wrapElement(a, b) {
            ...
            if (_isEditing) {
                ...
                e = b.style + "width: 100%; height: 100%;",
                ("goods" === b.type || "smsCheck" === b.type || "time" === b.type || "city" === b.type || "multiselect" === b.type) && (e = "width: 100%; height: 100%;"),
                f.attr("style", e),
                f.css("position", ""),
                f.css("left", ""),
                f.css("top", ""),
                f.css("z-index", ""),
                void 0 !== b.rotate && (f.css("-webkit-transform", "rotate(" + b.rotate + "deg) translateZ(0)"),
                f.css("transform", "rotate(" + b.rotate + "deg) translateZ(0)"));
                var g = $('<div class="element-box" style="width: 100%; height: 100%;"></div>');
                return void 0 !== b.opacity && "video" !== b.type && g.css("opacity", b.opacity),
                "div" === b.type && (c = $(a),
                c.has("img").length > 0 && (d = c.find("p"),
                d.css("display", "none"),
                c.find("img").css("display", "block")),
                c.length > 0 ? a = c[0].outerHTML : console.info(b),
                g.css("vertical" === b.textDirec ? {
            ...
            var h = $("<div ></div>");
            if (e = b.style + "width: 100%; height: 100%;",
            ("goods" === b.type || "smsCheck" === b.type || "time" === b.type || "city" === b.type || "multiselect" === b.type) && (e = "width: 100%; height: 100%;"),
            h.attr("style", e),
            h.css("position", ""),
            ...
            h.css("top", ""),
            h.css("z-index", ""),
            void 0 !== b.opacity && "video" !== b.type && h.css("opacity", b.opacity),
            void 0 !== b.rotate && (h.css("-webkit-transform", "rotate(" + b.rotate + "deg) translateZ(0)"),
            h.css("transform", "rotate(" + b.rotate + "deg) translateZ(0)")),
            "div" === b.type) {
                var i = {};
                ...
                b.isLongText && (i.overflow = "",
                h.addClass("txt-long-iscroll")),
                h.css(i),
                c = $(a),
                c.has("img").length > 0 && (d = c.find("p"),
                d.css("display", "none"),
            ...
            return void 0 !== arguments[2] && "img" === b.type ? (h.addClass("image-border-two"),
            h.html(a),
            h.append(arguments[2])) : h.html(a),
            h
        }
        function submitData(a, b) {
            if (!b.hasSubmit) {
                if (b.hasSubmit = !0,
                null === _dataObj)
                    return b.hasSubmit = !1,
                    void a.val(b.content);
                ...
                if ($page) {
                    ...
                    $.each(l, function(a, b) {
                        ...
                        if ("input" === b.type || "select" === b.type || "date" === b.type || "time" === b.type || "multiselect" === b.type || "city" === b.type || "file" === b.type || "goods" === b.type ? c = getPageInputSelect(b) : "checkbox" === b.type || "radio" === b.type ? c = getPageCheckRadio(b) : "rating" === b.type ? c = getPageRating(b) : "uploadImage" == b.type && (c = getPageUploadImage(b)),
                        "goods" === b.type && "" !== c.value) {
                            if (1 === c.result)
                                return k = [],
                                winAlert(c.msg),
                                j = !0,
                                !1;
                            for (var d = JSON.parse(c.value), e = 0; e < d.length; e++)
                                m += parseFloat(d[e].price * d[e].count)
                        } else if (1 === c.result)
                            return k = [],
                            winAlert(c.msg),
                            j = !0,
                            !1;
                        g && !f && "3" == b.inputType && (f = c.value),
                    ...
                    if (!j) {
                        ...
                        $.each(o, function(a, b) {
                            ...
                            return 1 === c.result ? (winAlert(c.msg),
                            k = [],
                            n = [],
                            !1) : (g && !f && (f = c.item.value),
                            k.push(c.item),
                            void n.push(c.codeItem))
                        })
                    }
                    if (k.length > 0) {
                        var p = "";
                        if (m = parseFloat(m, 10).toFixed(2),
                        m > 0)
                            return Cool.util.checkIsWeixin() || appConfig.dev ? void winAlert("表单中有未支付的商品，您需要支付『" + m + "元』人民币。", function(d) {
                                d ? submitDataMethod(c, k, b, a, f, n, g, h, i, p) : (b.hasSubmit = !1,
                                a.val(b.content))
                            }, !0) : (winAlert("表单中有未支付的商品，需要在微信中打开！"),
                            b.hasSubmit = !1,
                            void a.val(b.content));
        ...
        function submitDataMethod(a, b, c, d, e, f, g, h, i, j) {
            uploadFileCallBack(b, function(k) {
                for (var l = 0; l < k.length; l++)
                    if (k[l].required && "" === k[l].value && ("file" === k[l].type || "uploadImage" === k[l].type))
                        return winAlert(k[l].msg ? k[l].msg : "请上传" + k[l].title),
                        c.hasSubmit = !1,
                        void d.val(c.content);
                b = k;
                ...
                $.post(getInteractServiceHostIfHttps() + "formdata/add", {
                    ...
                    if (0 === b.result) {
                        ...
                        $page.find(".input-query").val("").focus(),
                        $page.find(".custom-input").val(""),
                        $page.find(".control-outer .option").attr("checked", !1),
                        $page.find(".rating-outer .rate .selected").css("color", "inherit"),
                        $page.find(".rating-outer .rate .selected").removeClass("selected"),
                        $($page.find(".uploadImage-query .uploadImage")).remove(),
                        $page.find(".city-query").length > 1 && $page.find(".city-query").resetCityInfo(),
                        $page.find(".date-query").val(""),
                        $page.find(".date-query").removeClass("full"),
                        $page.find(".time-query .time-select select").val("-1"),
                        $page.find(".multiselect-query .time-select select").val("-1");
                        for (var g = $page.find(".file-element-box"), h = 0; h < g.length; h++)
                            resetFileInput($(g[h])),
                            $(g[h]).find(".file-content").html('<span class="fb_plus">+</span><p class="fb_text">上传文件（需小于10MB）</p>');
                        ...
                        for (var m = $page.find(".smsCheck-query"), n = 0; n < m.length; n++) {
                            ...
                            q.val("").focus(),
                            resetSMSButton(o.find(".smsButtom"), q)
                        }
                        c.hasSubmit = !1,
                        d.val(c.content),
                        bindElementEvent(a, c)
                    } else if (c.hasSubmit = !1,
                    d.val(c.content),
                    winAlert(b.msg),
                    "goods" == b.errorCode) {
                        var r = b.errorData.stock;
                        0 > r && (r = 0),
                        $("#stock-" + b.errorData.elementId + "-" + b.errorData.goodId).html(r)
                    }
                    d.focus()
                }, "json")
            })
        ...
        function uploadFileCallBack(a, b) {
            ...
            $.each(a, function(f, g) {
                "uploadImage" == g.type ? g.value.indexOf("data:image") > -1 ? (c = !0,
                fnUplaodImage(g.value, function(a) {
                    g.value = a,
                    e()
                })) : (c && d === a.length - 1 && b(a),
                d++) : "file" == g.type ? (c = !0,
                fnUploadFile(g.value, function(a) {
                    0 === a.result ? g.value = a.data.savedName : (g.value = "",
                    console.info(a),
                    g.msg = a.msg),
                    e()
                })) : (c && d === a.length - 1 && b(a),
        ...
        function fnUploadFile(a, b) {
            var c = getInteractServiceHostIfHttps()
              , d = new FormData;
            d.append("file", a),
            $.ajax({
        ...
        function controlsOrderByTop() {
            ...
            return $.each(a, function(a, c) {
                for (var e = $page.find("." + c + "-query"), f = 0; f < e.length; f++) {
                    ...
                    m = g.data("unique"),
                    n = g.attr("title"),
                    "goods" === c && (l = j.find(".element-last").data("required"));
                    var r = 0
                      , s = [];
                    if ("city" === c)
                        o = g.getCityInfoWithSplit();
                        ...
                        g.length > 0 && g[0].files && g[0].files.length > 0 && (o = g[0].files[0]);
                    else if ("goods" === c) {
                        s = g.children();
                        var v = [];
        ...
        function getPageInputSelect(a) {
            ...
            if ("input" === b) {
                ...
                if ("" !== e) {
                    if ("邮箱" === a.title && !h.test(e))
                        return {
                            result: 1,
                            msg: "输入的邮箱格式不正确！"
                        };
                    if (!("3" != a.inputType && "手机" !== a.title && "手机号" !== a.title && "手机号码" !== a.title || g.test(e)))
                        return {
                            result: 1,
                            msg: "输入的手机号码格式不正确！"
                        };
                    if ("5" == a.inputType || "身份证" === a.title || "身份证号" === a.title || "身份证号码" === a.title) {
                        var i = IdentityCodeValid(e);
                        if (1 == i.result)
                            return i
                    }
                }
                ...
                if ("" !== e) {
                    for (var j = JSON.parse(e), k = 0, l = 0; l < j.length; l++)
                        if (k += j[l].price * j[l].count,
                        1 == j[l].useStock && j[l].count > j[l].stock)
                            return {
                                result: 1,
                                msg: j[l].name + "购买数据不能大于库存数"
                            };
                    if (k > 3e3)
                        return {
                            result: 1,
                ...
                if ("city" == b) {
                    var n = $page.find(".element_" + c + " .time-select").length;
                    console.log("value", e),
                    console.log("_optionCount", n);
                    var o = e.split("-")
                      , p = "请选择" + f
                      , q = o.length
                      , r = !1;
                ...
                } else if ("multiselect" == b && e.split(",").length < 2)
                    return {
                        result: 1,
                        msg: "请完善" + f
                    }
        ...
        function getPageCheckRadio(a) {
            ...
            return d.value = "" !== e ? e.substring(0, e.length - 1) : "",
            d
        }
        ...
        function getPagesmsCheck(a) {
            var b = "";
            if (!a.value)
                return b = a.title + "不能为空！",
                {
                    result: 1,
                    msg: b
                };
            if (!a.codeValue)
                return b = a.title + "验证码不能为空！",
                {
                    result: 1,
                    msg: b
                };
        ...
        function playAnimation(a, b, c, d, e) {
            var f = null;
            f = _isEditing ? $.extend(!0, {}, c) : c,
            e && !_isEditing ? ($p = getPageDomById(e),
            $item = $p.find(".element_" + b)) : $item = a.find(".element_" + b),
            doEleAnimation($item, f, d, e)
        }
        function doEleAnimation(a, b, c, d) {
            var e = 0;
            if (0 === b.delay || _isEditing || void 0 !== c && c !== !1 || (e = b.delay),
            "css" == _animationEngine)
                -1 === b.repeat && _isEditing || (b.type && 1 === parseInt(b.type) ? CssAnimationEngine.textAnimation(a, b.name, e, b.duration, b.repeat, b.repeatDelay, c, _isEditing, b.textDirection) : CssAnimationEngine.animation(a, b.name, e, b.duration, b.repeat, b.repeatDelay, c, _isEditing));
            else {
                for (var f = 0; f < preAnimationList.length; f++)
                    preAnimationList[f].pageId === currentPageId && preAnimationList[f].elementId === elementId && preAnimationList[f].animationName === b.name && preAnimationList[f].animation.seek(preAnimationList[f].animation.totalDuration());
        ...
        function playElement(a, b, c) {
            if (void 0 !== b.animationList) {
                for (var d, e = 0, f = 0, g = 0; g < b.animationList.length; g++)
                    d = b.animationList[g],
                    (void 0 === d.trigger || 0 === parseInt(d.trigger)) && (d.duration + d.delay > f && (f = d.duration + d.delay),
                    e > 0 && 0 !== d.delay ? playSecondAnimation(a, b, d, c) : playAnimation(a, b.id, d, !1, c),
                    e++);
                return f
            }
        }
        function getPageObjById(a) {
            if ("loadingpage" == a) {
                if (void 0 !== _dataObj.loadingpage && void 0 !== _dataObj.loadingpage.title)
                    return _dataObj.loadingpage
            } else if ("sharepage" == a) {
                if (void 0 !== _dataObj.sharepage)
                    return _dataObj.sharepage
            } else if ("floorpage" == a) {
                if (void 0 !== _dataObj.floorpage)
                    return _dataObj.floorpage
            } else if ("toppage" == a) {
                if (void 0 !== _dataObj.toppage)
                    return _dataObj.toppage
            } else {
                var b = 0;
                if (void 0 !== _dataObj.pageList)
                    for (b = 0; b < _dataObj.pageList.length; b++)
                        if (_dataObj.pageList[b].id == a)
                            return _dataObj.pageList[b];
                if (void 0 !== _dataObj.dialogList)
                    for (b = 0; b < _dataObj.dialogList.length; b++)
                        if (_dataObj.dialogList[b].id == a)
                            return _dataObj.dialogList[b]
            }
            return null
        }
        function getNextPageIdObjById(a) {
            ...
            for (b = 0; c > b; b++)
                if (_dataObj.pageList[b].id == a)
                    return b + 1 >= c ? 0 : _dataObj.pageList[b + 1].id;
            return 0
        }
        ...
        function fillPageBgColorDomAttr(a, b) {
            ...
            var d = "#FFFFFF"
              , e = 1
              , f = getPageType(b);
            return void 0 !== b.backgroundAlpha && "" !== b.backgroundAlpha && (e = 2 === f ? (100 - b.backgroundAlpha) / 100 : b.backgroundAlpha / 100),
            1 === c ? (void 0 !== b.backgroundColor && "" !== b.backgroundColor && (d = b.backgroundColor),
            a.css({
                opacity: e,
                backgroundColor: d
            ...
            a.addClass(b.bgGradien.gradientClassName)),
            a
        }
        function parsePageBackground(a) {
            ...
            if (void 0 === a || null === a)
                return b;
            if (b = fillPageBgColorDomAttr(b, a),
            void 0 !== a.backgroundImage && null !== a.backgroundImage && "" !== a.backgroundImage) {
                var c = handleImgUrl(a.backgroundImage);
                b.css("background-image", "url(" + c + ")"),
                b.css("background-repeat", "no-repeat"),
                b.css("background-size", "cover"),
                b.css("background-position", "center center")
            }
            return b
        }
        function parsePageBackgroundFixMode(a, b) {
            if (void 0 !== a && null !== a) {
                var c = $("<div class='pt-page-bg-box' style='width:100%;height:100%;cursor: default;'></div>");
                c = fillPageBgColorDomAttr(c, a),
                void 0 !== a.backgroundImage && null !== a.backgroundImage && "" !== a.backgroundImage ? (b.append(c),
                parsePageBackgroundImage(a, b)) : b.append(c)
            }
        }
            ...
            if (void 0 !== a && null !== a) {
                ...
                void 0 !== a.backgroundImage && null !== a.backgroundImage && "" !== a.backgroundImage) {
                    ...
                    void 0 === a.backgroundView) {
                        ...
                        var i = ""
                          , j = !1;
                        i = _isEditing ? window.rrxiuWsiteCrateTime : wsiteInfo.loading.createTime,
                        i && appConfig.startTimeParseBgImgNew && i > appConfig.startTimeParseBgImgNew && (j = !0);
                        var k, l, m, n, o, p, q;
                        if (p = Math.ceil(_$canvas.width() / _pt_inner_scale_value),
                        q = Math.ceil(_$canvas.height() / _pt_inner_scale_value),
                        testAlert("_pt_inner_scale_value" + _pt_inner_scale_value),
                        testAlert("canvas-w" + _$canvas.width()),
                        testAlert("canvas-h" + _$canvas.height()),
                        j) {
                            k = a.backgroundImageNaturalWidth / a.backgroundImageNaturalHeight;
                            var r = 1;
                            a.backgroundImageNaturalWidth === a.backgroundView.width ? (testAlert("NaturalWidth " + a.backgroundImageNaturalWidth),
                            testAlert("viewWidth " + a.backgroundView.width),
                            r = a.backgroundView.width / p,
                            l = p,
                            m = l / k) : (r = a.backgroundView.width / p,
                            l = a.backgroundImageNaturalWidth / r,
                            m = l / k),
                            o = void 0 === a.backgroundView ? 0 : a.backgroundView.x / r,
                            n = void 0 === a.backgroundView ? 0 : a.backgroundView.y / r
                        } else {
                            var s = 1010;
                            a.backgroundImageNaturalHeight >= 1008 && a.backgroundImageNaturalHeight <= 1010 ? s = 1010 : a.backgroundImageNaturalHeight > 1010 ? s = 1100 : a.backgroundImageNaturalHeight > 1100 && (s = a.backgroundImageNaturalHeight),
                            k = a.backgroundImageNaturalWidth / a.backgroundImageNaturalHeight;
                            var t = a.backgroundImageNaturalHeight / s;
                            m = s;
                            var u = 1;
                            a.backgroundView.height * t < s && (u = s / a.backgroundView.height * t,
                            m = s * u),
                            l = k * m,
                            n = void 0 === a.backgroundView ? 0 : a.backgroundView.y * u / t,
                            n < 1 / _pt_inner_scale_value && (n = 1 / _pt_inner_scale_value),
                            o = void 0 === a.backgroundView ? 0 : a.backgroundView.x * u / t,
                            640 == a.backgroundView.width && a.backgroundView.height > 1100 && (l = a.backgroundView.width,
                            m = a.backgroundView.height)
                        }
                        if (l = Math.ceil(l),
                        m = Math.ceil(m),
                        !a.longPage || isLongPageFixMode(a)) {
                            var v = l / m
                              , w = ""
                              , x = q > m
                              , y = p > l;
                            ...
                            testAlert("refsize" + w),
                            "h" === w ? (m = q,
                            l = Math.ceil(m * v)) : "w" === w && (console.log("spec w"),
                            l = p,
                            m = Math.ceil(l / v)),
                            testAlert("refsizedw" + l + " dh " + l),
                            "" !== w && (o = (l - p) / 2,
                            n = 0)
                        }
                        testAlert(l + " " + m + " " + o + " " + n),
        ...
        function parsePage(a) {
            ...
            if (void 0 === a || null === a)
                return b;
            if (null !== a && (void 0 === a || void 0 === a.elementList))
                return b;
            for (var c = [], d = [], e = 0; e < a.elementList.length; e++) {
                var f = a.elementList[e];
                if ("plugin" !== f.type || _isEditing || (pluginIsGame(f.content.levelId) || pluginIsModule(f.content.modules) || !pluginIsFull(f.content.sizeType)) && !pluginIsTop(f.content.isTop))
                    if (!_isPageThumb && "plugin" === f.type && f.content.modules && f.content.modules.length > 0) {
                        var g = "";
                        if (f.content.modules && f.content.modules.length > 0)
                            for (var h = 0; h < f.content.modules.length; h++) {
                                var i = f.content.modules[h];
                                if (i.enable) {
                                    var j = i;
                                    j.id = f.id + "_" + i.key,
                                    j.type = "plugin-module";
                                    var k = parseElement(j, a.id);
                                    g || (g = k.find(".element-last")),
                                    b.append(k)
                                }
                            }
                        ...
                        "html" === f.type && f.content.fullscreen && (f.left = 0,
                        f.top = 0,
                        f.width = 640,
                        f.height = a.longPage ? a.height : 1010);
                        var m = parseElement(f, a.id)
                          , n = !1;
                        "submit" !== f.type && "interact" !== f.type && "audio" !== f.type && "video" !== f.type && bindElementEvent(a.id, f, m),
                        "input" === f.type && (_isEditing || setInputPlaceholderColor(m.find(".input-query.element-last"), "")),
                        "smsCheck" === f.type && (_isEditing || (setInputPlaceholderColor(m.find(".smsPhone.element-last"), ""),
                        setInputPlaceholderColor(m.find(".smsCode.element-last"), ""))),
                        "img" === f.type && (n = f.canFloat),
                        n ? c.push(m) : b.append(m)
                    }
                else
                    parseEffectElement(a.id, f)
            }
            var o = $("<div></div>");
            return a.longPage ? (o.attr("class", "iscroll_wrapper"),
            o.attr("id", "iscroll_wrapper" + a.id),
            b.css("height", a.height)) : _isEditing || o.attr("class", "normal_wrapper"),
            o.html(b),
            a.longPage && $.each(c, function(a, b) {
                o.append(b)
            }),
        ...
        function appendFormJoin(a, b, c) {
            if ("submit" === b.type && b.showJoin) {
                ...
                _isEditing ? (d.html("目前已有 XXX 人参与活动"),
                a.append(d)) : $.ajax({
                    url: getInteractServiceHostIfHttps() + "formdata/getcount",
                    type: "POST",
                    data: {
                    ...
                    (appConfig.dev || 0 === b.result && b.data.join > 0) && (d.html("目前已有" + b.data.join + "人参与活动"),
                    a.append(d))
                })
            }
        }
        ...
        function setPageArrowIcon(a) {
            ...
            if (b)
                if (b.hasOwnProperty("arrowImgUrl") && "" !== b.arrowImgUrl && null !== b.arrowImgUrl) {
                    ...
                    "down" === flipWay ? $(".pt-wrapper .arrow-down p").css("background-image", "") : $(".pt-wrapper .arrow-down p").css("background-image", "")
        }
        function outPage(a, b, c) {
            ...
            if (_isEditing) {
                ...
                e.append('<div class="pt-page pt-page-current"></div>');
            var g = e.find(".pt-page");
            return a.longPage ? void 0 === a.longPagebgMode || "1" === a.longPagebgMode ? (parsePageBackgroundFixMode(a, g),
            g.append(parsePage(a))) : (parsePageBackgroundColor(a, g),
            g.append(parsePage(a)),
            parsePageBackgroundImage(a, e.find(".pt-page-element-list-box"))) : void 0 === a.backgroundImageNaturalWidth || void 0 === a.backgroundView ? (e.find(".pt-page").append(parsePageBackground(a)),
            e.find(".pt-page").append(parsePage(a))) : (parsePageBackgroundColor(a, g),
            g.append(parsePage(a)),
            parsePageBackgroundImage(a, e.find(".pt-page-element-list-box"))),
            d
        }
        function isPagebgColorOpacity(a) {
            if (null === a || void 0 === a)
                return !1;
            var b = 1;
            if (null !== a.pageType && void 0 !== a.pageType && (b = parseInt(a.pageType, 10),
            2 === b))
                return !0;
            var c = 1;
            if (null !== a.backgroundColorType && void 0 !== a.backgroundColorType && (c = parseInt(a.backgroundColorType, 10)),
            1 === c) {
                if (null === a.backgroundColor || void 0 === a.backgroundColor || "" === a.backgroundColor)
                    return !0;
                if ("transparent" === a.backgroundColor)
                    return !0;
        ...
        function handleScaleIfSmallScreen(a) {
            if (!_isPc) {
                ...
                if (c > b && "1" !== $page.attr("data-long")) {
                    ...
                    e.css("-webkit-transform", "scale(" + d + ")"),
                    e.css("transform", "scale(" + d + ")"),
                    e.css("-webkit-transform-origin", "center top"),
                    e.css("transform-origin", "center top")
                }
            }
        }
        ...
        function getImgSilderTimerByPage(a) {
            for (var b = 0; b < regImgSilderTimerRecord.length; b++)
                if (a == regImgSilderTimerRecord[b].pageId)
                    return regImgSilderTimerRecord[b];
            return null
        }
            ...
            for (var b = 0; b < regImgSilderTimerRecord.length; b++)
                if (a != regImgSilderTimerRecord[b].pageId) {
                    if (void 0 !== regImgSilderTimerRecord[b] && void 0 !== regImgSilderTimerRecord[b].silderObject)
                        for (j = 0; j < regImgSilderTimerRecord[b].silderObject.length; j++)
                            void 0 !== regImgSilderTimerRecord[b].silderObject[j] && regImgSilderTimerRecord[b].silderObject[j].stop()
                } else if (void 0 !== regImgSilderTimerRecord[b] && void 0 !== regImgSilderTimerRecord[b].silderObject)
                    for (j = 0; j < regImgSilderTimerRecord[b].silderObject.length; j++)
                        void 0 !== regImgSilderTimerRecord[b].silderObject[j] && regImgSilderTimerRecord[b].silderObject[j].start()
        }
        function stopAllImgSilderTimer() {
            for (var a = 0; a < regImgSilderTimerRecord.length; a++)
                if (void 0 !== regImgSilderTimerRecord[a] && void 0 !== regImgSilderTimerRecord[a].silderObject)
                    for (var b = 0; b < regImgSilderTimerRecord[a].silderObject.length; b++)
                        void 0 !== regImgSilderTimerRecord[a].silderObject[b] && regImgSilderTimerRecord[a].silderObject[b].stop()
        }
        function regImgSilderTimer(a) {
            if (pageId = a,
            stopOtherImgSilderTimer(pageId),
            !isRegImgSilderTimer(pageId)) {
                ...
                b.length > 0 && Cool.util.loadJs(appConfig.libHost + "flux.js?v=" + appConfig.version, function() {
                    $.each(b, function(a, b) {
                        ...
                        if (0 === c.children().length)
                            return void console.info("img 0");
                        var d = c.attr("id");
                        if (void 0 !== d) {
        ...
        function regImgPlayTimer(a) {
            ...
            if (null !== b) {
                if (clearRegIntervals(),
                void 0 === b.elementList)
                    return;
                var c = b.elementList;
                $.each(c, function(a, c) {
        ...
        function regImgElementEvent(a, b, c) {
            ...
            if (c.showAnimation && f.length > 0) {
                ...
                1 === parseInt(c.imageType) && resetElementLastImg(g, !0),
                $.each(f, function(a, b) {
                    $(b).css("opacity", 0)
                });
                var h = null;
                1 === parseInt(c.touchType) ? (d.bind(clickEventType, function(d) {
                    ...
                    d.stopPropagation(),
                    setTimeout(function() {
                        null === h && ($(f[0]).css("opacity", 1),
                        1 === parseInt(c.imageType) && resetElementLastImg(g, !1),
                        h = new ImgPlayTimer,
                        h.setCount(0),
                        h.setPageId(a),
                        h.setElemId(b),
                ...
                d.bind("mouseup mouseleave touchend", function(a) {
                    ...
                    h.setContent(c),
                    h.playImgList()
                }, 1e3 * c.playDelay) : "3" === c.touchType && (startShake(),
                window.addEventListener("shake", function(d) {
                    stopShake(),
                    setTimeout(function() {
                        $(f[0]).css("opacity", 1),
                        1 === parseInt(c.imageType) && resetElementLastImg(g, !1),
        ...
        function clearAllCustomIntervals() {
            for (var a = 0; a < customIntervals.length; a++)
                window.clearInterval(customIntervals[a]);
        ...
        function createAudioElement(a, b, c) {
            ...
            if (!e) {
                ...
                e.setAttribute("id", d),
                e.setAttribute("style", "opacity:0;width:1px;height:1px"),
                e.setAttribute("src", f),
                e.setAttribute("preload", !0),
                c.click ? "loop" === c.click.type ? e.setAttribute("loop", "loop") : "" !== c.click.value && $(e).on("ended", function() {
                    bindElementEvent(a, c)
                }) : c.content.loop && e.setAttribute("loop", c.content.loop),
                $("#main").append(e),
                (void 0 === _pageAudio[a] || null === _pageAudio[a]) && (_pageAudio[a] = []),
                -1 == _pageAudio[a].indexOf(d) && _pageAudio[a].push(d),
                rrxdebug && console.log(_pageAudio)
            }
        }
        function switchAudioPlay(a, b) {
            var c = document.getElementById("audio-" + a + "-" + b);
            rrxdebug && console.log("switchAudioPlay", c),
            c && (c.paused ? (c.play(),
            Cool.util.checkIsWeixin() === !0 && "undefined" != typeof WeixinJSBridge && WeixinJSBridge.invoke("getNetworkType", {}, function(a) {
                c.play()
            })) : c.pause())
        }
        function pauseAudio(a) {
            var b = document.getElementById(a);
            rrxdebug && console.log(b),
            null !== b && (b.paused || b.pause())
        }
        function pausePageAudio(a) {
            rrxdebug && console.log(_pageAudio, a),
            _pageAudio[a] && $.each(_pageAudio[a], function(a, b) {
                pauseAudio(b)
            })
        }
        function regAudioEvent(a, b, c, d) {
            var e = d || null
              ...
              , g = c.delay || 0;
            g = 1e3 * g,
            "0" === c.touchType ? f.off(clickEventType).on(clickEventType, function(c) {
                ...
                switchAudioPlay(a, b)
            }, g) : "3" === c.touchType && (startShake(),
            window.addEventListener("shake", function(c) {
                stopShake(),
                setTimeout(function() {
                    switchAudioPlay(a, b)
                }, g),
        ...
        function createVideoClose(a, b) {
            ...
            c.click(function() {
                apiHelper.getAppInstance().resetFlip(!0),
                $("#mask_" + b).remove(),
                $("#close_" + b).remove(),
                showMusicIcon(),
                musicIsPlayWhenPlayVideo && playMusic(),
                showElement(b)
            }),
        ...
        function createVideoPlay(a, b, c) {
            ...
            1 === parseInt(c.type) || g ? (1 === parseInt(c.type) && apiHelper.getAppInstance().stopFlip(),
            e = $('<video style="object-fit: fill;"  autoPlay controls></video>'),
            e.attr("type", "video/mp4"),
            e.attr("id", "video_" + b),
            e.attr("src", handleDataUrl(c.url)),
            e.css({
                position: "absolute",
                height: "50%",
                width: "100%",
                top: "22%"
            })) : (apiHelper.getAppInstance().stopFlip(),
            c.code = handleVideoIframeSrc(c.code),
            e = $(c.code).css({
                position: "absolute",
                top: "22%"
            }),
            ...
            d.html(e),
            getPageDomById(a).append(d)
        }
        function removeAllVideo() {
            $(".video-mask").remove(),
            $(".close-mask").remove(),
            $('div[eletype="video"]').show(),
            showMusicIcon()
        }
        ...
        function createVideoControl(a, b, c) {
            createVideoPlay(a, b, c),
            createVideoClose(a, b, c)
        }
        function createVideoElement(a, b, c, d) {
            if (0 === parseInt(d.type) && !getCanVisitThirdVideo())
                return void winAlert("暂时不支持第三方视频");
            if (isPreview()) {
                musicIsPlayWhenPlayVideo = $iconMusic.hasClass("music-play") || $iconMusic.hasClass("music-play-none"),
                stopMusic(),
                hideMusicIcon();
        ...
        function regVideoEvent(a, b, c, d) {
            ...
            if (0 !== g && 0 !== parseInt(c.type) && c.embed)
                if (1 === g) {
                    ...
                    c.embed && 2 === g && null !== e && createVideoElement(f, a, b, c);
            else
                f.off(i).on(i, function(d) {
                    reloveTwoClickByISroll() && (d.preventDefault(),
                    d.stopPropagation(),
                    createVideoElement(f, a, b, c))
                })
        }
        ...
        function regAnimationShake(a) {
            ...
            if (b)
                for (var d = 0; d < b.length; d++)
                    "animation" === b[d].type && 2 === parseInt(b[d].animation.trigger) && c(_$canvas, b[d].elementId, b[d].animation)
        }
        function startShake(a) {
            a = a || "shake",
            void 0 === myShakeEvent[a] ? (myShakeEvent[a] = new Shake({
                shake: a
            }),
        ...
        function stopShake(a) {
            a = a || "shake",
            void 0 !== myShakeEvent[a] && myShakeEvent[a].stop()
        }
        ...
        function regPageStopflipEvent(a) {
            _allowFlipCurrentPage = !getPageStopflip(a),
            _allowFlip && _allowFlipCurrentPage ? a == lastPageId ? getCanShowCopyrightPageEnd() ? showArrow() : hideArrow() : showArrow() : hideArrow()
        }
        ...
        function regPageEndEvent(a) {
            ...
            regAnimationShake(a),
            regSensorEvent(a),
            regPageStopflipEvent(a),
            regPageAutoTimeFlipEvent(a)
        }
        ...
        function loadPluginEvent(a) {
            rrxdebug && console.log("loadPluginEvent", a),
            a = a || currentPageId,
            loopPluginByPage(a, function(b) {
        ...
        function hideMenuByOther(a) {
            if (pageIsHaveTopPlugin(!0, "照片投票,VR全景图,问答", [1, appConfig.gameCategory], !0))
                return void hideMenuPlugin();
        ...
        function resetEmbedVideo(a) {
            ...
            getEmbedVideo(a, function(b, c) {
                ...
                1 === parseInt(c.content.touchType) || 0 === parseInt(c.content.touchType) && h.attr("controls", "controls"),
                1 == c.content.touchType ? h.attr("preload", "auto") : h.attr("preload", "metadata"),
                void 0 === c.content.poster || e || h.attr("poster", c.content.poster),
                c.click && ("loop" === c.click.type ? h.attr("loop", "loop") : "" !== c.click.value && h.off().on("ended", function() {
                    bindElementEvent(a, c)
                })),
        ...
        function getActualPageId(a) {
            ...
            var c = null;
            if (-1 == a) {
                for (c = b.next(); c.hasClass("ifpage") && (c = c.next(),
                c.hasClass("pt-page") !== !1); )
                    ;
                c.hasClass("pt-page") === !1 && (c = $pagelist.find("div.pt-page:not(.ifpage)").first())
            } else if (-2 == a) {
                for (c = b.prev(); c.hasClass("ifpage") && (c = c.prev(),
                c.hasClass("pt-page") !== !1); )
                    ;
                c.hasClass("pt-page") === !1 && (c = $pagelist.find("div.pt-page:not(.ifpage)").last())
            } else
                0 === a && (c = $pagelist.find("div.pt-page:not(.ifpage)").first());
            return null !== c && (a = c.data("id")),
            a
        }
        function getAnimationIndex(a, b) {
            var c, d = "";
            return b === !0 ? (c = getPageObjById(a),
            void 0 !== c.flip ? d = c.flip.enter : void 0 !== flipAnimation.enter && (d = flipAnimation.enter)) : (c = getPageObjById(currentPageId),
            void 0 !== c.flip ? d = c.flip.back : void 0 !== flipAnimation.back && (d = flipAnimation.back)),
            d
        }
        ...
        function playPage(a, b) {
            if (void 0 === b || void 0 === b.elementList)
                return 0;
            for (var c = -1, d = 0, e = 0; e < b.elementList.length; e++) {
                var f = b.elementList[e];
                f.display !== !0 && void 0 !== f.display && _isEditing || (c = playElement(a, f, b.id),
                "img" === f.type && "loadingpage" === b.id && f.content.showAnimation && regImgElementEvent(b.id, f.id, f.content, f.content.name),
                c > d && (d = c))
            }
            return d
        }
        ...
        function setBlurBgPage() {
            ...
            $("div.outGameCanvas").addClass("blur-container")
        }
        ...
        function removeBlurBgPage() {
            ...
            $("div.outGameCanvas").removeClass("blur-container")
        }
        ...
        function createPages() {
            if (void 0 !== _dataObj.pageList) {
                for (var a = _dataObj.pageList, b = 0; b < a.length; b++) {
                    ...
                    c.longPage && (d += ' data-long="1"'),
                    c.stopFlip && (d += ' data-stopflip="1"'),
                    d += "></div>",
                    $pagelist.append(d),
                    $.isNumeric(c.id) && _pageIdList.push(parseInt(c.id, 10))
                }
                firstPageId = a[0].id,
                lastPageId = a[a.length - 1].id,
                totalPages = a.length
            }
        }
        function createWrapper(a, b) {
            a.html(""),
            html = '<div class="pt-outer"><div class="pt-inner"></div></div>',
            a.append(html),
            console.log();
            var c = parseFloat(a.height() / a.width()) * canvasDefaultWidth;
            scale = parseFloat(1 * a.width() / canvasDefaultWidth).toFixed(6),
            _pt_inner_scale_value = scale;
            var d = parseFloat(a.height() / c)
              , e = navigator.userAgent.toLowerCase()
              , f = 97e-5 * parseFloat(a.width() / 360);
            e.indexOf("android") > -1 && (d += f),
            d = d.toFixed(6);
            var g = 0;
            if (_isEditing) {
                var h = !1;
                g = parseFloat(-1 * c / 2) - 0,
                h && (.5 == d && (c = 1016,
                g = -509),
                .75 == d && (c = 1014,
                g = -508.5))
                ...
                g = parseFloat(-1 * c / 2) - 0;
            $outer = a.find(".pt-outer"),
            $inner = a.find(".pt-inner"),
            $inner.css("height", c),
            $inner.css("margin-top", g),
            $inner.css("-webkit-transform", "scale(" + scale + "," + d + ")"),
            $inner.css("-moz-transform", "scale(" + scale + "," + d + ")"),
            $inner.css("transform", "scale(" + scale + "," + d + ")"),
            $outer.css("height", a.height()),
            $outer.css("width", a.width())
        }
        function createProgress() {
            ...
            $progress.css("background-color", "rgba(0,0,0,.2)"),
            $(".progress-tip").css("display", "none"),
            $(".page-tip").css("display", "none")
        }
        ...
        function isShowTopMenu() {
            if (void 0 === _dataObj.topMenu || void 0 === _dataObj.topMenu.list || 0 === _dataObj.topMenu.list.length)
                return !1;
            if (1 === _dataObj.topMenu.list.length && "菜单1" === _dataObj.topMenu.list[0].name)
                return !1;
        ...
        function sysMenuBottomCreate() {
            if (sysMenuBottomIsShow()) {
                var a = template.compile(sysMenuBottomHtml)
                  , b = a({
                ...
                $ptWrapper.append(b),
                $sysMenuBottom = $("#js_rrx_sys_menu_bottom"),
                sysMenuBottomBindEvent(),
                _isHaveMenu = !0
            }
        }
        function sysMenuBottomBindEvent() {
            ...
            a.off(clickEventType).on(clickEventType, function(a) {
                ...
                var c = $(this).data("id")
                  , d = _dataObj.topMenu.list[c];
                "sms" !== d.type && "tel" !== d.type && (a.stopPropagation(),
                a.preventDefault()),
                sysMenuBottomItemEventExec(d, c, !0)
            })
        }
        function sysMenuBottomSubMenuRender(a, b) {
            ...
            c.css("left", 200 * b + 10),
            c.html(d),
            c.find("a").off(clickEventType).on(clickEventType, function(a) {
                var d = $(this).data("id")
                  , e = d.split("-");
                if (2 === e.length) {
                    var f = _dataObj.topMenu.list[e[0]].list[e[1]];
                    "sms" !== f.type && "tel" !== f.type && (a.stopPropagation(),
                    a.preventDefault()),
                    sysMenuBottomItemEventExec(f, b, !1)
                }
                c.hide()
            }),
            $(document).one(clickEventType, function(a) {
                return a.stopPropagation(),
                "block" === c.css("display") ? void c.hide() : void 0
            })
        }
        ...
        function createTopeMenu() {
            if (isShowTopMenu()) {
                ...
                $topMenuButton.attr("src", a),
                $topMenuButton.css("pointer-events", "auto"),
                $topMenuButton.off().on(clickEventType, function(a) {
                    a.stopPropagation(),
                    a.preventDefault(),
                    showTopMenu(),
                    setBlurBgPage()
        ...
        function formatHref(a) {
            return a && -1 === a.indexOf("http://") && -1 === a.indexOf("https://") && (a = a.replace("www", "http://www")),
            a || ""
        }
        function showTopMenu() {
            if (void 0 !== _dataObj.topMenu) {
                if (0 === $topMenuPanel.find(".top-menu-list").length) {
                    ...
                    for (var c = _dataObj.topMenu.list, d = 0; d < c.length; d++)
                        a += "url" === c[d].type ? '<a class="menu-' + c[d].type + '" href="javascript:void(0)" data-id="' + formatHref(c[d].href) + '">' + c[d].name + "</a>" : "page" === c[d].type ? '<a class="menu-' + c[d].type + '" href="javascript:void(0)" data-id="' + c[d].value + '">' + c[d].name + "</a>" : "event" === c[d].type ? '<a class="menu-' + c[d].type + '" href="javascript:void(0)" data-id="' + c[d].event + '">' + c[d].name + "</a>" : "tel" === c[d].type ? '<a class="menu-' + c[d].type + '" href="tel:' + c[d].phone + '">' + c[d].name + "</a>" : "sms" === c[d].type ? '<a class="menu-' + c[d].type + '" href="sms:' + c[d].phone + '">' + c[d].name + "</a>" : "openDialog" === c[d].type ? '<a class="menu-' + c[d].type + '" href="javascript:void(0)" data-id="' + c[d].dialog + '">' + c[d].name + "</a>" : '<a class="menu-' + c[d].type + '" href="javascript:void(0)" data-id="' + c[d].value + '">' + c[d].name + "</a>",
                        (b || d !== c.length - 1) && (a += '<div class="cut-line"></div>');
                    b && (a += '<a class="menu-focus" href="javascript:void(0)">关注公众号</a>'),
                    a += "</div></div></div>",
                    a += "customer" === _copyrightFrom ? '<div class="menu-copyright">' + getCopyrightCustomer(!0) + '<span class="show-report">举报</span></div>' : "na" === _copyrightFrom ? '<div class="menu-copyright"></div>' : '<div class="menu-copyright"><span class="show-report">举报</span><span class="show-copyright"><a href="' + getMakeRRxUrl() + '" target="_blank" style="color:#fff;">' + appConfig.copyright.content + "</a></span></div>",
                    $topMenuPanel.html(a),
                    "na" !== _copyrightFrom && registerReportEvent($topMenuPanel.find(".menu-copyright .show-report")),
                    _dataObj.showVisitCount && null !== _log && !getIsFromTpl() && setTimeout(function() {
                    ...
                    e.off().on(clickEventType, function(a) {
                        a.stopPropagation(),
                        a.preventDefault(),
                        displayPanelDialog("up", "down", "topmenu"),
                        removeAllBlurPage()
                    });
                    ...
                    f.find(".menu-page").off().on("click", function(a) {
                        ...
                        setTimeout(function() {
                            if ("first" === b)
                                firstPageId != currentPageId && apiHelper.getAppInstance().gotoPage(firstPageId);
                            else if ("pre" === b)
                                apiHelper.getAppInstance().gotoPrePage();
                            else if ("next" === b)
                                apiHelper.getAppInstance().gotoNextPage();
                            else {
                                if (b === currentPageId || "0" === b || 0 === b)
                                    return;
                ...
                displayPanelDialog("down", "up", "topmenu"),
                loadMenuListByiScroll()
            }
        }
        ...
        function createFocusWechat() {
            if (isShowFocusWechat() && (!_dataObj.focusWechat || "rrx-qrcode.jpg" === _dataObj.focusWechat.qrcode || getCanModifyWechat())) {
                ...
                $focusButton.attr("src", a),
                $focusButton.off().on(clickEventType, function(a) {
                    a.stopPropagation(),
                    a.preventDefault(),
                    showFocusWechat(),
                    setBlurBgPage(),
                    _rrxtach.recordFocusClick(apiHelper.getAppInstance().weixinStrong.getWxOpenId())
                }),
            ...
            if ("rrx-qrcode.jpg" !== _dataObj.focusWechat.qrcode && (!_dataObj.focusWechat || "rrx-qrcode.jpg" === _dataObj.focusWechat.qrcode || getCanModifyWechat())) {
                if (0 === $focusPanel.find(".fw-qrcode-box").length) {
                    ...
                    c.off().on(clickEventType, function(a) {
                        a.stopPropagation(),
                        a.preventDefault(),
                        displayPanelDialog("up", "down", "focus"),
                        removeAllBlurPage()
                    }),
        ...
        function playShowCopyrightPageAnim() {
            $pageCopyrightPageEnd.css("display", "block"),
            getIsFlipDown() ? setTimeout(function() {
                $pageCopyrightPageEnd.removeClass("damu-down"),
                $pageCopyrightPageEnd.addClass("damu-up")
            }, 0) : setTimeout(function() {
                $pageCopyrightPageEnd.removeClass("damu-right"),
                $pageCopyrightPageEnd.addClass("damu-left")
            }, 0)
        }
        function playHideCopyrightPageAnim() {
            getIsFlipDown() ? (setTimeout(function() {
                $pageCopyrightPageEnd.css("display", "none"),
                $pageCopyrightPageEnd.removeClass("damu-up"),
                removeBlurBgPage()
            }, 250),
            $pageCopyrightPageEnd.removeClass("damu-up"),
            $pageCopyrightPageEnd.addClass("damu-down")) : (setTimeout(function() {
                $pageCopyrightPageEnd.css("display", "none"),
                $pageCopyrightPageEnd.removeClass("damu-left"),
                removeBlurBgPage()
            }, 250),
            $pageCopyrightPageEnd.removeClass("damu-left"),
            $pageCopyrightPageEnd.addClass("damu-right"))
        }
        function displayPanelDialog(a, b, c) {
            var d = null;
            d = "danmu" === c ? $danmuPanel : "topmenu" === c ? $topMenuPanel : "share" === c ? $sharePanel : $focusPanel,
            "down" === a ? (d.css("display", "block"),
            hideDanmuInfo(),
            apiHelper.getAppInstance().stopFlip()) : (setTimeout(function() {
                d.css("display", "none"),
                removeBlurBgPage()
            }, 250),
            resetDanmuInfo(),
        ...
        function createSharePanel() {
            ...
            "na" === _copyrightFrom ? d.hide() : d.show(),
            registerReportEvent(d),
            _dataObj.showVisitCount && null !== _log && !getIsFromTpl() && setTimeout(function() {
            ...
            e.off().on(clickEventType, function(a) {
                a.stopPropagation(),
                a.preventDefault(),
                displayPanelDialog("up", "down", "share"),
                removeAllBlurPage()
            }),
            $sharePanel.find(".share-button-friend").off().on(clickEventType, function(a) {
                a.stopPropagation(),
                a.preventDefault(),
                1 === parseInt(_dataObj.forbidShare) ? winAlert("当前活动禁止分享！") : showSharepage()
            }),
            $sharePanel.find(".share-button-timeline").off().on(clickEventType, function(a) {
                a.stopPropagation(),
                a.preventDefault(),
                1 === parseInt(_dataObj.forbidShare) ? winAlert("当前活动禁止分享！") : (createSharePoster(),
                _rrxtach.recordSharePoster(apiHelper.getAppInstance().weixinStrong.getWxOpenId()))
            })
        }
        function showSharePanel() {
            setBlurBgPage(),
            displayPanelDialog("down", "up", "share")
        }
        function getSharePosterBgImg() {
            return _dataObj.sharePosterBgImg ? (sharePosterBgImgCustomed = !0,
            handleImgUrl(_dataObj.sharePosterBgImg)) : ""
        }
        function createSharePoster() {
            var a = !1;
            if (sharePosterCreated ? (shareTitle !== shareTitleLast || shareDesc !== shareDescLast || shareImageUrl !== shareImgLast || shareUrl !== shareUrlLast) && (a = !0) : a = !0,
            a) {
                var b = {
                ...
                c.create(),
                showSharePosterTips("正在生成"),
                shareTitleLast = shareTitle,
                shareDescLast = shareDesc,
                shareImgLast = shareImageUrl,
                shareUrlLast = shareUrl
            } else
                showSharePosterTips("正在生成"),
                setTimeout(function() {
                    hideSharePosterTips(),
        ...
        function handleSharePosterResult(a) {
            if (0 === a.code)
                if ("base64" === a.imgFormat)
                    hideSharePosterTips(),
                    $("#share_poster_img").attr("src", a.base64),
                    showSharePosterDialog(),
                    sharePosterCreated = !0;
                else {
                    var b = getImageHost() + a.imgPath;
                    Cool.util.loadImage(b, function() {
                        if (hideSharePosterTips(),
                        appConfig.dev === !0) {
                            var a = new Date;
                            $("#share_poster_img").attr("src", b + "?v=" + a.getTime())
                        } else
                            $("#share_poster_img").attr("src", b);
                        showSharePosterDialog(),
                        sharePosterCreated = !0
                    }, !1)
                }
        ...
        function showSharePosterTips(a) {
            $sharePosterTips.find(".dialog-container-process").html(a),
            $sharePosterTips.show()
        }
        function hideSharePosterTips() {
            $sharePosterTips.hide(),
            $sharePosterTips.find(".dialog-container-process").html("请稍等")
        }
        function showSharePosterDialog() {
            $sharePosterDialog.find(".dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
            $sharePosterDialog.show()
        }
        function hideSharePosterDialog() {
            $sharePosterDialog.find(".dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
            setTimeout(function() {
                $sharePosterDialog.hide()
            }, 600)
        }
        function initSidleShare() {
            (1 === wsiteInfo.activityType || _isAllPageShowReport || _isWxMin) && ($sidleShareButton = $(".sidle-share"),
            setSidleSharePos(),
            showSidleShare(),
            $sidleShareButton.off().on(clickEventType, function(a) {
                a.stopPropagation(),
                a.preventDefault(),
                lanchShare(),
                _rrxtach.recordShareClick(apiHelper.getAppInstance().weixinStrong.getWxOpenId())
            }))
        }
        function lanchShare() {
        ...
        function getForbidShare() {
            return _isWxMin && "ash0mw" == _dataObj.guid ? !0 : 1 === parseInt(_dataObj.forbidShare) || wsiteInfo.wxp.showShareMenu === !1
        }
        ...
        function initSidleReport() {
            (1 === wsiteInfo.activityType || _isAllPageShowReport) && ($sidleReportButton = $(".sidle-report"),
            setSidleReportPos(),
            showSidleReport(),
            registerReportEvent($sidleReportButton))
        }
        function setSidleReportPos() {
            hasBgMusic ? getIsFromTpl() && $sidleReportButton.css({
                top: "11%"
            }) : $sidleReportButton.css({
                top: "11%"
            })
        }
        ...
        function initWsiteInvite() {
            if (Cool.util.checkIsWeixin() && wsiteInfo.isOpenInvite) {
                var a = Cool.util.getPluginDomain("wsiteInvite", 10) + "index.js";
                AmdLoader.require(a, function(a) {
                    if (a && a.init) {
                        var b = {
                            id: "wsiteInvite" + _dataObj.guid,
                            content: {
                                token: "wsiteInvite",
                                version: 10
                            }
                        };
                        a.init(b, $("#main"), apiHelper.getAppInstance(), 0, 0)
                    }
                })
            }
        }
        function initSidlePluginMsg() {
            if ($pluginMsgButton.off().on(clickEventType, function() {
                var a = "开启活动消息提醒";
                window.pluginMsgAlertTitle && (a = window.pluginMsgAlertTitle),
                showAlertPluginMsg(a, function(a) {
                    if (a) {
                        var b = _$canvas.find(".rrx-plugin-msg-dialog");
                        b && b.length > 0 && (b.find(".dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
                        b.find(".content-close").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
                        b.show())
                    }
                })
            }),
            $sidleReportButton) {
                var a = $sidleReportButton.css("display");
                "none" !== a && hasBgMusic ? $pluginMsgButton.css({
                    top: "27%"
                }) : hasBgMusic && "none" === a ? $pluginMsgButton.css({
                    top: "11%"
                }) : hasBgMusic || "none" === a ? hasBgMusic || "none" !== a || $pluginMsgButton.css({
                    top: "3%"
                }) : $pluginMsgButton.css({
                    top: "19%"
                })
        ...
        function setPluginMsgAlertTitle(a) {
            window.pluginMsgAlertTitle = a
        }
        function showPluginMsgButton() {
            wsiteInfo && wsiteInfo.authBehind && $pluginMsgButton.show()
        }
        function hidePluginMsgButton() {
            $pluginMsgButton.hide()
        }
        function loadPluginMsg(a) {
            if (wsiteInfo && wsiteInfo.authBehind) {
                var b = apiHelper.getAppInstance().weixinStrong.getAuthedInfo();
                if ("" !== b.id && null !== b.id && void 0 !== b.id) {
                    var c = {};
                    null !== a && void 0 !== a && (c = $.extend({}, a)),
                    c.wsiteGuid = _dataObj.guid,
                    c.wxOpenId = b.id,
                    requestAjax("checkfocus", c, "POST", "pluginmsg", _host).then(function(b) {
                        0 === b.result && b.data.needShowDialog && (createRRxPluginMsgDialog(apiHelper.getAppInstance(), {
                            qr: b.data.qr
                        }),
                        showPluginMsgButton()),
        ...
        function setNeedTriggerWxMessage() {
            var a = "1"
              , b = ""
              , c = 10;
            Cool.cookie.setWithoutTime(getNeedTriggerWxMessageKey(), a, c, b)
        }
        function getNeedTriggerWxMessageKey() {
            var a = _dataObj.guid;
            return hex_md5("NeedTriggerWxMessage" + a)
        }
        function getNeedTriggerWxMessageCookie() {
            return Cool.cookie.get(getNeedTriggerWxMessageKey())
        }
        ...
        function createDanmu() {
            danmuButtonShow && isShowDanmu() && (rrxdebug && console.info("createDanmu"),
            $danmuButton.off().on(clickEventType, function(a) {
        ...
        function createDanmuPanel() {
            ...
            "customer" !== _copyrightFrom && "na" !== _copyrightFrom && (_isWxMin || (b += '<div class="p-make"><a href="' + getMakeRRxUrl() + '" target="_blank">我也要制作liao</a></div>')),
            b += "customer" === _copyrightFrom ? '<div class="p-copyright">' + getCopyrightCustomer(!0) + '<span class="show-report">举报</span></div>' : "na" === _copyrightFrom ? '<div class="p-copyright"></div>' : '<div class="p-copyright"><span class="show-report">举报</span><span class="show-copyright"><a href="' + getMakeRRxUrl() + '" target="_blank" style="color:#fff;">' + appConfig.copyright.content + "</a></span></div>",
            $danmuPanel.html(b),
            "na" !== _copyrightFrom && registerReportEvent($danmuPanel.find(".p-copyright .show-report")),
            _dataObj.showVisitCount && null !== _log && !getIsFromTpl() && setTimeout(function() {
                0 !== _log.getVisitCount() && $danmuPanel.find(".p-copyright").append('<span class="show-visit">阅读:' + _log.getVisitCount() + "</span>")
            }, 300),
            1 === parseInt(_dataObj.forbidShare) && ($danmuPanel.find(".p-buttons .btn-share").css({
                visibility: "hidden"
            }),
            $sharePanel.find(".share-tips-box").hide(),
            $sharePanel.find(".share-button-box").hide()),
            loadCommentListByiScroll(DM_Comment_List)
        }
        function showDanmuEvent() {
            displayPanelDialog("down", "up", "danmu"),
            null === danmuiScrollInstance && (createDanmuPanel(),
            bindDanmuElementEvent())
        }
        function hideDanmuInfo() {
            ...
            Cool.util.checkIsAndroid() && stopEmbedVideo(),
            currentPageId === lastPageId && hideEffect($copyright),
            (isShowFocusWechat() || isShowTopMenu()) && ($focusButton.hide(),
            $topMenuButton.hide()),
            hideSidleShare(),
            hideSidleReport(),
            isShowDanmu() && ($danmuButton.hide(),
            isShowDanmuAnimate() && (Danmaku.stop(),
            Danmaku.hide())),
            $cartButton.css("opacity", 0))
        }
        function hideWsiteInvite() {
            if (wsiteInfo.isOpenInvite) {
                var a = _$canvas.find(".rrx-wsite-invite-button");
                a && a.length > 0 && a.hide()
            }
        }
        function showWsiteInvite() {
            if (wsiteInfo.isOpenInvite) {
                var a = _$canvas.find(".rrx-wsite-invite-button");
                a && a.length > 0 && a.show()
            }
        ...
        function pageIsHaveTopPlugin(a, b, c, d) {
            ...
            if (void 0 === currentPageId && console.trace(currentPageId),
            null === e || void 0 === e)
                return !1;
            var f = e.elementList;
            b = b || "照片投票";
            for (var g = 0; g < f.length; g++) {
                if (a && pluginIsTop(f[g].content.isTop))
                    return console.log(14, f[j].content.categoryId),
                    !0;
                if (void 0 !== b && null !== b && "" !== $.trim(b) && b.indexOf(f[g].content.name) > -1)
                    return !0;
                if (d && pluginIsFull(f[g].content.sizeType))
                    return !0;
                if (c && c.indexOf(0 | f[g].content.categoryId) > -1)
                    return !0
            }
            return !1
        }
        function resetDanmuInfo() {
            if (showWsiteInvite(),
            isShowDanmu() || isShowFocusWechat() || isShowTopMenu() || "rrxiu" !== _copyrightFrom) {
                if ("" !== musicUrl && $iconMusic.css({
                    display: "block",
                    opacity: 1
                }),
                $progress.css("opacity", 1),
                Cool.util.checkIsAndroid() && resetEmbedVideo(),
                currentPageId === lastPageId && (currentPageId === lastPageId || _isHaveMenu && "na" === _copyrightFrom)) {
                ...
                (isShowFocusWechat() || isShowTopMenu()) && ($focusButton.show(),
                $topMenuButton.show()),
                showSidleShare(),
                showSidleReport(),
                isShowDanmu() && ($danmuButton.show(),
                isShowDanmuAnimate() && Danmaku.start()),
        ...
        function bindDanmuElementEvent() {
            ...
            e.unbind().bind(clickEventType, function(a) {
                a.stopPropagation(),
                a.preventDefault(),
                $(window).trigger("sysDanmaCloseClick"),
                displayPanelDialog("up", "down", "danmu")
            }),
            c.unbind().bind(clickEventType, function(a) {
                a.stopPropagation(),
                a.preventDefault();
                var b = c.find(".l-icon");
                b.hasClass("rrx-icon-danmu-close") ? (b.addClass("rrx-icon-danmu-open"),
                b.removeClass("rrx-icon-danmu-close"),
                _dataObj.danmuLike.showDanmu = !0,
                closeOnlyPluginDanmu(),
                forceOpenDanmu = !1) : (b.addClass("rrx-icon-danmu-close").removeClass("rrx-icon-danmu-open"),
                _dataObj.danmuLike.showDanmu = !1,
                Danmaku.stop())
            }),
            ...
            a.unbind().bind(clickEventType, function(a) {
                ...
                a.preventDefault(),
                $danmuPanel.hide(),
                $danmuPanel.removeClass("danmu-up").addClass("damu-down"),
                _isWxMin && displayPanelDialog("up", "down", "danmu"),
                lanchShare(),
                _rrxtach.recordShareClick(apiHelper.getAppInstance().weixinStrong.getWxOpenId())
            }),
        ...
        function getCommentLikeCount() {
            ajaxPost("like/getCount", {
                ...
                0 === a.result ? (danmu_like_count = a.data.likeCount,
                danmu_comment_count = a.data.commentCount,
                createDanmu()) : console.error(a)
            })
        }
        function sendLikePost() {
            danmu_like_count = parseInt(danmu_like_count) + 1;
            var a = $danmuPanel.find(".p-buttons .btn-like .l-tip");
            a.html(danmu_like_count),
            setTimeout(function() {
                ajaxPost("like/add", {
                    wsiteGuid: _dataObj.guid,
        ...
        function sendComment() {
            if (!isSending) {
                ...
                if ("" === a.val())
                    return void showDanmuTip("评论信息不能为空！");
                if (Danmaku.getCharacterSize(a.val()) > 48)
                    return void showDanmuTip("评论信息不能超过25个字符！");
                if (null === authUserInfo)
                    return void showDanmuTip("微信授权失败，请尝试点击输入框！");
                isSending = !0,
                ajaxPost("comment/add", {
                    wsiteGuid: _dataObj.guid,
                    review: !0,
                    ...
                    if (0 === b.result) {
                        ...
                        c.hasClass("rrx-icon-danmu-close") && (c.addClass("rrx-icon-danmu-open"),
                        c.removeClass("rrx-icon-danmu-close"),
                        _dataObj.danmuLike.showDanmu = !0),
                        danmu_comment_count = parseInt(danmu_comment_count, 10) + 1,
                        a.val(""),
                        showDanmuTip("评论成功 ^_^");
                        var d = $danmuPanel.find(".p-buttons .btn-danmu .l-tip");
                        d.html(danmu_comment_count),
                        b.data.photo && (b.data.photo = handleWxHeadImg(b.data.photo)),
                        DM_Comment_List.unshift(b.data),
                        Danmaku.refresh(DM_Comment_List),
                        appendCommentToList(b.data)
                    } else
                        showDanmuTip("评论失败 ︶︿︶")
                })
            }
        ...
        function handleWxHeadImg(a) {
            return a ? (a.indexOf(!1) && a.indexOf("/0") > -1 && (a = a.replace("/0", "/64")),
            a.replace("http://", "https://")) : a
        }
        ...
        function appendCommentToList(a) {
            if (a.createTime || (a.createTime = getNowFormatDate()),
            !a.hideInList) {
        ...
        function getCommentHtml(a) {
            return a.hideInList ? "" : a.customCommnetListItem ? ($citem = $('<div class="cm-content" data-customid="' + a.customId + '" data-photo="' + a.photo + '">' + a.customCommnetListItem + "</div>"),
            a.customEvent && $citem.unbind("mousedown touchstart").bind("mousedown touchstart", function(b) {
                b.preventDefault(),
                b.stopPropagation(),
                console.info("click", a.customEvent),
                a.customEvent.clickEvent($citem, a.customData, a.customId)
            }),
        ...
        function getNowFormatDate() {
            ...
            var h = a.getSeconds();
            h >= 0 && 9 >= h && (h = "0" + h);
            var i = a.getFullYear() + b + d + b + e + " " + f + c + g + c + h;
            return i
        }
        ...
        function loadCommentListByiScroll(a) {
            var b = $danmuPanel.find(".p-comments .comment-list");
            $.each(a, function(a, b) {
                b.sort = stringTime2Time(b.createTime),
                danmuSortKey.push(b.sort)
            }),
            a = srotDanmuList(danmuSortKey, a);
            for (var c = 0; c < a.length; c++)
                b.find(".scroll-comment").append(getCommentHtml(a[c]));
        ...
        function getCommentList() {
            ajaxPost("comment/getCommentList", {
                ...
                0 === a.result && (a.data && a.data.length > 20 && (a.data = a.data.slice(0, 19)),
                $.each(a.data, function(a, b) {
                    b.photo = handleWxHeadImg(b.photo),
                    DM_Comment_List.push(b)
                }),
                a.likeData && a.likeData.length > 10 && (a.likeData = a.likeData.slice(0, 9)),
                $.each(a.likeData, function(a, b) {
                    b.photo = handleWxHeadImg(b.photo),
                    DM_Comment_Like_List.push(b)
                }),
                isShowDanmu() && (initDanmu(),
                isShowDanmuAnimate() && !window.rrxDanmuJump && danmuAnimateShow && Danmaku.start()))
            })
        }
        function initDanmu() {
            var a = "horizontal";
            if (void 0 !== _dataObj.danmuLike && null !== _dataObj.danmuLike && (a = _dataObj.danmuLike.style),
            onlyPluginDanmu) {
                var b = [];
                console.log(DM_Comment_List),
                ...
                console.log(b),
                Danmaku.setDanmuData(b),
                Danmaku.setDanmuLikeData(DM_Comment_Like_List)
            } else
                Danmaku.init({
                    style: a
                }),
                Danmaku.setDanmuData(DM_Comment_List),
                Danmaku.setDanmuLikeData(DM_Comment_Like_List)
        }
        ...
        function renderPage(a, b, c) {
            (void 0 === b || null === b) && (b = !0),
            (void 0 === c || null === c) && (c = !0),
            $(".pt-wrapper .arrow-down p").css("background-image", "none !important"),
            $(".pt-wrapper .arrow-down p").css("background-image", "none !important"),
            $page = _$canvas.find(".page_" + a),
            "sharepage" == a ? $page = $sharepage : "loadingpage" == a ? $page = $loadingpage : "floorpage" == a ? $page = $floorpage : "toppage" == a ? $page = $pagewrapper : b && flipLoadImage(a);
            var d = null
              , e = !1;
            return _dataObj.swipe = void 0,
            $page.data("isrender") !== !0 ? ("loadingpage" !== a && pageCodeInit(a, apiHelper.getAppInstance()),
            pageEventInit(a),
            $page.data("isrender", !0),
            d = getPageObjById(a),
            null !== d && (e = d.longPage,
            d.longPage ? (longPageObj.push(d),
            void 0 === d.longPagebgMode || "1" === d.longPagebgMode ? (parsePageBackgroundFixMode(d, $page),
            $page.append(parsePage(d))) : (parsePageBackgroundColor(d, $page),
            $page.append(parsePage(d)),
            parsePageBackgroundImage(d, $page.find(".pt-page-element-list-box")))) : void 0 === d.backgroundImageNaturalWidth || void 0 === d.backgroundView ? ($page.append(parsePageBackground(d)),
            $page.append(parsePage(d))) : (parsePageBackgroundColor(d, $page),
            $page.append(parsePage(d)),
            parsePageBackgroundImage(d, $page.find(".pt-page-element-list-box"))),
            d.elementList && !_isEditing && $.each(d.elementList, function(a, b) {
                if ("html" === b.type) {
                    if (e = !b.content.fullscreen && e,
                    b.content.scroll) {
                    ...
                    var g = "vertical" === b.textDirec
                      , h = apiHelper.getAppInstance().getElement(b.id, d.id);
                    if (h) {
            ...
            recoredPageRendered(a))) : c && (_isEditing || loadPluginEvent(a),
            d = getPageObjById(a),
            d.elementList && !_isEditing && $.each(d.elementList, function(a, b) {
                d.elementList[a].playedAnimation = !1
            }),
            e = d.longPage),
            c ? ($.isNumeric(a) || "loadingpage" !== a && pageCodeLoad(a, apiHelper.getAppInstance()),
            e) : void 0
        }
        function renderDialog(a) {
            $page = _$canvas.find(".page_" + a),
            (null === $page || void 0 === $page || 0 === $page.length) && $ptWrapper.append('<div class="pt-page dialog-page page_' + a + '" data-id="' + a + '"></div>'),
            $page = _$canvas.find(".page_" + a),
            flipLoadImage(a);
            var b = null;
            return iScrollLongPage = !1,
            $page.data("isrender") !== !0 ? ("loadingpage" !== a && pageCodeInit(a, apiHelper.getAppInstance()),
            pageEventInit(a),
            $page.data("isrender", !0),
            b = getPageObjById(a),
            null !== b && (void 0 === b.backgroundImageNaturalWidth || void 0 === b.backgroundView ? ($page.append(parsePageBackground(b)),
            $page.append(parsePage(b))) : (parsePageBackgroundColor(b, $page),
            $page.append(parsePage(b)),
            parsePageBackgroundImage(b, $page.find(".pt-page-element-list-box"))),
            b.elementList && !_isEditing && $.each(b.elementList, function(a, c) {
            ...
            regDialogCloseSelf(a),
            iScrollLongPage
        }
        function renderPageObj(a) {
            null !== a && (iScrollLongPage = a.longPage,
            a.longPage ? (longPageObj.push(a),
            void 0 === a.longPagebgMode || "1" === a.longPagebgMode ? (parsePageBackgroundFixMode(a, $page),
            $page.append(parsePage(a))) : (parsePageBackgroundColor(a, $page),
            $page.append(parsePage(a)),
            parsePageBackgroundImage(a, $page.find(".pt-page-element-list-box")))) : void 0 === a.backgroundImageNaturalWidth || void 0 === a.backgroundView ? ($page.append(parsePageBackground(a)),
            $page.append(parsePage(a))) : (parsePageBackgroundColor(a, $page),
            $page.append(parsePage(a)),
            parsePageBackgroundImage(a, $page.find(".pt-page-element-list-box"))),
            a.elementList && !_isEditing && $.each(a.elementList, function(b, c) {
                if ("html" === c.type && (iScrollLongPage = !c.content.fullscreen && iScrollLongPage,
                c.content.scroll)) {
        ...
        function renderPagePart(a, b) {
            ...
            if (!(d > pageListCount - 1)) {
                for (var e = d + 1; d + c > e && e < _pageIdList.length; e++)
                    _pageRendered[_pageIdList[e] + ""] || (rrxdebug && console.log("after will render", e, _pageIdList[e]),
                    rrxdebug && console.log(_pageRendered[e + ""]),
                    renderPage(_pageIdList[e], !0, b));
                for (var f = d - 1; f >= d - c && f >= 0; f--)
                    _pageRendered[_pageIdList[f] + ""] || (rrxdebug && console.log("before will render", f, _pageIdList[f]),
                    renderPage(_pageIdList[f], !0, b));
        ...
        function regDialogCloseSelf(a) {
            ...
            b.find(".pt-page-element-list-box").unbind("mousedown touchstart click").bind("mousedown touchstart click", function(b) {
                b.stopPropagation(),
                "pt-page-element-list-box" === b.currentTarget.className && "pt-page-element-list-box" === b.target.className && dialogClose(a)
            }),
            b.find(".element_pagebg").unbind("mousedown touchstart click").bind("mousedown touchstart click", function(b) {
                b.stopPropagation(),
                console.log("close", b),
                "element element_pagebg" !== b.currentTarget.className || "element element_pagebg" !== b.target.className && "pagebg_img" !== b.target.className || dialogClose(a)
            })
        }
        function renderProgress(a, b) {
            if (2 > pageListCount)
                return void $progress.css("display", "none");
            var c = "block";
            a === lastPageId && (c = "none");
            for (var d = _dataObj.pageList, e = a, f = 0; f < d.length; f++)
                if (d[f].id === a) {
                    e = f + 1;
                    break
                }
            var g = e / b * 100 + "%"
              , h = e + "/" + b;
            $progress.css("display", c),
            $(".progress-tip").animate({
                width: g
            }, 700),
            $(".progress-tip").css("display", "block"),
            $(".progress-tip").css("height", "100%"),
            $(".progress-tip").css("background-color", "#08A1EF"),
            $(".page-tip").html(h),
            $(".page-tip").css("display", "inline-block"),
            $(".page-tip").css("position", "absolute"),
            $(".page-tip").css("font-size", "16px"),
            $(".page-tip").css("bottom", "10px"),
            $(".page-tip").css("right", "10px"),
            $(".page-tip").css("color", "#fff")
        }
        function removeCopyrightContainer() {
            return _isWxMin ? ($(".copyright").remove(),
            !0) : !1
        }
        ...
        function renderCopyrightH5webpage() {
            _isHaveMenu && "rrxiu" !== _copyrightFrom && "bottom" !== _copyrightFrom && $copyright.css("bottom", "70px"),
            0 !== _dataObj.result ? createCopyrightWeplus(!0) : "customer" === _copyrightFrom ? createCopyrightCustomer() : createCopyrightWeplus()
        }
        ...
        function object2QueryString(a, b) {
            if (a) {
                ...
                return jQuery.each(a, function(a, d) {
                    d = $.trim(d),
                    void 0 !== d && null !== d && "" !== d && (b && (d = encodeURIComponent(d)),
                    c.push(a + "=" + d))
                }),
                c.join("&")
            }
        ...
        function navigateToWxMinShare() {
            var a = _dataObj.shareImageUrl || defaultShareImageUrl
              , b = getImageHost() + removeHostName(a)
              , c = _dataObj.guid + "VisitFirstLogGuid"
              , d = Cool.cookie.get(c)
              , e = {
                guid: _dataObj.guid,
                title: shareTitle,
        ...
        function switchToWxMinPage(a) {
            a = a || "index",
            appConfig.wxMinAppPath && wx.miniProgram.switchTab({
        ...
        function checkWxMinWhenWxReady() {
            wsiteInfo.wxp.isp ? _isWxMin || (_isWxMin = "miniprogram" === window.__wxjs_environment) : _isWxMin = "miniprogram" === window.__wxjs_environment,
            wsiteInfo.wxp.isp || (window.location.href.indexOf(rrxCommConfig.wxMinDomain) > -1 || 2 === wsiteInfo.rrxfp) && !_isWxMin && (window.location.href = appConfig.viewDomainFormat.replace("{guid}", _dataObj.guid)),
            setWxMinShare()
        }
        ...
        function createCopyrightCustomer() {
            $copyright.css("background-color", getCopyrightBgColor(_dataObj.copyright.bgColor)),
            $copyright.css("color", getCopyrightColor(_dataObj.copyright.color)),
            $copyright.css("text-align", getCopyrightTextAlign(_dataObj.copyright.textAlign)),
            $copyright.html(getCopyrightCustomer()),
            $copyright.prepend(getShowReportByWeplus()),
            registerReportEvent($copyright.find(".show-report")),
            _dataObj.showVisitCount && null !== _log && !getIsFromTpl() && setTimeout(function() {
        ...
        function getShowVisitByWeplus() {
            ...
            return _dataObj.flipProgress && (a += 'style="margin-right:40px;margin-bottom:2px;"'),
            a += ">阅读:" + _log.getVisitCount() + "</span>"
        }
        ...
        function createCopyrightWeplus(a) {
            var b = ""
              ...
              , e = null;
            $copyright.css("background-color", getCopyrightBgColor(c.bgColor)),
            $copyright.css("color", getCopyrightColor(c.color)),
            "na" === _copyrightFrom ? ($copyright.css("pointer-events", "none"),
            _dataObj.showVisitCount && a !== !0 && !getIsFromTpl() && setTimeout(function() {
                0 !== _log.getVisitCount() && (b = getShowVisitByWeplus(),
                $copyright.append(b))
            }, 1500)) : (b = "union" === _copyrightFrom ? getShowCopyrightByUnion() : getShowCopyrightByWeplus(),
            $copyright.css("text-align", "center"),
            a ? ($copyright.html(b),
            showCopyright(!0, currentPageId)) : (b = d + b,
            _dataObj.showVisitCount && null !== _log && !getIsFromTpl() && setTimeout(function() {
                0 !== _log.getVisitCount() && $copyright.append('<span class="show-visit">阅读:' + _log.getVisitCount() + "</span>")
            }, 1500),
            $copyright.html(b),
            registerReportEvent($copyright.find(".show-report")),
            e = getPageObjById(currentPageId),
            showCopyright(e ? e.stopFlip : !1, currentPageId)))
        }
        ...
        function getCopyrightContent(a) {
            return void 0 === a || "" === $.trim(a) ? "免费制作 → liao" : a
        }
        ...
        function createPageCodes() {
            if (_dataObj.pageCodeList = {},
            wsiteInfo.wxp.isp) {
                var pageList = _dataObj.pageList
                  , specialList = ["loadingpage", "floorpage", "sharepage"]
                  , pageCode = null;
                $.each(specialList, function(idx, sid) {
                    void 0 !== _dataObj[sid] ? void 0 !== _dataObj[sid].code && null !== _dataObj[sid].code && "" !== _dataObj[sid].code ? eval("_dataObj.pageCodeList['" + _dataObj[sid].id + "']= new function(){" + _dataObj[sid].code + " return this;};") : (pageCode = getCodeByCodeList(sid),
                    null !== pageCode && eval("_dataObj.pageCodeList['" + pageCode.id + "']= new function(){" + pageCode.code + " return this;};")) : "loadingpage" === sid && (pageCode = getCodeByCodeList(sid),
                    null !== pageCode && eval("_dataObj.pageCodeList['" + pageCode.id + "']= new function(){" + pageCode.code + " return this;};"))
                });
                var i = 0, pageItem;
                for (i = 0; i < pageList.length; i++)
                    pageItem = pageList[i],
                    void 0 !== pageItem.code && null !== pageItem.code && "" !== pageItem.code ? eval("_dataObj.pageCodeList['" + pageItem.id + "']= new function(){" + pageItem.code + " return this;};") : (pageCode = getCodeByCodeList(pageItem.id),
                    null !== pageCode && eval("_dataObj.pageCodeList['" + pageCode.id + "']= new function(){" + pageCode.code + " return this;};"));
                if (_dataObj.dialogList)
                    for (pageList = _dataObj.dialogList,
                    i = 0; i < pageList.length; i++)
                        pageItem = pageList[i],
                        void 0 !== pageItem.code && null !== pageItem.code && "" !== pageItem.code ? eval("_dataObj.pageCodeList['" + pageItem.id + "']= new function(){" + pageItem.code + " return this;};") : (pageCode = getCodeByCodeList(pageItem.id),
                        null !== pageCode && eval("_dataObj.pageCodeList['" + pageCode.id + "']= new function(){" + pageCode.code + " return this;};"));
                showloadingpageCode()
        ...
        function getPageCodes(a) {
            ...
            null !== b) {
                var d = !1
                  , e = 0;
                for (e = 0; e < _dataObj.pageList.length; e++)
                    a == _dataObj.pageList[e].id && (b = _dataObj.pageList[e],
                    d = !0);
                if (!d && _dataObj.dialogList)
                    for (e = 0; e < _dataObj.dialogList.length; e++)
                        a == _dataObj.dialogList[e].id && (b = _dataObj.dialogList[e])
            }
            return b
        }
        function loadExternalJsLibs(a) {
            if (_isSetting)
                return void a();
            if (void 0 === _dataObj.codeJsLibs)
                return createPageCodes(),
                void a();
            var b = _dataObj.codeJsLibs;
            return 1 === b.length && "" === $.trim(b[0]) ? (createPageCodes(),
            void a()) : void Cool.util.loadJs(b, function() {
                createPageCodes(),
                a()
            })
        }
        ...
        function pageEventInit(a) {
            ...
            (void 0 === b || null === b) && (_dataObj.pageEventList[a] = [],
            b = _dataObj.pageEventList[a]);
            var c = getPageObjById(a);
            if (null !== c) {
                if (!c.hasOwnProperty("elementList"))
                    return;
                for (var d = 0; d < c.elementList.length; d++) {
                    var e = c.elementList[d];
                    if (void 0 !== e.animationList) {
                        for (var f, g = 0; g < e.animationList.length; g++)
                            f = e.animationList[g],
                            (1 === parseInt(f.trigger) && "" !== f.eventName || 2 === parseInt(f.trigger)) && b.push({
                                name: f.eventName,
                                type: "animation",
                                elementId: e.id,
                                animation: f
        ...
        function triggerPageEvent(a, b, c) {
            ...
            if (void 0 !== _dataObj.pageEventList.floorpage && (d = d.concat(_dataObj.pageEventList.floorpage)),
            void 0 !== d && null !== d) {
                for (var e, f = {}, g = 0; g < d.length; g++)
                    e = d[g],
                    e.name == b && ("animation" == e.type ? f[e.elementId] ? f[e.elementId].push(e.animation) : f[e.elementId] = [e.animation] : "imageAnimation" == e.type ? (clearRegIntervals(a, e.elementId),
                    regImgElementEvent(a, e.elementId, e.animation, e.name)) : "audioEvent" === e.type ? regAudioEvent(a, e.elementId, e.animation, e.name) : "videoEvent" === e.type ? regVideoEvent(a, e.elementId, e.animation, e.name) : "customEvent" == e.type && void 0 !== e.callback && e.callback(c));
                for (var h in f)
                    for (var i, j = 0, k = 0, l = f[h], m = 0; m < l.length; m++)
                        i = l[m],
                        (1 === parseInt(i.trigger) && "" !== i.eventName || 2 === parseInt(i.trigger)) && (i.duration + i.delay > k && (k = i.duration + i.delay),
                        j > 0 && 0 !== i.delay ? playSecondAnimation(_$canvas, {
                            id: h
                        }, i, a) : playAnimation(_$canvas, h, i, !1, a),
                        j++)
            }
        }
        function createCopyRightPage() {
            try {
                if (("we+" === _copyrightFrom || "rrxiu" === _copyrightFrom) && 0 === _dataObj.result && !isOldWsite()) {
                    ...
                    a.elementList[0].content.html = c.replace("{{shareTitle}}", _dataObj.title).replace("{{shareImageUrl}}", d).replace("{{showVisitCount}}", _dataObj.showVisitCount ? "block" : "none"),
                    _dataObj.pageList.push(a),
                    hasCopyRightPage = !0
                }
            } catch (e) {}
        }
        ...
        function createCopyRightPage2() {
            try {
                if (getCanShowCopyrightPageEnd() && 0 === _dataObj.result && !isOldWsite()) {
                    getIsFlipDown() || ($pageCopyrightPageEnd.removeClass("damu-down").addClass("damu-right"),
                    $pageCopyrightPageEnd.css({
                        top: 0,
                        left: "100%"
                    }));
                    var a = "";
                    ...
                    b = b.replace("{{shareTitle}}", _dataObj.title).replace("{{shareImageUrl}}", c).replace("{{showVisitCount}}", _dataObj.showVisitCount ? "block" : "none").replace("{{makeRRXUrl}}", getMakeRRxUrl()).replace("{{makeRRXText}}", appConfig.copyright.content),
                    $pageCopyrightPageEnd.html(b),
                    _dataObj.showVisitCount && setTimeout(function() {
                        var a = _log.getVisitCount()
                          , b = $pageCopyrightPageEnd.find(".show-rrxiu-visit");
                        !getIsFromTpl() && b.length > 0 && a > 0 ? (b.css("display", "block"),
                        b.html(b.html().replace("{{visitCount}}", a))) : b.css("display", "none")
                    }, 1500),
                    registerReportEvent($pageCopyrightPageEnd.find(".show-rrxiu-report")),
                    hasCopyRightPage = !0,
                    $pageCopyrightPageEnd.find(".rrx-icon-close-layer").unbind().bind(clickEventType, function(a) {
                        a.stopPropagation(),
                        a.preventDefault(),
                    ...
                    _isWxMin && !getIsFromTpl() && $pageCopyrightPageEnd.find(".mini-home-button").off().on(clickEventType, function(a) {
                        a.stopPropagation(),
                        a.preventDefault(),
                        switchToWxMinPage("index")
                    }),
                    getIsFlipDown() ? (touch.on($pageCopyrightPageEnd, "swipedown", function(a) {
                        copyrightPageEndHide()
                    }),
                    touch.on($pageCopyrightPageEnd, "swipeup", function(a) {
                        "stop" !== lastPageGoto && (console.log("netx"),
                        pageListCount > 1 ? (copyrightPageEndHideNoAnim(),
                        isCopyrightPageEndGotoFirst = !0,
                        goToNextPage()) : (copyrightPageEndHideNoAnim(),
        ...
        function copyrightPageEndShow() {
            getCanShowCopyrightPageEnd() && (hideDanmuInfo(),
            apiHelper.getAppInstance().stopFlip(),
            playShowCopyrightPageAnim(),
            setBlurBgPage(),
            isCopyrightPageEndShow = !0)
        }
        function copyrightPageEndHide() {
            getCanShowCopyrightPageEnd() && (resetDanmuInfo(),
            apiHelper.getAppInstance().resetFlip(!0),
            playHideCopyrightPageAnim(),
            removeAllBlurPage(),
        ...
        function copyrightPageEndHideNoAnim() {
            ...
            apiHelper.getAppInstance().resetFlip(!0);
            $pageCopyrightPageEnd.css("display", "none"),
            getIsFlipDown() ? ($pageCopyrightPageEnd.removeClass("damu-up"),
            $pageCopyrightPageEnd.addClass("damu-down")) : ($pageCopyrightPageEnd.removeClass("damu-left"),
            $pageCopyrightPageEnd.addClass("damu-right")),
            removeAllBlurPage(),
            isCopyrightPageEndShow = !1
        }
        function getCopyrightPageValue(a, b) {
            return void 0 !== _dataObj.copyrightPage ? (b = b || "",
            null !== _dataObj.copyrightPage && void 0 !== _dataObj.copyrightPage[a] ? b + _dataObj.copyrightPage[a] : null) : null
        }
        ...
        function getViewHost() {
            if (appConfig.dev)
                return appConfig.viewHost;
            if (_isWxMin)
                return appConfig.viewHost;
            if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
                return appConfig.viewHost.replace("http://", "https://");
        ...
        function setMusicIcon(a, b) {
            if ("" !== a) {
                if (_isWxMin)
                    return getImageHost() + removeHostName(a);
                if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
                    a = a.replace("http://", "https://");
                else {
        ...
        function setMusicPosition() {
            _isWxMin && (musicPosition = "rt"),
            wsiteInfo.wxp.isp || (musicPosition = "rt"),
            "rb" === musicPosition ? ($iconMusic.css("right", "23px"),
            $iconMusic.css("bottom", "3%")) : "lt" === musicPosition ? isShowFocusWechat() ? ($iconMusic.css("right", "23px"),
            $iconMusic.css("top", "3%")) : ($iconMusic.css("left", "23px"),
            $iconMusic.css("top", "3%")) : "lb" === musicPosition ? ($iconMusic.css("left", "23px"),
            $iconMusic.css("bottom", "3%")) : ($iconMusic.css("right", "23px"),
            $iconMusic.css("top", "3%"))
        }
        function autoPlayBackGroundMusicByWeixin() {
            if (Cool.util.checkIsWeixin() === !0 && wsiteInfo && wsiteInfo.loading) {
                var a = wsiteInfo.loading.musicAutoPlay
                  , b = !1;
                (1 === a || "1" === a) && (b = !0);
                var c = wsiteInfo.loading.musicUrl;
                if (void 0 !== c && "" !== c && (c = apiHelper.getAppInstance().musicPreFix(c)),
                b) {
                    if (null === $music) {
                        var d = document.createElement("audio");
                        d.setAttribute("src", c),
                        d.setAttribute("id", "viewBgMusicId"),
                        d.setAttribute("preload", "true"),
                        d.setAttribute("autoplay", "autoplay"),
                        $("body").append(d),
                        $music = document.getElementById("viewBgMusicId")
                    }
        ...
        function canPlayAudio(a, b) {
            a.paused && (b && (a.currentTime = 0,
            a.load()),
            a.play(),
            Cool.util.checkIsWeixin() === !0 ? document.addEventListener("WeixinJSBridgeReady", function() {
                a.play(),
                WeixinJSBridge.invoke("getNetworkType", {}, function(b) {
                    a.paused && (a.play(),
                    Cool.util.checkIsAndroid() && a.paused && $(window).one("click", function() {
                        a.play()
                    }))
                })
            }, !1) : a.play())
        ...
        function playMusic(a) {
            if (null !== $music)
                ...
                b.setAttribute("src", musicUrl),
                b.setAttribute("id", "viewBgMusicId"),
                b.setAttribute("preload", "true"),
            ...
            $iconMusic.show(),
            $iconMusic.off().on("click", function(a) {
                a.stopPropagation(),
                a.preventDefault(),
                reloveTwoClickByISroll() && ($music.paused ? playMusic() : stopMusic())
            })),
            null !== $music && ($music.paused ? ($music.play(),
            setMusicIconOff()) : (setMusicIcon(musicPlayIcon, "on"),
            $iconMusic.removeClass("music-play"),
            $iconMusic.removeClass("music-play-none"),
            $iconMusic.addClass("" === musicPlayIcon ? "music-play" : "music-play-none")),
            $music.paused && $(document).off().on("click", function() {
                $(document).off(),
                $music.paused && (_isWxMin ? 0 === playCount && playMusic() : playMusic())
            }))
        }
        function stopMusic() {
            null !== $music && ($music.paused || $music.pause(),
            setMusicIconOff())
        }
        function setMusicIconOff() {
            setMusicIcon(musicStopIcon, "off"),
            $iconMusic.removeClass("music-play"),
            $iconMusic.removeClass("music-play-none")
        }
        ...
        function handleAllPageImageThumb() {
            for (var a = _dataObj.pageList, b = 0, c = a.length; c > b; b++)
                getImageListByPage(a[b])
        }
        function getLoadingImageList(a) {
            ...
            if (_preloadAllResource) {
                ...
                for (c = 0; c < d.length; c++)
                    b = getImageListByPage(d[c]),
                    d[c] != a && loadImgList(b, 1)
            } else {
        ...
        function updateLoadingPercent(a) {
            $loadingpage.find(".line").css("width", a + "%"),
            $loadingpage.find(".percent").html(a + "%")
        }
        function filterUserImage(a) {
            return a.indexOf("@!user_image_") > -1 || a.indexOf("data:image") > -1 ? !1 : !0
        }
        function getImageListByPage(a) {
            ...
            if (null !== a) {
                var c = []
                  ...
                  , e = "";
                if (a.elementList)
                    for (var f = 0; f < a.elementList.length; f++) {
                        var g = a.elementList[f].content
                          , h = a.elementList[f].type;
                        if ("img" === h) {
                            var i = g.width || 0;
                            if (e = handleImgUrl(g.src),
                            filterUserImage(e) && (e += Cool.util.getImageThumb(i, "", e),
                            g.src = e),
                            b.push(e),
                            g.showImageBorder && ("" !== g.border && b.push(handleImgUrl(g.border)),
                            "" !== g.mask && b.push(handleImgUrl(g.mask))),
                            g.showAnimation && (c = g.imageList,
                            void 0 !== c))
                                for (var j = 0; j < c.length; j++)
                                    e = handleImgUrl(c[j].src),
                                    filterUserImage(e) && (e += Cool.util.getImageThumb(i, "", e),
                                    c[j].src = e),
                                    b.push(e)
                        } else if ("imggroup" === h) {
                            ...
                            for (var k = 0; k < c.length; k++)
                                d = a.elementList[f].width,
                                e = handleImgUrl(c[k].src),
                                filterUserImage(e) && (e += Cool.util.getImageThumb(d, h, e),
                                c[k].src = e),
                                b.push(e);
                            ...
                            if ("卡片" === g.name && g.imageList) {
                                ...
                                for (var l = 0; l < c.length; l++)
                                    "" !== c[l].src && (d = a.elementList[f].width,
                                    e = handleImgUrl(c[l].src),
                                    filterUserImage(e) && (e += Cool.util.getImageThumb(d, "", e),
                                    c[l].src = e),
                                    b.push(e))
                            }
                        } else if ("svgShape" === h) {
                            var m = getSvgFullUrl(g.src);
                            "" !== m && b.push(m)
                        }
                    }
                "" !== a.backgroundImage && void 0 !== a.backgroundImage && (e = handleImgUrl(a.backgroundImage),
                filterUserImage(e) && (e += Cool.util.getImageThumb(a.backgroundImageNaturalWidth, "", e),
                a.backgroundImage = e),
                b.push(e))
            }
            return b
            ...
            for (var b, c = [], d = [], e = !1, f = 0; f < a.length; f++) {
                ...
                if (void 0 !== g && "" !== g && null !== g)
                    for (var h = 0; h < g.length; h++)
                        "plugin" === g[h].type ? (b = Cool.util.getPluginDomain(g[h].content.token, g[h].content.version) + "index.js",
                        -1 === d.indexOf(b) && c.push({
                            element: g[h],
        ...
        function loading(a, b, c) {
            ...
            if (0 === h) {
                var j = setInterval(function() {
                    _allowFlip === !0 && (clearInterval(j),
                    setTimeout(function() {
                        $loadingpage.addClass("pt-page-fadeOut animated"),
                        setTimeout(function() {
                            $loadingpage.hide()
                        }, 500),
                        c()
                ...
                for (var l = !1, m = function() {
                    ...
                    if (percent >= a && l === !1) {
                        ...
                        var d = setInterval(function() {
                            _allowFlip === !0 && (clearInterval(d),
                            setTimeout(function() {
                                $loadingpage.hasClass("pt-page-fadeOut") === !1 && ($loadingpage.addClass("pt-page-fadeOut animated"),
                                setTimeout(function() {
                                    $loadingpage.hide()
                                }, 500),
                                c())
                    ...
                    loadSvg(a).then(function(b, c, d) {
                        4 == d.readyState && 200 == d.status && (isLoadedSvg(a) || pushLoadedSvgKey(a),
                        saveLoadedSvgXml(a, d.responseText)),
                        n()
                    }, function(a) {
                        console.error(a),
                        n()
                ...
                var r = []
                  , s = function(a) {
                    if (a && "0" != a.length) {
                        ...
                        m(),
                        s(a)) : (r.push(b.url),
                        Cool.util.loadJs(b.url, function() {
                            $wePluginClient.add(b.token, b.version, window.wePluginInit, window.wePluginLoad, window.wePluginPreLoad, window.wePluginLeave),
                            $wePluginClient.preload(b.element),
                            i++,
                            m(),
                            s(a)
                        }))
            ...
            if (b.data("isrender") !== !0) {
                ...
                if (void 0 !== e) {
                    ...
                    for (c = 0; c < e.length; c++)
                        ...
                        f.id == a) {
                            c > 0 && d.push(e[c - 1].id),
                            c < e.length - 1 && d.push(e[c + 1].id);
                            break
                        }
                    for (c = 0; c < d.length; c++)
                        if (b = _$canvas.find(".page_" + d[c]),
                        b.data("isrender") !== !0) {
        ...
        function showLoadingpage() {
            void 0 !== _dataObj.llImageUrl && "" !== _dataObj.llImageUrl || _dataObj.showCustomLoadingLogo || void 0 !== _dataObj.loadingpage && void 0 !== _dataObj.loadingpage.title && ($loadingpage.html(""),
            renderPage("loadingpage"),
            playPageByPageId("loadingpage"))
        }
        function showloadingpageCode() {
            void 0 !== _dataObj.loadingpage && (pageCodeInit("loadingpage", apiHelper.getAppInstance()),
            pageCodeLoad("loadingpage", apiHelper.getAppInstance()))
        }
        function showFloorpage() {
            void 0 !== _dataObj.floorpage && (renderPage("floorpage"),
            playPageByPageId("floorpage"))
        }
        function showToppage() {
            void 0 !== _dataObj.toppage && void 0 !== _dataObj.toppage.elementList && _dataObj.toppage.elementList.length > 0 && (renderPage("toppage"),
            playPageByPageId("toppage"))
        }
        function showSharepage() {
            void 0 !== _dataObj.sharepage ? (renderPage("sharepage"),
            playPageByPageId("sharepage")) : renderDefautShareInfo(),
            $sharepage.show()
        }
        ...
        function renderDefautShareInfo() {
            checkDefautShareInfoSetting(),
            $sharepage.css("background-color", appConfig.shareInfo.bgColor),
            $sharepage.css("color", appConfig.shareInfo.color);
        ...
        function showReportpage() {
            if (_reportInit === !1) {
                ...
                $reportpage.css("position", "absolute"),
                $reportpage.css("z-index", "10000"),
                $reportpage.css("width", "100%"),
                $reportpage.css("height", "100%"),
                _reportInit = !0;
                    ...
                    !e) {
                        ...
                        if ("" !== b) {
                            ...
                            setTimeout(function() {
                                ...
                                $reportpage.find(".report-msg").show(),
                                e = !1
                            }, 500)
                        }
                    }
                ...
                d.on(clickEventType, function(a) {
                    _isWxMin ? $reportpage.css("display", "none") : "undefined" != typeof WeixinJSBridge ? WeixinJSBridge.call("closeWindow") : (window.close(),
                    setTimeout(function() {
                        $reportpage.css("display", "none")
                    }, 1e3))
                })
                ...
                $reportpage.css("display", "block"),
                $reportpage.find(".report-content").show(),
                $reportpage.find(".report-msg").hide()
        }
        function suspended(a) {
            void 0 === a && (a = "暂停访问"),
            html = '<div class="pt-reportpage page_reportpage" style="display:none"></div><div class="pt-wrapper"><div class="pt-suspended"><div class="msg">' + a + "</div></div><div class=\"copyright\"><a href='http://www.rrxiu.net' target='_blank'><div>使用 <span>liao</span> 制作</div></a></div></div>",
            _$canvas.find(".pt-inner").append(html),
            _copyrightFrom = "rrxiu",
            $copyright = _$canvas.find(".copyright"),
            $reportpage = _$canvas.find(".pt-reportpage"),
            renderCopyright(),
            showCopyright(!0)
        }
        function needCode(a) {
            void 0 === a && (a = "需要授权"),
            html = '<div class="pt-wrapper" id="pt-wrapper-needcode"><div class="pt-code"><div class="code-title">' + _dataObj.title + '</div><div class="msg">' + a + "</div><div><table><tr><td><input type='text' name='code' class='code-value' placeholder='输入授权码' /></td></tr><tr><td><input class='code-submit' type='button' value='提交'/></td></tr></table></div><div class=\"copyright\"><a href='http://www.rrxiu.net' target='_blank'><div>使用 <span>liao</span> 制作</div></a></div></div>",
            _$canvas.find(".pt-inner").append(html),
            $code = _$canvas.find(".code-value"),
            $btn = _$canvas.find(".code-submit"),
            $btn.bind(clickEventType, function() {
                var a = $code.val();
                if ("" !== a) {
                    ...
                    $.ajax({
                        ...
                        complete: function() {
                            ...
                            _log = new WePlusLog(_host,_dataObj.guid,a,b,_isPreview),
                            base.init(_host, _$canvas, coolData, _isPc, _isWeixin, _log, _isEditing, _isPreview)
                        }
                    })
                }
            })
        ...
        function initBone() {
            html = '<div class="pt-reportpage page_reportpage" style="display:none"></div><div class="pt-sharepage page_sharepage"></div><div class="share-poster-result-dialog" style="-webkit-user-select:none"></div><div class="share-poster-process-dialog" style="-webkit-user-select:none"></div><img class="focus-wechat-button" style="pointer-events:auto"><img class="top-menu-button" style="pointer-events:auto"><div class="focus-wechat-panel damu-down"></div><div class="focus-plugin-wxqr-panel"></div><div class="top-menu-panel damu-down"></div><div class="share-panel damu-down"></div><div class="page_copyrightPage damu-down"></div><div class="cart-button rrx-icon-sidle-cart"><span class="cart-num"></span></div><div class="danmu-button rrx-icon-sidle-danmu"></div><div class="danmu-panel damu-down"></div><div class="copyright"></div><div class="plugin-copyright"></div><div class="wxmin-share-button">分享</div><div class="danmu-show"></div><div class="pt-preview-notice">预览模式，仅供测试</div><div class="pt-wrapper"><div class="pt-pagewrapper"><div class="pt-floorpage page_floorpage"></div><div class="pt-pagelist"></div><div class="pt-progress"><span class="progress-tip"></span><span class="page-tip"></span></div></div><div class="arrow-down"><p></p></div><div class="arrow-right"><p></p></div><div class="music"><span class="music1"><s></s></span><span class="music2"><s></s></span><span class="music3"><s></s></span></div><div class="sidle-share rrx-icon-share"></div><div class="sidle-report rrx-icon-report"></div><div class="sidle-plugin-msg rrx-icon-msg"></div></div>',
            _$canvas.find(".pt-inner").append(html),
            $ptWrapper = _$canvas.find(".pt-wrapper"),
            $previewNotice = _$canvas.find(".pt-preview-notice"),
            $copyright = _$canvas.find(".copyright"),
            $pluginCopyright = _$canvas.find(".plugin-copyright"),
            $wxminShareButton = _$canvas.find(".wxmin-share-button"),
            $pagewrapper = _$canvas.find(".pt-pagewrapper"),
            $pagelist = _$canvas.find(".pt-pagelist"),
            $progress = _$canvas.find(".pt-progress"),
            $floorpage = _$canvas.find(".pt-floorpage"),
            $loadingpage = _$canvas.find(".pt-loadingpage"),
            $sharepage = _$canvas.find(".pt-sharepage"),
            $reportpage = _$canvas.find(".pt-reportpage"),
            $sharepage.bind(clickEventType, function() {
                $(this).hide()
            }),
            $iconArrowDown = _$canvas.find(".arrow-down"),
            $iconArrowRight = _$canvas.find(".arrow-right"),
            $iconMusic = _$canvas.find(".music"),
            $focusButton = _$canvas.find(".focus-wechat-button"),
            $topMenuButton = _$canvas.find(".top-menu-button"),
            $focusPanel = _$canvas.find(".focus-wechat-panel"),
            $topMenuPanel = _$canvas.find(".top-menu-panel"),
            $sharePanel = _$canvas.find(".share-panel"),
            $sharePosterDialog = _$canvas.find(".share-poster-result-dialog"),
            $pageCopyrightPageEnd = _$canvas.find(".page_copyrightPage"),
            $danmuButton = _$canvas.find(".danmu-button"),
            $danmuPanel = _$canvas.find(".danmu-panel"),
            $danmuShow = _$canvas.find(".danmu-show"),
            $focusWxQrPanel = _$canvas.find(".focus-plugin-wxqr-panel"),
            $cartButton = _$canvas.find(".cart-button"),
            isShowDanmu() || $cartButton.css("bottom", "90px"),
            $pluginMsgButton = _$canvas.find(".sidle-plugin-msg")
        }
        function initSwipe() {
            var a = !1;
            setScrollFn(),
            $pagewrapper.on("mousedown touchstart", function(b) {
                rrxdebug && console.log("$pagewrapper touchstart"),
                a = !0,
                (_allowFlip && !getPageStopflip(currentPageId) && pageEffectComplete(currentPageId) || "copyrightPage" === currentPageId) && scrollStart(b)
            }),
            $pagewrapper.on("mousemove touchmove", function(b) {
                rrxdebug && console.log("$pagewrapper touchmove"),
                a && (_allowFlip && !getPageStopflip(currentPageId) && pageEffectComplete(currentPageId) || "copyrightPage" == currentPageId ? (scrollMove(b),
                rrxdebug && console.info("can flip")) : rrxdebug && console.info("cannot flip pid", currentPageId, _allowFlip)),
                rrxdebug && console.log("touchmove")
            }),
            $pagewrapper.on("mouseup touchend mouseleave", function(b) {
                rrxdebug && console.log("$pagewrapper touchend", b),
                a = !1,
                (_allowFlip && !getPageStopflip(currentPageId) && pageEffectComplete(currentPageId) || "copyrightPage" === currentPageId) && scrollEnd(b)
            }),
        ...
        function getCoord(a) {
            ...
            var b, c;
            return ("mousedown" == a.type || "mousemove" == a.type) && (b = a.pageX - left,
            c = a.pageY - top),
            ("touchstart" == a.type || "touchmove" == a.type) && (b = a.touches ? a.touches[0].pageX : a.originalEvent.touches[0].pageX,
            c = a.touches ? a.touches[0].pageY : a.originalEvent.touches[0].pageY),
            {
        ...
        function scrollStart(a) {
            if (isSliding = !0,
            _isDisableFlipPage)
                rrxdebug && console.log("_isDisableFlipPage true");
            else {
                scrolling || (_$activePage = null),
                rrxdebug && console.log("isStart = true"),
                isStart = !0,
                isNext = !1,
                isFirstTime = !0,
                moveDistanceX = 0,
                ...
                b && (startX = b.x,
                startY = b.y),
                _$currentPage = _$canvas.find(".page_" + currentPageId).first(),
                cssAnimation(_$currentPage[0].style, "Transition", "none")
            }
        }
        function scrollMove(a) {
            if (enableScroll()) {
                ...
                var b = getCoord(a);
                b && (moveDistanceX = b.x - startX,
                moveDistanceY = b.y - startY),
                setScrollFn(),
                rrxdebug && console.log("绑定移动方法"),
                doScrollMoveFn()
            } else
                rrxdebug && console.log("not scrollMove")
        }
        function scrollEnd(a) {
            isSliding = !1,
            scrolling = !1,
            rrxdebug && console.log("isStart", isStart),
            isStart && (isStart = !1,
            rrxdebug && console.log("_$activePage", _$activePage),
            _$activePage && (_isDisableFlipPage = !0,
            setScrollEndAnim(),
            setScrollFn(),
            doScrollEndFn())),
            _canContinue = !0
        ...
        function flipend() {
            $pluginCopyright.hide(),
            _pageScrollEnd = !1;
            var a = currentPageId;
            currentPageId = _$activePage.data("id"),
            console.log(currentPageId),
            $page = _$activePage,
            rrxdebug && console.log("flipend", currentPageId),
            rrxdebug && console.log("regPageEndEvent", currentPageId);
            var b = _$activePage.data("id");
            b == lastPageId ? b === _copyrightId && (hideDanmuInfo(),
            _pageScrollEnd = !0) : a === _copyrightId && resetDanmuInfo(),
            setPageArrowIcon(currentPageId),
            triggerPluginLeaveEvent(a),
            rrxdebug && console.info("flipend-showCopyright ", currentPageId, lastPageId, _copyrightId),
            currentPageId == lastPageId && "rrxiu" !== _copyrightFrom ? (rrxdebug && console.log("flipend-showCopyright ", currentPageId, lastPageId),
            showCopyright(!0, currentPageId),
            getCanShowCopyrightPageEnd() ? showArrow() : hideArrow()) : (showCopyright(!1, currentPageId),
            showArrow()),
            renderPagePart(currentPageId, !1),
            setTimeout(function() {
                _flipProgress === !0 && renderProgress(currentPageId, totalPages)
            }, 10),
            setTimeout(function() {
                regPageEndEvent(currentPageId),
                cssAnimation(_$currentPage[0].style, "Transition", "none"),
                deactive(_$activePage).addClass("pt-page-current"),
                deactive(_$currentPage).removeClass("pt-page-current"),
                _$currentPage = _$activePage,
                _isDisableFlipPage = !1,
                _$currentPage.css("z-index", "1"),
                $(".pt-page").attr("style", ""),
                rrxdebug && console.log("end"),
                updateUserReadDepth(),
                "loadingpage" !== currentPageId && pageCodeLoad(currentPageId, apiHelper.getAppInstance()),
                _isEditing || loadPluginEvent(currentPageId),
                resetLongPage(),
                flipBlurPage(),
                isCopyrightPageEndGotoFirst = !1
            }, flipEndTimeout)
        ...
        function setScrollFn() {
            ...
            _scrollMode = b,
            doScrollMoveFn = scroll[a + b + "Move"],
            doScrollEndFn = scroll[a + b + "End"]
        }
        function getPageDomById(a) {
            return _$canvas.find(".page_" + a).first()
        }
        function enableScroll() {
            return rrxdebug && console.log("isStart _dataObj.pageList", isStart, _dataObj.pageList),
            getCanShowCopyrightPageEnd() ? isStart && _dataObj.pageList.length > 0 : isStart && _dataObj.pageList.length > 1
        }
        ...
        function setCssWhenEnd(a, b, c, d) {
            cssAnim(_$currentPage, "transform", "scale(1)"),
            cssAnim(_$activePage, "transform", a + "(0px)")
        }
        function setCssWhenEndForCopyright(a, b, c, d, e) {
            cssAnim(a, "transform", "scale(1)"),
            cssAnim(a, "transform", b + "(0px)")
        }
        ...
        function cancelFlip() {
            ...
            var a;
            setScrollFn(),
            a = moveDistanceY > 0 ? -windowHeight : windowHeight,
            cssAnim(_$activePage, "transform", "translateY(" + a + "px)"),
            cssAnim(_$currentPage, "transform", "translateY(0) scale(1)"),
            setTimeout(function() {
                _$currentPage.attr("style", ""),
                _$activePage.attr("style", ""),
                "copyrightPage" === currentPageId && _$activePage.css({
                    display: "block"
                }),
                deactive(_$activePage),
                _isDisableFlipPage = !1
            }, 500)
        }
        function getMoveInit(a, b, c, d) {
            ...
            active(_$activePage);
            var f = a ? "-" : "";
            e[0].style.webkitTransition = "none",
            e[0].style.transition = "none",
            e[0].style.webkitTransform = c + "(" + f + d + "px)",
            e[0].style.transform = c + "(" + f + d + "px)",
            cssAnim(_$currentPage, "transform-origin", b)
        }
        function active(a) {
            return playPageByPageId(a.data("id")),
            a.addClass("z-active")
        }
        function deactive(a) {
        ...
        function setScrollEndAnim() {
            var a = "linear";
            "LRSlide" === _scrollMode && setTransition(_$currentPage[0], animTime, a),
            setTransition(_$activePage[0], animTime, a)
        }
        function setTransition(a, b, c) {
            a.style.webkitTransition = "-webkit-transform " + b + "s " + c,
            a.style.transition = "transform " + b + "s " + c
        }
        function getActivePage(a) {
            if (scrolling)
                return _$activePage;
            var b;
            return "prev" === a ? (b = getActualPageId(-2),
            getPageDomById(b)) : "next" === a ? (b = getActualPageId(-1),
            getPageDomById(b)) : void 0
        }
        function goToPrePage() {
            console.log("goToPrePage");
            var a = 0;
            scrollStart(),
            timer_goToPrePage = setInterval(function() {
                a += 2,
                _scrollMode.indexOf("LR") > -1 ? moveDistanceX = a : moveDistanceY = a,
                scrollMove(),
                a >= 21 && (clearInterval(timer_goToPrePage),
                timer_goToPrePage = null,
                scrollEnd())
            }, 1)
        }
        function goToNextPage() {
            ...
            var a = 0;
            scrollStart(),
            timer_goToNextPage = setInterval(function() {
                a -= 2,
                rrxdebug && console.log("e", a, _scrollMode, moveDistanceY),
                rrxdebug && console.log(_scrollMode, a),
                _scrollMode.indexOf("LR") > -1 ? moveDistanceX = a : moveDistanceY = a,
                scrollMove(),
                -21 >= a && (clearInterval(timer_goToNextPage),
                timer_goToNextPage = null,
                scrollEnd(),
                rrxdebug && console.log("clear..........."))
            }, 1)
        }
        function isCurrentToCurrent(a) {
            return "next" == a || "pre" == a ? !1 : ("first" == a && (a = getFirstPageId()),
            _$activePage = getPageDomById(a),
            _$activePage.length > 0 ? parseInt(a) === parseInt(currentPageId) : !0)
        }
        function goToPageById(a) {
            if (!isCurrentToCurrent(a) && (renderPagePart(a, !1),
            !_isDisableFlipPage))
                if ("first" === a)
                    goToPageById(getFirstPageId());
                else if ("next" === a)
                    goToNextPage();
                else if ("pre" === a)
                    goToPrePage();
                    ...
                    if (scrolling = !0,
                    _$activePage = getPageDomById(a),
                    _$activePage.length > 0) {
                        var c = _pageIdList.indexOf(parseInt(currentPageId, 10))
                          , d = _pageIdList.indexOf(parseInt(a, 10));
                        c > d ? goToPrePage() : d > c && goToNextPage()
                    }
                }
        }
        ...
        function beforeScrollEndThenCopyrightEndPage(a) {
            rrxdebug && console.log(a),
            a == lastPageId && a === _copyrightId && ($(".make-rrxiu").hide(),
            $(".show-rrxiu-visit").hide(),
            hideDanmuInfo(),
            showCopyrightEndPage())
        }
        function isStopNextPage() {
            if (rrxdebug && console.log("isStopNextPage", currentPageId, lastPageId),
            currentPageId == lastPageId) {
                if (getCanShowCopyrightPageEnd())
                    return !1;
                if ("stop" == lastPageGoto)
                    return !0
            }
            return !1
        }
        function isContinuePrePage() {
            return rrxdebug && console.log("isContinuePrePage", currentPageId, lastPageId),
            currentPageId == firstPageId ? !1 : !0
        }
        ...
        function rrxScrollLongPage(b, e) {
            function f() {
                rrxdebug && console.log("addTouchEvent", i),
                i.on("mousedown touchstart", function(a) {
                    rrxdebug && console.log("long page touchstart", p, h.height, a);
                    var b = a.target;
                    if (c = b.tagName,
                    d = b.getAttribute("ctype") ? b.getAttribute("ctype").charAt(0) : "",
                    cname = b.getAttribute("class"),
                    rrxdebug && console.log("long evt target", b, c, d, a),
                    "SELECT" == c || "TEXTAREA" == c || "BUTTON" == c || "INPUT" == c || b.getAttribute("data") || b.getAttribute("href") || "option-label" == cname)
                        A = !1,
                        a.stopPropagation();
                    else {
                        A = !0,
                        ...
                        t = g ? g.clientY : a.clientY,
                        t /= _pt_inner_scale_value,
                        "WE" == p && (v = g ? g.clientX : a.clientX,
                        v /= _pt_inner_scale_value),
                        y = touchPos,
                        b = Date.now(),
                        rrxdebug && console.log("v m w", t, v, y)
                    }
                }),
                i.on("mousemove touchmove", function(b) {
                    if (rrxdebug && console.log("long page touchmove", p, b),
                    b.stopPropagation(),
                    A && b.preventDefault(),
                    r) {
                        ...
                        if (e /= _pt_inner_scale_value,
                        u = touchPos + e - t,
                        "WE" == p) {
                            var f = c ? c.clientX : b.clientX;
                            f /= _pt_inner_scale_value,
                            w = f - v
                        }
                        if (Math.abs(w) > Math.abs(u - touchPos))
                            return w > 0 ? goToPrePage() : goToNextPage(),
                            s = !1,
                            void (rrxdebug && console.log(1));
                        if (u > 0 && "NS" == p && !q)
                            return rrxdebug && console.log(2),
                            goToPrePage(),
                            s = !1,
                            void (touchPos = 0);
                        if (rrxdebug && console.info("g o", u, l),
                        u > l && 0 > u)
                            g(u),
                            doTransformIscrollWrapper(i, u, 0),
                            rrxdebug && console.log(3);
                        else if (l > u + 20 && "NS" == p && !q)
                            return rrxdebug && console.log(4),
                            touchToBottomCount += 1,
                            rrxdebug && console.log("_toBottomCount", touchToBottomCount, touchEndCount),
                            touchToBottomCount > 1 && touchEndCount > 0 && goToNextPage(),
                            s = !1,
                            void (touchPos = l);
                        z = Date.now(),
                        z - x > 300 && (x = z,
                ...
                i.on("mouseup touchend mouseleave", function(a) {
                    ...
                    if (console.log(e),
                    rrxdebug && console.log("long page touchend", touchPos, a),
                    a.stopPropagation(),
                    A && a.preventDefault(),
                    !r)
                        return void (r = !1);
                    if (touchEndCount += 1,
                    rrxdebug && console.log("_endCount", touchEndCount),
                    r = !1,
                    s = !1,
                    u > l && 0 > u) {
                        var f = Date.now();
                        ...
                        u = 0) : l > u && (d = (u - l) / m * d,
                        u = l),
                        doTransformIscrollWrapper(i, u, d),
                        touchPos = u,
                        touchEndCount = 0
                    }
                })
            ...
            function g(a) {}
            var h, i, j, k, l, m, n, o = windowHeight, p = "NS", q = !1, r = !1, s = 0, t = 0, u = 0, v = 0, w = 0, x = 0, y = 0, z = 0, A = !0;
            o = m,
            h = e,
            n = b,
            rrxdebug && console.log(h),
            q = e.stopFlip,
            j = _$canvas.find(".page_" + h.id),
            i = $("#iscroll_wrapper" + h.id).find(".pt-page-element-list-box"),
            k = -(h.height - 1e3),
            l = k;
            var B = parseInt(_dataObj.flipAnimation, 10);
            p = B >= 210 ? "WE" : "NS",
            f(),
            rrxdebug && console.log(k, i)
        }
            ...
            b.height)
              , f = new iScroll($("#iscroll_wrapper" + b.id).get(0),{
                ...
                onScrollEnd: function(a) {
                    ...
                    "bottom" == d ? goToNextPage() : "top" === d && goToPrePage()
                },
            ...
            var d = !1
              ...
              , p = new iScroll(o,{
                ...
                onScrollMove: function(a) {
                    n = !0;
                    var b = a.y;
                    !b && a.touches.length > 0 && (b = a.touches[0].clientY),
                    h ? (h = !1,
                    i = b) : j = b
                },
                onScrollEnd: function(a) {
                    ...
                    if (e) {
                        if (0 === g) {
                            ...
                            d && n && !f)) {
                                if (n = !1,
                                c(),
                                console.log("longpage goToPrePage1"),
                                isStopNextPage())
                                    return;
                                goToPrePage()
                            }
                        ...
                        if (d && n && !f)
                            if (n = !1,
                            c(),
                            console.log("longpage goToPrePage2"),
                            currentPageId !== lastPageId || isCopyrightPageEndShow || isCopyrightPageEndGotoFirst)
                                goToNextPage();
                            else if (getCanShowCopyrightPageEnd())
                                return void copyrightPageEndShow()
                    } else if (Math.abs(this.maxScrollY) - g <= 0) {
                        var o = Math.abs(k - g) < 20;
                        if (m++,
                        (o || m > 1) && (scroll.toEnd = 0,
                        d && n && !f))
                            if (n = !1,
                            c(),
                            console.log("longpage goToPrePage2"),
        ...
        function swipeFlipEvent(a, b) {
            rrxdebug && console.log("swipeFlipEvent"),
            "left" === a || "up" === a ? goToNextPage() : goToPrePage()
        }
        function formatWsiteTitle() {
            var a = defaultShareTitle
              , b = document.title;
            return a.indexOf("#分享人昵称#") > -1 && wsiteInfo.wxauthedInfo && wsiteInfo.wxauthedInfo.nickname && (b = replaceAll(a, "#分享人昵称#", wsiteInfo.wxauthedInfo.nickname),
            b = replaceAll(b, "#分享数#", wsiteInfo.visitCount || "00")),
            b
        }
        function formatShareUrl(a) {
            return a = a || location.href.split("#")[0],
            shareUrl = a,
            a
        }
        function registerShareNickName() {
            _isWeixin && wsiteInfo.hasShareNickName && wsiteInfo.fromshareid && (shareUrl = Cool.util.getBrowserUrl("fromshareid", wsiteInfo.fromshareid, shareUrl),
            shareTitle = formatWsiteTitle())
        }
        function initShareInfo() {
            var a = function() {
                void 0 !== _dataObj.describe && (shareDesc = _dataObj.describe),
                void 0 !== _dataObj.title && (shareTitle = _dataObj.title),
                (void 0 === _dataObj.shareImageUrl || "" === _dataObj.shareImageUrl) && (_dataObj.shareImageUrl = defaultShareImageUrl),
                shareImageUrl = _dataObj.shareImageUrl
            };
            if (defaultShareTitle = _dataObj.title,
            _dataObj.title = document.title,
            "0" === wsiteInfo.wxp.newReview || 403 === coolData.result) {
                var b = "欢迎使用liao，您的作品审核不通过";
                shareDesc = b,
                shareTitle = b,
                document.title = b,
                coolData = {
        ...
        function fnHackTitle(a) {
            a && !wsiteInfo.hasShareNickName && (document.title = a);
        ...
        function dialogObjectToArray(a) {
            if (a.hasOwnProperty("dialogList") && a.dialogList.constructor === Object) {
                var b = [];
                for (var c in a.dialogList)
                    b.push(a.dialogList[c]);
                a.dialogList = b
            }
            return a
        }
        ...
        function handleDataUrl(a) {
            ...
            if (wsiteInfo && wsiteInfo.datacdn) {
                if (wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
                    return "https://" + wsiteInfo.datacdn + "/" + removeHostName(a);
        ...
        function nextPage() {
            var a = !1;
            if (getPageCount() > 1) {
                if (currentPageId == lastPageId && "stop" == lastPageGoto)
                    return;
                var b = getActualPageId(-1);
                b == lastPageId ? b === _copyrightId && (hideDanmuInfo(),
                a = !0) : currentPageId === _copyrightId && resetDanmuInfo();
        ...
        function prePage() {
            var a = !1;
            if (getPageCount() > 1) {
                if (currentPageId == firstPageId && "continue" != lastPageGoto)
                    return;
        ...
        function fnCheckIsNoCopyright() {
            return base.isLastPage() ? (console.log("ckr"),
            pageIsHaveTopPlugin(!1, ["VR全景图"], [1, appConfig.gameCategory])) : !1
        }
        function showCopyright(a, b) {
            if (needShowCopyright() && !getCanShowCopyrightPageEnd()) {
                if (rrxdebug && console.info("showCopyright", b, _copyrightId, a),
                b === _copyrightId)
                    return void (_isAllPageShowReport && hideAllPageReport());
                if (_isHaveMenu) {
                ...
                var d = function(a) {
                    a === !0 ? (rrxdebug && console.info("func show"),
                    showEffect($copyright)) : (hideEffect($copyright),
                    _isAllPageShowReport && showAllPageReport())
                };
                rrxdebug && console.trace(_copyrightFrom),
                rrxdebug && console.info("showCopyright-_copyrightFrom", _dataObj.copyright);
                var e = null;
                if ("we+" !== _copyrightFrom && "rrxiu" !== _copyrightFrom || void 0 === b)
                    if ("customer" === _copyrightFrom || "bottom" === _copyrightFrom || "union" === _copyrightFrom)
                        ...
                        "na" === _copyrightFrom && (_dataObj.showReport || _dataObj.showVisitCount) ? d(a) : 0 !== _dataObj.result && d(a);
                else
                    e = getPageObjById(b),
                    d(e && e.stopFlip === !0 ? !0 : a)
            }
        }
        ...
        function hideCopyrightEndPage() {
            copyrightendPageShowing = !1,
            $cypage = getPageDomById(_copyrightId),
            $cypage && (showSidleReport(),
            showSidleShare(),
            resetDanmuInfo(),
            $cypage.removeClass("copyrightPageAnimShow").addClass("copyrightPageAnimHide"),
            setTimeout(function() {
                $cypage.css({
                    zIndex: 0,
                    display: "none"
        ...
        function hideMenuPlugin() {
            _$canvas.find(".rrx-pg-menu-index").length > 0 && (hideEffect(_$canvas.find(".rrx-pg-menu-index")),
            ("bottom" === _copyrightFrom || "union" === _copyrightFrom || "customer" === _copyrightFrom) && hideEffect($copyright)),
            $sysMenuBottom && (hideEffect($sysMenuBottom),
            ("bottom" === _copyrightFrom || "union" === _copyrightFrom || "customer" === _copyrightFrom) && hideEffect($copyright))
        }
        function setMenuStyle() {
            _$canvas.find(".rrx-pg-menu-index").length > 0 && (_$canvas.find(".rrx-pg-menu-index").css("bottom", "38px"),
            $copyright.css("height", "40px"),
            $copyright.css("line-height", "40px"))
        }
        function sysMenuBottomStyleSet() {
            $sysMenuBottom && ("union" === _copyrightFrom ? $sysMenuBottom.css("bottom", "64px") : $sysMenuBottom.css("bottom", "38px"),
            $copyright.css("height", "40px"),
            $copyright.css("line-height", "40px"))
        }
        function showMenuPlugin() {
            _$canvas.find(".rrx-pg-menu-index").length > 0 && (showEffect(_$canvas.find(".rrx-pg-menu-index")),
            ("bottom" === _copyrightFrom || "union" === _copyrightFrom || "customer" === _copyrightFrom) && (showEffect($copyright),
            setMenuStyle())),
            $sysMenuBottom && (showEffect($sysMenuBottom),
            ("bottom" === _copyrightFrom || "union" === _copyrightFrom || "customer" === _copyrightFrom) && (showEffect($copyright),
            sysMenuBottomStyleSet()))
        }
        ...
        function getPrefixCss(a, b) {
            for (var c = function(b) {
                ...
                if (d.length > 0)
                    ...
                    c = b;
                return c
            }, d = "", e = b.replace(new RegExp(/(@)/g), "$@").split("$"), f = 0; f < e.length; f++)
                d += -1 === e[f].indexOf("@") ? c(e[f]) : e[f];
            return d
        }
        function fnIsInSpacePlugin(a) {
            if (a.elementList)
                for (var b = 0; b < a.elementList.length; b++) {
                    ...
                    if ("plugin" == c.type && c.displayName && c.displayName.indexOf("一镜到底"))
                        return !0
                }
            return !1
        }
        function getCopyrightFrom() {
            ...
            if (b) {
                ...
                for (var c = 0; c < b.length; c++) {
                    var d = b[c].elementList;
                    if (d)
                        for (var e = 0; e < d.length; e++)
                            if ("plugin" === d[e].type && "菜单" === d[e].content.name) {
                                _menuPageIndex = c,
                                _isHaveMenu = !0,
                                "customer" === a && _dataObj.showReport && (a = "na");
                                break
                            }
                }
            }
        ...
        function checkWsiteHaveInductionPlugin() {
            if (0 === _dataObj.result) {
                ...
                return a || (a = listHaveInductionPlugin(_dataObj.dialogList)),
                a
            }
        }
            ...
            if (b > 0)
                for (var c = 0; b > c; c++) {
                    ...
                    for (var e = d.length, f = 0; e > f; f++)
                        if ("plugin" === d[f].type && ("答题" === d[f].content.name || "答题20" === d[f].content.name || "问答" === d[f].content.name || "照片投票" === d[f].content.name || "砍价" === d[f].content.name || "新年签" === d[f].content.name || d[f].content.name.indexOf("红包") > -1 || d[f].content.name.indexOf("抽奖") > -1 || parseInt(d[f].content.categoryId) === appConfig.gameCategory))
                            return !0
                }
            return !1
        }
        ...
        function getCanFocusByWay(a) {
            return void 0 === a || null === a ? wsiteInfo.wxp.focusWechat : (a = parseInt(a, 10),
            1 === a ? wsiteInfo.wxp.focusWechat : 2 === a && wsiteInfo.wxp.focusWechat && wsiteInfo.wxp.myWxAuthOpen ? (console.log("fwa"),
            !0) : !1)
        }
        ...
        function getFormatCount(a) {
            var b = a.toString();
            return b.length >= 6 && (b = b.substr(0, 2) + "," + b.substr(2, 3) + "," + b.substr(5)),
            b
        }
        ...
        function showPluginFocus(a, b) {
            ...
            if (null === c || void 0 === c || 0 === c.length) {
                ...
                $focusWxQrPanel.html(d),
                c = $focusWxQrPanel.find(".dialog-content");
                ...
                if (2 === e)
                    ...
                    c.type === b.EXTENT) {
                        ...
                        if (3 === f.length) {
                            ...
                            c.radius = f[1];
                            var g = f[2].split(",");
                            2 === g.length && (c.lat = g[0],
                            c.lng = g[1])
                        }
                    } else
                        c.regions = getRegions(d[0]);
                else
                    e > 0 && (c.type = b.REGION,
                    c.regions = getRegions(d[0]))
            }
        ...
        var base = this, _$canvas = null, canvasDefaultWidth = 640, $previewNotice, $copyright, $pluginCopyright, $progress, $reportpage, $iconMusic, $focusButton, $topMenuButton, $sysMenuBottom, $focusPanel, $topMenuPanel, $cartButton, $danmuButton, $danmuPanel, $danmuShow, $focusWxQrPanel, $sidleShareButton, $sidleReportButton, $sharePanel, $sharePosterDialog, $sharePosterTips, $pluginMsgButton, $pageCopyrightPageEnd, $ptWrapper = null, $pagewrapper = null, $pagelist = null, $floorpage = null, $loadingpage = null, $sharepage = null, $iconArrowDown, $iconArrowRight, currentPageId = 0, _dataObj = null, _host = "", _allowTempFlip = !0, _allowFlip = !0, _allowFlipCurrentPage = !0, flipWay = "down", flipAnimation = {
            enter: "1101",
            back: "1102"
        }, musicUrl = "", musicPlayIcon = "", musicStopIcon = "", musicPosition = "", musicAutoPlay = !0, hasBgMusic = !1, $music = null, _isEditing = !1, PLUGIN_SIZE_TYPE = {
            AUTO: "1",
            FIXED: "2",
            FULL: "3",
            SCALE: "4"
        }, _isPc = !0, _isPreview = !1, _isPageThumb = !1, lastPageGoto = "continue", firstPageId = 0, lastPageId = 0, hasCopyRightPage = !1, clickEventType = "click", self, _log = null, _rrxtach, _isWeixin = !1, _animationEngine = appConfig.animationEngine, _copyrightFrom = "", _isHaveMenu = !1, _menuPageIndex = -1, _copyrightId = "copyrightPage", _leftCopyrightText = "点击免费制作liao", _rightCopyrightText = "", _page_element_list_scale_value = 1, limitBottomCount = 0, limitTopCount = 0, iScrollInstances = [], noAutoPlayImgGroupInstances = [], pageLongScroll = [], longPageObj = [], defaultShareImageUrl = (wsiteInfo.flhtps || wsiteInfo.httpsEnabled ? "https://file2.rrxh5.cc" : "http://file2.rrxh5.cc") + "/logo_blue_200x200.jpg", defaultShareTitle = "", shareUrl = formatShareUrl(), shareTitle = "", shareImageUrl = "", shareDesc = "", customIntervals = [], _preloadAllResource = !1, _reportInit = !1, _flipProgress = !1, _pagePluginCopyRight = [], PNAME_WGUID = "v", longPageCopyright = {
            title: "长页-liao旗下产品",
            image: getImageHost() + "plugin_icon/longpage.png",
            color: "#2ac3fd"
        }, _crUnionRrx = "liao技术支持", _renderAllPage = !1, subRenderTotal = 20, _pageIdList = [], _pageRendered = {}, _pageAudio = {}, _isAllPageShowReport = !1, pageListCount = 0, _isSetting = !1, _isWxMin = !1, rrxtrace = function(a) {
            void 0 !== _log && null !== _log && _log.logError(a)
        }, getOriginUrl = function() {
            return void 0 !== window.rrxh5OriginUrl && null !== window.rrxh5OriginUrl && "" !== $.trim(window.rrxh5OriginUrl) ? (console.log(1),
            window.rrxh5OriginUrl) : wsiteInfo && void 0 !== wsiteInfo.vurl && null !== wsiteInfo.vurl && "" !== $.trim(wsiteInfo.vurl) ? (console.log(2),
            wsiteInfo.vurl) : location.href.split("#")[0]
        }, requestAjax = function(a, b, c, d, e) {
            c = c || "GET",
            void 0 === e && (e = getInteractServiceHostIfHttps());
            var f = e + d + "/" + a;
            return $.ajax({
                url: f,
                type: c,
        ...
        var multiSelectObj = {
            getTipValue: function(a, b) {
                var c = function(b) {
                    return "-1" === b.defaultValue.toString() ? b.defaultTip || "请选择" : (d = getIndexByArray(a.list, b.defaultValue, "id"),
                    d > -1 ? a.list[d].value : "请选择");
                ...
                if ("one" === b)
                    return c(a);
                if ("two" === b) {
                    if (d = getIndexByArray(a.list, a.defaultValue, "id"),
                    d > -1)
                        return c(a.list[d])
                } else if ("three" === b && (d = getIndexByArray(a.list, a.defaultValue, "id"),
                d > -1)) {
                    var e = getIndexByArray(a.list[d].options, a.list[d].defaultValue, "id");
                    if (e > -1)
                        return c(a.list[d].options[e])
                }
                return "请选择"
            },
            getOptions: function(a, b, c, d) {
                ...
                if ("one" === b)
                    ...
                    g = getIndexByArray(a.list, i, "id"),
                    g > -1 && (h = a.list[g].defaultValue,
                    j = a.list[g].options,
                    f = e(a.list[g]));
                else if ("three" === b && (g = getIndexByArray(a.list, i, "id"),
                g > -1)) {
                    d = d || a.list[g].defaultValue;
                    var k = getIndexByArray(a.list[g].options, d, "id");
                    k > -1 && (h = a.list[g].options[k].defaultValue,
                    j = a.list[g].options[k].options,
                    f = e(a.list[g].options[k]))
                }
                return $.each(j, function(a, b) {
                    f += h == b.id ? '<option value="' + b.id + '" selected="selected">' + b.value + "</option>" : '<option value="' + b.id + '" >' + b.value + "</option>"
                }),
                0 === j.length && (f = '<option value="-1" >请选择</option>'),
                f
            },
            formatOne: function(a, b, c, d) {
                c.children().length > 0 && c.empty(),
                d.children().length > 0 && d.empty(),
                c.append(multiSelectObj.getOptions(a.content, "two", b)),
                d.append(multiSelectObj.getOptions(a.content, "three", b, c.find("option:selected").val()))
            },
            formatTwo: function(a, b, c, d) {
                d.children().length > 0 && d.empty(),
                d.append(multiSelectObj.getOptions(a.content, "three", b, c))
            },
        ...
        }, loadedSvgKey = [], loadedSvgXml = {}, timer_count = 0, timer_instance, t1 = null, preAnimationList = [], useIphonex = !0, regImgSilderTimerRecord = [{
            pageId: 0,
            isReg: !1,
            silderObject: []
        }];
                  ...
                  , c = setInterval(function() {
                    if (b) {
                        if (a.count >= a.imgList.length) {
                            if (a.count = 0,
                            !a.content.playLoop)
                                return void window.clearInterval(c);
                            b = !1,
                            setTimeout(function() {
                                b = !0,
                                $(a.imgList[a.imgList.length - 1]).css("opacity", 0),
                                $(a.imgList[0]).css("opacity", 1)
                            }, 1e3 * a.content.loopDelay)
                        }
                        a.count > 0 && ($(a.imgList[a.count - 1]).css("opacity", 0),
                        $(a.imgList[a.count]).css("opacity", 1)),
                        a.count++
                    }
        ...
        var myShakeEvent = {}
          , Shake = function(a) {
            if (this.hasDeviceMotion = "ondevicemotion"in window,
            this.options = {
                shake: "shake",
                threshold: 15,
                timeout: 1e3
            ...
            this.lastY = null,
            this.lastZ = null,
            "function" == typeof document.CustomEvent)
                this.event = new document.CustomEvent(this.options.shake,{
                    bubbles: !0,
                    cancelable: !0
                });
            else {
                ...
                this.event.initEvent(this.options.shake, !0, !0)
            }
        };
        Shake.prototype = {
            reset: function() {
            ...
            start: function() {
                this.reset(),
                this.hasDeviceMotion && window.addEventListener("devicemotion", this, !1)
            },
            stop: function() {
                this.hasDeviceMotion && window.removeEventListener("devicemotion", this, !1),
                this.reset()
            },
            devicemotion: function(a) {
                ...
                if (null === this.lastX && null === this.lastY && null === this.lastZ)
                    return this.lastX = d.x,
                    this.lastY = d.y,
                    void (this.lastZ = d.z);
                if (e = Math.abs(this.lastX - d.x),
                f = Math.abs(this.lastY - d.y),
                g = Math.abs(this.lastZ - d.z),
                (e > this.options.threshold && f > this.options.threshold || e > this.options.threshold && g > this.options.threshold || f > this.options.threshold && g > this.options.threshold) && (b = new Date,
                c = b.getTime() - this.lastTime.getTime(),
                c > this.options.timeout)) {
                    var h = Math.abs(e + f + g) / c * 1e4;
                    this.event.speed = h.toFixed(2),
          ...
          , flip = function() {
            function a(a, b) {
                if (void 0 !== a)
                    if (h = a,
                    b = void 0 === b ? 0 : b,
                    h.find(".pt-page").each(function() {
                        $(this).data("originalClassList", $(this).attr("class"))
                    }),
                    0 === b) {
                        var c = h.find("div.pt-page:not(.ifpage)").first();
                        c.addClass("pt-page-current"),
                        i = c.data("id")
                    } else
                        h.find(".page_" + b).addClass("pt-page-current"),
                        i = b
            }
            function b(a, b) {
                c(a, b),
            ...
            function c(a, b) {
                b.attr("class", b.data("originalClassList")),
                a.attr("class", a.data("originalClassList") + " pt-page-current")
            }
            function d(a) {
                return "" === a && (a = "1101"),
                g[a]
            ...
            _support = !0;
            var g = [];
            g[1101] = ["pt-page-moveFromBottom", "pt-page-moveToTop"],
            g[1102] = ["pt-page-moveFromTop", "pt-page-moveToBottom"],
            g[1201] = ["pt-page-moveFromBottom pt-page-ontop", "pt-page-fade"],
            g[1202] = ["pt-page-moveFromTop pt-page-ontop", "pt-page-fade"],
            g[1301] = ["pt-page-moveFromBottom", "pt-page-moveToTopEasing pt-page-ontop"],
            g[1302] = ["pt-page-moveFromTop", "pt-page-moveToBottomEasing pt-page-ontop"],
            g[1401] = ["pt-page-flipInTop pt-page-delay500", "pt-page-flipOutBottom"],
            g[1402] = ["pt-page-flipInBottom pt-page-delay500", "pt-page-flipOutTop"],
            g[1501] = ["pt-page-rotatePullBottom pt-page-delay180", "pt-page-rotatePushTop"],
            g[1502] = ["pt-page-rotatePullTop pt-page-delay180", "pt-page-rotatePushBottom"],
            g[1601] = ["pt-page-rotateCubeTopIn", "pt-page-rotateCubeTopOut pt-page-ontop"],
            g[1602] = ["pt-page-rotateCubeBottomIn", "pt-page-rotateCubeBottomOut pt-page-ontop"],
            g[1701] = ["pt-page-scaleUpCenter pt-page-delay400", "pt-page-scaleDownCenter"],
            g[1801] = ["pt-page-rotateInNewspaper pt-page-delay500", "pt-page-rotateOutNewspaper"],
            g[1901] = ["pt-page-scaleUp", "pt-page-rotateFall pt-page-ontop"],
            g[2001] = ["pt-page-scaleUp", "pt-page-moveToTop pt-page-ontop"],
            g[2101] = ["pt-page-moveFromRight", "pt-page-moveToLeft"],
            g[2102] = ["pt-page-moveFromLeft", "pt-page-moveToRight"],
            g[2201] = ["pt-page-moveFromRight", "pt-page-moveToLeftEasing pt-page-ontop"],
            g[2301] = ["pt-page-rotateCubeLeftIn", "pt-page-rotateCubeLeftOut pt-page-ontop"],
            g[2401] = ["pt-page-rotateCarouselLeftIn", "pt-page-rotateCarouselLeftOut pt-page-ontop"],
            g[2501] = ["pt-page-rotateSlideIn", "pt-page-rotateSlideOut"];
            var h, i = 0, j = !1;
            return {
                init: a,
                gotoPage: e
        ...
        scroll.downMoveMove = function() {
            ...
            if (rrxdebug && console.log("downMoveMove", a),
            !a)
                if (moveDistanceY > 0) {
                    if (_isDisableFlipPrevPage)
                        return;
                    if (!isContinuePrePage())
                        return void (_canContinue = !1);
                    isNext || isFirstTime ? (isNext = !1,
                    isFirstTime = !1,
                    _$activePage && deactive(_$activePage),
                    rrxdebug && console.warn("init prev"),
                    _$activePage = getActivePage("prev"),
                    getMoveInit(!0, "bottom center", "translateY", windowHeight)) : setCssWhenMove(!0, "translateY", windowHeight, moveDistanceY, "vertical")
                } else if (0 > moveDistanceY) {
                    if (_isDisableFlipPrevPage)
                        return;
                    if (isStopNextPage())
                        return void (_canContinue = !1);
                    if (currentPageId === lastPageId && !isCopyrightPageEndShow && !isCopyrightPageEndGotoFirst && getCanShowCopyrightPageEnd())
                        return clearInterval(timer_goToNextPage),
                        void copyrightPageEndShow();
                    !isNext || isFirstTime ? (isNext = !0,
                    isFirstTime = !1,
                    _$activePage && deactive(_$activePage),
                    _$activePage = getActivePage("next"),
                    getMoveInit(!1, "top center", "translateY", windowHeight)) : setCssWhenMove(!1, "translateY", windowHeight, moveDistanceY, "vertical")
                }
            removeAllBlurPage()
        }
        ,
        scroll.downMoveEnd = function() {
            if (Math.abs(moveDistanceY) > Math.abs(moveDistanceX) && Math.abs(moveDistanceY) > 20) {
                rrxdebug && console.log(moveDistanceY, windowHeight),
                setCssWhenEnd("translateY", moveDistanceY, windowHeight, _scrollMode),
                rrxdebug && console.log("移动结束"),
                beforeScrollEndThenNext();
                var a = _$activePage.data("id");
                beforeScrollEndThenCopyrightEndPage(a),
                flipend()
            } else
                _isDisableFlipPage = !1,
                cancelFlip()
        ...
        scroll.downFadeMove = function() {
            ...
            if (!a)
                if (moveDistanceY > 0) {
                    ...
                    _$activePage && deactive(_$activePage),
                    _$activePage = getActivePage("prev"),
                    _$activePage.removeClass("z-fade-in"),
                    deactive(_$activePage),
                    _$currentPage[0].style.zIndex = 1,
                    _$activePage[0].style.zIndex = 2,
                    _$activePage.addClass("z-fade-in"),
                    active(_$activePage))
                } else if (0 > moveDistanceY) {
                    if (_isDisableFlipNextPage)
                        return;
                    if (isStopNextPage())
                        return void (_canContinue = !1);
                    if (currentPageId === lastPageId && !isCopyrightPageEndShow && !isCopyrightPageEndGotoFirst && (console.log(isCopyrightPageEndShow),
                    getCanShowCopyrightPageEnd()))
                        return void copyrightPageEndShow();
                    (!isNext || isFirstTime) && (isNext = !0,
                    isFirstTime = !1,
                    _$activePage && deactive(_$activePage),
        ...
        scroll.downScaleMove = function() {
            if (needBlurPage = 0,
            Math.abs(moveDistanceY) > Math.abs(moveDistanceX)) {
                if (moveDistanceY > 0) {
                    if (_isDisableFlipPrevPage)
                        return;
                    if (!isContinuePrePage())
                    ...
                    _$activePage[0].style.zIndex = 2,
                    active(_$activePage),
                    _$activePage[0].style.opacity = 1,
                    _$currentPage[0].style.opacity = 0)
                } else if (0 > moveDistanceY) {
                    if (_isDisableFlipNextPage)
                        return;
                    if (isStopNextPage())
                ...
                _$activePage[0].style.opacity = a.toFixed(1),
                a.toFixed(3) <= 1 && cssAnim(_$activePage, "transform", "scale(" + a.toFixed(3) + ")")
            }
            removeAllBlurPage()
        }
        ,
        scroll.downScaleEnd = function() {
            if (Math.abs(moveDistanceY) > Math.abs(moveDistanceX) && Math.abs(moveDistanceY) > 20) {
                cssAnim(_$activePage, "transform", "scale(1)"),
                _$activePage[0].style.opacity = 1,
                beforeScrollEndThenNext();
                var a = _$activePage.data("id");
                beforeScrollEndThenCopyrightEndPage(a),
                ...
                cssAnimation(_$currentPage[0].style, "Transition", "none"),
                cssAnimation(_$activePage[0].style, "Transition", "none"),
                _isDisableFlipPage = !1,
                cancelFlip()
        }
        ,
        scroll.downCardMove = function() {
            ...
            Math.abs(moveDistanceY) > Math.abs(moveDistanceX))
                if (moveDistanceY > 0) {
                    ...
                    _$activePage = getActivePage("prev"),
                    deactive(_$activePage),
                    cssAnimation(_$activePage[0].style, "TransformOrigin", "top"),
                    cssAnimation(_$activePage[0].style, "Transform", "rotateX(90deg)"),
                    active(_$activePage)) : cssAnimation(_$activePage[0].style, "Transform", "rotateX(" + (90 - moveDistanceY / windowHeight * 90) + "deg)")
                } else if (0 > moveDistanceY) {
                    if (_isDisableFlipNextPage)
                        return;
                    if (isStopNextPage())
                    ...
                    if (!isNext || isFirstTime) {
                        ...
                        isFirstTime = !1,
                        _$activePage && deactive(_$activePage),
                        currentPageId === lastPageId && !isCopyrightPageEndShow && !isCopyrightPageEndGotoFirst && (console.log(isCopyrightPageEndShow),
                        getCanShowCopyrightPageEnd()))
                            return void copyrightPageEndShow();
                        _$activePage = getActivePage("next"),
                        deactive(_$activePage),
                        cssAnimation(_$activePage[0].style, "TransformOrigin", "bottom"),
                        cssAnimation(_$activePage[0].style, "Transform", "rotateX(-90deg)"),
                        active(_$activePage)
                    } else
                        cssAnimation(_$activePage[0].style, "Transform", "rotateX(" + (-90 - moveDistanceY / windowHeight * 90) + "deg)")
                }
            removeAllBlurPage()
        }
        ,
        scroll.downCardEnd = function() {
            if (Math.abs(moveDistanceY) > Math.abs(moveDistanceX) && Math.abs(moveDistanceY) > 20) {
                cssAnimation(_$activePage[0].style, "Transform", "rotateX(0deg)"),
                beforeScrollEndThenNext();
                var a = _$activePage.data("id");
                beforeScrollEndThenCopyrightEndPage(a),
                flipend()
        ...
        scroll.rightLRMoveMove = function() {
            ...
            Math.abs(moveDistanceX) > Math.abs(moveDistanceY))
                if (moveDistanceX > 0) {
                    ...
                    _$activePage && deactive(_$activePage),
                    _$activePage = getActivePage("prev"),
                    getMoveInit(!0, "center right", "translateX", windowWidth)) : setCssWhenMove(!0, "translateX", windowWidth, moveDistanceX, _scrollMode)
                    ...
                    _$activePage && deactive(_$activePage),
                    _$activePage = getActivePage("next"),
                    getMoveInit(!1, "center left", "translateX", windowWidth)) : setCssWhenMove(!1, "translateX", windowWidth, moveDistanceX, _scrollMode)
                }
            removeAllBlurPage()
        }
        ,
        scroll.rightLRMoveEnd = function() {
            if (Math.abs(moveDistanceX) > Math.abs(moveDistanceY) && Math.abs(moveDistanceX) > 20) {
                setCssWhenEnd("translateX", moveDistanceX, windowWidth, _scrollMode),
                beforeScrollEndThenNext();
                var a = _$activePage.data("id");
                beforeScrollEndThenCopyrightEndPage(a),
                flipend()
        ...
        scroll.rightLRRotateMove = function() {
            ...
            if (Math.abs(moveDistanceX) > Math.abs(moveDistanceY))
                if (moveDistanceX > 0) {
                    ...
                    if (!isContinuePrePage())
                        return void (_canContinue = !1);
                    rrxdebug && console.log("moveDistanceX", moveDistanceX),
                    isNext || isFirstTime ? (isNext = !1,
                    isFirstTime = !1,
                    _$activePage && deactive(_$activePage),
                    _$activePage = getActivePage("prev"),
                    active(_$activePage),
                    cssAnim(_$activePage, "Transform", "scale(0.3) translateX(0) translateZ(-" + windowHeight + "px) rotateY(45deg)"),
                    _$activePage[0].style.zIndex = "0",
                    _$currentPage[0].style.zIndex = "100") : (a = ((4 * windowWidth / 4 - moveDistanceX) / windowWidth).toFixed(3),
                    b = 1.5 * moveDistanceX,
                    c = moveDistanceX - windowWidth / 4,
                    d = moveDistanceX / windowWidth * 45,
                    cssAnim(_$currentPage, "Transform", "translateX(" + b + "px) scale(" + a + ") rotateY(" + d + "deg) translateZ(" + c + "px)"),
                    e = (moveDistanceX / windowWidth).toFixed(3),
                    f = -windowWidth + b,
                    g = windowWidth / 4 + moveDistanceX,
                    h = -45 + (moveDistanceX + windowWidth / 4) / windowWidth * 45,
                    cssAnim(_$activePage, "Transform", "scale(" + e + ") translateX(" + f + "px) translateZ(" + g + "px) rotateY(" + h + "deg)"))
                } else if (0 > moveDistanceX) {
                    if (_isDisableFlipNextPage)
                        return;
                    if (isStopNextPage())
                    ...
                    getCanShowCopyrightPageEnd()))
                        return void copyrightPageEndShow();
                    rrxdebug && console.log("moveDistanceX", moveDistanceX, moveDistanceY),
                    !isNext || isFirstTime ? (isNext = !0,
                    isFirstTime = !1,
                    _$activePage && deactive(_$activePage),
                    _$activePage && deactive(_$activePage),
                    _$activePage = getActivePage("next"),
                    active(_$activePage),
                    cssAnim(_$activePage, "Transform", "scale(0.3) translateX(" + (windowWidth + 300) + "px) translateZ(-" + windowHeight + "px) rotateY(-45deg)"),
                    _$activePage[0].style.zIndex = "0",
                    _$currentPage[0].style.zIndex = "100") : (prev_scale = ((4 * windowWidth / 4 + moveDistanceX) / windowWidth).toFixed(3),
                    prev_tx = 1.5 * moveDistanceX,
                    prev_tz = moveDistanceX + windowWidth / 4,
                    prev_ry = moveDistanceX / windowWidth * 45,
                    cssAnim(_$currentPage, "Transform", "translateX(" + prev_tx + "px) scale(" + prev_scale + ") rotateY(" + prev_ry + "deg) translateZ(" + prev_tz + "px)"),
                    e = (-moveDistanceX / windowWidth).toFixed(3),
                    f = windowWidth - -prev_tx,
                    g = windowWidth / 4 + moveDistanceX,
                    h = 45 + (moveDistanceX + windowWidth / 4) / windowWidth * 45,
                    cssAnim(_$activePage, "Transform", "scale(" + e + ") translateX(" + f + "px) translateZ(" + g + "px) rotateY(" + h + "deg)"))
                }
        ...
        scroll.rightLRRotateEnd = function() {
            if (Math.abs(moveDistanceX) > Math.abs(moveDistanceY) && Math.abs(moveDistanceX) > 20) {
                moveDistanceX > 0 ? (rrxdebug && console.log("rightLRRotateEnd 11", moveDistanceX),
                _$currentPage[0].style.webkitTransformOrigin = "right",
                _$currentPage[0].style.webkitTransform = "translateX(" + -windowWidth + "px) translateZ(-" + windowWidth + "px) rotateY(-180deg) scale(0.2)",
                _$activePage[0].style.webkitTransform = "translateX(0) translateZ(0) rotateY(0) scale(1)",
                _$currentPage[0].style.zIndex = "0",
                _$activePage[0].style.zIndex = "1") : (rrxdebug && console.log("rightLRRotateEnd 22", moveDistanceX),
                _$currentPage[0].style.webkitTransformOrigin = "left",
                _$currentPage[0].style.webkitTransform = "translateX(" + windowWidth + "px) translateZ(-" + windowWidth + "px) rotateY(180deg) scale(0.2)",
                _$activePage[0].style.webkitTransform = "translateX(0) translateZ(0) rotateY(0) scale(1)",
                _$activePage[0].style.zIndex = "1",
                _$currentPage[0].style.zIndex = "0"),
                beforeScrollEndThenNext();
                var a = _$activePage.data("id");
                beforeScrollEndThenCopyrightEndPage(a),
        ...
        scroll.rightLRSlideMove = function() {
            ...
            if (Math.abs(moveDistanceX) > Math.abs(moveDistanceY))
                if (moveDistanceX > 0) {
                    ...
                    cssAnim(_$activePage, "Transform", "translateX(0) translateZ(-500px)"),
                    cssAnim(_$currentPage, "Transform", "translateX(0) translateZ(-500px)")) : (curr_tx = moveDistanceX,
                    curr_tz = -500,
                    cssAnim(_$currentPage, "Transform", "translateX(" + curr_tx + "px) translateZ(" + curr_tz + "px)"),
                    _$currentPage.css({
                        opacity: .5
                    }),
                    a = -windowWidth + moveDistanceX - 200,
                    b = -500,
                    cssAnim(_$activePage, "Transform", "translateX(" + a + "px) translateZ(" + b + "px)"),
                    _$activePage.css({
                        opacity: .5
                    }))
                } else if (0 > moveDistanceX) {
        ...
        scroll.rightLRSlideEnd = function() {
            var a;
            Math.abs(moveDistanceX) > Math.abs(moveDistanceY) && Math.abs(moveDistanceX) > 2 ? moveDistanceX > 0 ? (_$currentPage[0].style.webkitTransform = "translateX(" + 2 * windowWidth + "px) translateZ(-500px)",
            _$activePage[0].style.webkitTransform = "translateX(0) translateZ(-500px)",
            beforeScrollEndThenNext(),
            a = _$activePage.data("id"),
            beforeScrollEndThenCopyrightEndPage(a),
            setTimeout(function() {
                _$activePage[0].style.webkitTransform = "translateX(0) translateZ(-0)",
                _$currentPage.css({
                    opacity: 1
                }),
                _$activePage.css({
                ...
                flipend()
            }, 450)) : (_$currentPage[0].style.webkitTransform = "translateX(" + -2 * windowWidth + "px) translateZ(-500px)",
            _$activePage[0].style.webkitTransform = "translateX(0) translateZ(-500px)",
            beforeScrollEndThenNext(),
            a = _$activePage.data("id"),
            beforeScrollEndThenCopyrightEndPage(a),
            setTimeout(function() {
                ...
                flipend()
            }, 450)) : (cssAnimation(_$currentPage[0].style, "Transition", "none"),
            cssAnimation(_$activePage[0].style, "Transition", "none"),
            _isDisableFlipPage = !1,
            cancelFlip())
        }
        ...
        base.init = function(a, b, c, d, e, f, g, h, i, j, k, l) {
            function m() {
                void 0 !== _dataObj.init && _dataObj.init(),
                initBone(),
                initSwipe(),
                createPages(),
                0 === t && 0 === currentPageId ? currentPageId = getFirstPageId() : t > 0 && (currentPageId = t),
                createProgress(),
                renderCopyright(),
                _isPreview && !_isSetting && $previewNotice.show(),
                pushStateForReadDepth(),
                void 0 !== _dataObj.loadingpage && void 0 !== _dataObj.loadingpage.title && $loadingpage.html(""),
                handleAllPageImageThumb(),
                getFormUseGoods(function() {
                        ...
                        loadExternalJsLibs(function() {
                            ...
                            setTimeout(function() {
                                loading(a, function(a) {
                                    ...
                                    setMusicPosition(),
                                    musicAutoPlay === !0 ? playMusic() : "" !== musicUrl && void 0 !== musicUrl && ($iconMusic.show(),
                                    setMusicIcon(musicStopIcon, "off"),
                                    $iconMusic.removeClass("music-play"),
                                    $iconMusic.removeClass("music-play-none"),
                                    $iconMusic.bind("click", function(a) {
                                        null === $music ? playMusic() : stopMusic()
                                    })),
                                    showToppage(),
                                    showFloorpage(),
                                    rrxdebug && console.log("_pageIdList", _pageIdList);
                                    {
                                        var a = currentPageId;
                                        renderPage(a, !1)
                                    }
                                    ...
                                    var b = function() {
                                        var b = 0;
                                        for (b = 0; b < _dataObj.pageList.length; b++)
                                            _dataObj.pageList[b].id !== a && (currentPageId = _dataObj.pageList[b].id,
                                            renderPage(_dataObj.pageList[b].id))
                                    }
                                      , c = 1;
                                    if (_renderAllPage)
                                        b();
                                    else if (_dataObj.pageList.length <= subRenderTotal)
                                        b();
                                    else {
                                        var d = 0;
                                        for (d = 0; d < _dataObj.pageList.length; d++) {
                                            if (_dataObj.pageList[d].id !== a) {
                                                if (c > subRenderTotal)
                                                    break;
                                                currentPageId = _dataObj.pageList[d].id,
                                                renderPage(_dataObj.pageList[d].id, !0, !0)
                                            }
                                            c++
                                        }
                                    }
                                    if (_dataObj.dialogList)
                                        for (p = 0; p < _dataObj.dialogList.length; p++)
                                            renderDialog(_dataObj.dialogList[p].id);
                                    if (currentPageId = a,
                                    rrxdebug && console.info("_pagePluginCopyRight", _pagePluginCopyRight),
                                    -1 === $.inArray(currentPageId, _pagePluginCopyRight) && $pluginCopyright.hide(),
                                    _flipProgress === !0 && renderProgress(currentPageId, totalPages),
                                    setPageArrowIcon(currentPageId),
                                    "loadingpage" !== currentPageId && pageCodeLoad(currentPageId, apiHelper.getAppInstance()),
                                    $(".bottomm-text").hide(),
                                    $(".show-rrxiu-visit").hide(),
                                    $page = _$canvas.find(".page_" + currentPageId),
                                    _isEditing || setTimeout(function() {
                                        loadPluginEvent(currentPageId)
                                    }, 300),
                                    playPageByPageId(currentPageId),
                                    flip.init($pagelist, currentPageId),
                                    rrxdebug && console.log("init data-", currentPageId, lastPageId),
                                    currentPageId == lastPageId)
                                        showCopyright(!0, currentPageId),
                                        getCanShowCopyrightPageEnd() ? showArrow() : hideArrow();
                                    else {
                                        showCopyright(!1, currentPageId);
                                        var e = getPageObjById(currentPageId);
                                        e.stopFlip || showArrow()
                                    }
                                    isShowDanmu() && !rrxDanmuJump && (rrxdebug && console.info("initdata-isShowDanmu"),
                                    getCommentLikeCount(),
                                    getCommentList()),
                                    createFocusWechat(),
                                    createTopeMenu(),
                                    ...
                                    initSidleShare(),
                                    initSidleReport(),
                                    createCopyRightPage2(),
                                    initSidlePluginMsg(),
                                    initWsiteInvite(),
                                    _excuteElementEventByBrowser(),
                                    i && j && ("rrxiu" === j.copyrightFrom ? (console.log("isSetting is rrxiu"),
                                    copyrightPageEndShow()) : copyrightPageEndHideNoAnim()),
                                    _rrxtach.recordVisit(apiHelper.getAppInstance().weixinStrong.getWxOpenId())
                                })
                            }, 0)
                        })
                    })
                }),
                wxinit(formatShareUrl())
            }
            if (wsiteInfo && wsiteInfo.wsiteType && wsiteInfo.wsiteType > 1 && (c.copyright = wsiteInfo.copyright,
            c.danmuLike && (c.danmuLike.show = !1),
            c.showVisitCount = !1),
            _isSetting = i,
            _isWxMin = k,
            $loadingpage = b.find(".pt-loadingpage"),
            "gql5ay" == c.guid && (_animationEngine = "css"),
            self = this,
            _host = a,
            void 0 !== f && null !== f && (_log = f),
            _rrxtach = l,
            _flipProgress = !!c.flipProgress,
            void 0 === c.flipProgress && (_flipProgress = !0),
            void 0 !== d && (_isPc = d),
            void 0 !== g && (_isEditing = g),
            void 0 !== h && h && (_isPreview = !0),
            void 0 !== e && (_isWeixin = e),
            clickEventType = null !== document.ontouchstart ? "click" : "touchstart",
            _$canvas = b,
            _dataObj = pageObjectToArray(c),
            _dataObj = dialogObjectToArray(c),
            void 0 !== _dataObj.result && 0 !== _dataObj.result) {
                for (var n = 2; 100 >= n; n++)
                    updateLoadingPercent(n);
                return void setTimeout(function() {
                    2 == c.result ? (needCode(_dataObj.msg),
                    wxinit(formatShareUrl())) : suspended(_dataObj.msg),
                    $loadingpage.hide()
                }, 50)
            }
            if (_isWxMin && "ash0mw" == _dataObj.guid && (_dataObj.forbidShare = 1),
            _dataObj.danmuLike && (_dataObj.danmuLike.review = !0),
            !g && !i && wsiteInfo.copyright) {
                var o = wsiteInfo.copyright.from;
                "bottom" === o || "union" === o ? (_dataObj.copyright.from = o,
                "union" === o && (wsiteInfo.copyright.content && (_dataObj.copyright.content = wsiteInfo.copyright.content),
                wsiteInfo.copyright.url && (_dataObj.copyright.url = wsiteInfo.copyright.url))) : wsiteInfo.fromChannel && wsiteInfo.copyright.channel && (_dataObj.copyright = wsiteInfo.copyright)
            }
            if (void 0 !== _dataObj.shareImageUrl && "" !== _dataObj.shareImageUrl && -1 == _dataObj.shareImageUrl.indexOf("thirdwx.qlogo.cn") && (_dataObj.shareImageUrl = handleImgUrl(_dataObj.shareImageUrl) + appConfig.shareImageThumb),
            void 0 !== _dataObj.llImageUrl && "" !== _dataObj.llImageUrl && (_dataObj.llImageUrl = handleImgUrl(_dataObj.llImageUrl) + appConfig.llImageThumb),
            checkWsiteHaveInductionPlugin() && (_dataObj.showReport = !0,
            _isAllPageShowReport = !0),
            _isAllPageShowReport || (_isAllPageShowReport = 1 === wsiteInfo.activityType),
            !_isSetting && !g && _dataObj.hasOwnProperty("cssList"))
                for (var q = h ? "preview" : "publish", r = 0; r < _dataObj.cssList.length; r++)
                    Cool.util.loadCss(Cool.util.hostStamp(getWebFontHost() + "css/" + q + "/" + _dataObj.cssList[r]));
            if (_copyrightFrom = getCopyrightFrom(),
            pageListCount = _dataObj.pageList ? _dataObj.pageList.length : 0,
            _$canvas.on("touchmove", function(a) {
                a.preventDefault()
            }),
            initShareInfo(),
            void 0 !== _dataObj.flipWay && "" !== _dataObj.flipWay && (flipWay = _dataObj.flipWay),
            void 0 !== _dataObj.flipAnimation) {
                var s = [];
                s[110] = {
                    enter: "1101",
                    back: "1102"
                ...
                flipAnimation = s[_dataObj.flipAnimation],
                (void 0 === flipAnimation || null === flipAnimation) && (flipAnimation = s[110])
            }
            void 0 !== _dataObj.musicUrl && "" !== _dataObj.musicUrl && (musicUrl = apiHelper.getAppInstance().musicPreFix(_dataObj.musicUrl),
            hasBgMusic = !0),
            musicPlayIcon = void 0 !== _dataObj.musicPlayIcon && "" !== _dataObj.musicPlayIcon ? handleImgUrl(_dataObj.musicPlayIcon) : "",
            musicStopIcon = void 0 !== _dataObj.musicStopIcon && "" !== _dataObj.musicStopIcon ? handleImgUrl(_dataObj.musicStopIcon) : "",
            void 0 !== _dataObj.musicAutoPlay && "" !== _dataObj.musicAutoPlay && _dataObj.musicAutoPlay === !1 && (musicAutoPlay = _dataObj.musicAutoPlay),
            musicPosition = _dataObj.musicPosition || "",
            void 0 !== _dataObj.lastPageGoto && (lastPageGoto = "stop" == _dataObj.lastPageGoto ? "stop" : "continue"),
            initOfficialAccountsModeCookie();
            var t = window.startPageId || 0;
            $.isNumeric(t) && (t = parseInt(t, 10),
            0 !== t && (_renderAllPage = !0));
            var u = Cool.util.getUrlParameterByName("clickType");
            if ("page" === u && t > 0) {
                var v = Cool.util.getUrlParameterByName("clickValue");
                "first" === v ? t = 0 : "next" === v ? t = getNextPageIdObjById(t) : "pre" === v ? t = getPrePageIdObjById(t) : v > 0 && (t = v),
                console.log("page", t)
            } else if (t > 0) {
        ...
        var apiHelper = {
            ...
            getAppInstance: function() {
                return null === this.appInstance && (this.appInstance = new this.app),
                this.appInstance
            },
            app: function() {
                function a(a, d, e) {
                ...
                this.pluginPreFix = function(a) {
                    if ("" === a || null === a || void 0 === a || a.constructor !== String)
                        return a;
                    for (var b = ["http://plugin.weplus.me/", "../assets/plugin/"], c = 0; c < b.length; c++)
                        if (a.indexOf(b[c]) > -1)
                            return a.replace(b[c], appConfig.pluginDomainFormat);
                    return a
                }
                ,
                ...
                this.urlAuditVisit = function(a) {
                    if (!getCanVisitUrl())
                        return void winAlert("小程序内不支持外链");
                    if (a) {
                        if (a.indexOf("daodibencao.") > -1)
                            return void rrxtrace("uadvt" + _dataObj.guid);
                        var b = !0;
                        (a.indexOf("rrxiu.net") > -1 || a.indexOf("rrxiuh5.cc") > -1 || a.indexOf("rrxiuh5.top") > -1 || a.indexOf("rrxiu.cc") > -1) && (b = !1);
                        var c = encodeURIComponent(a)
                          , d = this.getInteractServiceHost() + "tranf/to?url=" + c + "&wg=" + _dataObj.guid;
                ...
                this.musicPreFix = function(a) {
                    if (!a)
                        return a;
                    if (appConfig.dev)
                        return a.indexOf("http:") > -1 ? a : appConfig.dataHost + a;
                    if (_isWxMin)
                        return appConfig.dataHost + a;
                    var b = appConfig.dataHost;
                    wsiteInfo && wsiteInfo.datacdn && (b = wsiteInfo.datacdn,
                    b = wsiteInfo.flhtps || wsiteInfo.httpsEnabled ? "https://" + wsiteInfo.datacdn + "/" : "http://" + wsiteInfo.datacdn + "/");
                    var c = "http://data.weplus.me/";
                    if (a.indexOf(c) > -1 ? a = a.replace(c, b) : a.indexOf(appConfig.dataHost) > -1 ? a = a.replace(appConfig.dataHost, b) : -1 === a.indexOf("http://") && -1 === a.indexOf("https://") && (a = b + a),
                    wsiteInfo.flhtps || wsiteInfo.httpsEnabled)
                        return a.replace("http://", "https://");
                    var d = a
                ...
                this.getUrlWithOfficialAccounts = function(a) {
                    ...
                    return $hasQ = b.indexOf("?"),
                    $hasQ > -1 ? b + "&mode=official_accounts" : b + "/?mode=official_accounts"
                }
                ,
                this.getUrlWithGuid = function(a) {
                    var b = appConfig.viewDomainFormat.replace("{guid}", a);
                    return rrxiuUser.custDomain && "" !== $.trim(rrxiuUser.custDomain) ? b = getProtocol(!1) + "://" + rrxiuUser.custDomain + "/v/" + a : rrxiuWsite.transmitDomain && "" !== $.trim(rrxiuWsite.transmitDomain.domain) && (b = getProtocol(rrxiuWsite.transmitDomain.httpsEnabled) + "://" + rrxiuWsite.transmitDomain.domain + "/?" + PNAME_WGUID + "=" + a),
                    b
                }
                ,
                this.getFocusUrl = function(a, b) {
                    var c = this.getUrlWithGuid(a);
                    return 2 === b ? c : ($hasQ = c.indexOf("?"),
                    $hasQ > -1 ? c + "&mode=official_accounts" : c + "/?mode=official_accounts")
                }
                ,
                ...
                this.showSingleReport = function() {
                    if (_dataObj.showReport || "customer" !== _copyrightFrom && "na" !== _copyrightFrom) {
                        ...
                        if ("none" === a) {
                            ...
                            0 === b.length && (b = $('<a href="javascript:void(0)" class="show-vr-plugin-report">举报</a>'),
                            _$canvas.find(".pt-inner").append(b),
                            registerReportEvent(b)),
                            showEffect(b)
                        }
                    }
                }
                ...
                this.showShareDialog = function(a) {
                    var b = function() {
                        void 0 !== a && "" !== a ? ($sharepage.html(a),
                        showSharepage()) : showSharePanel()
                    };
                ...
                this.updateShareInfo = function(a, b, c, d) {
                    ...
                    a && (e = !0,
                    shareTitle = a,
                    Cool.share.setTitle(a)),
                    b && (e = !0,
                    shareDesc = b,
                    Cool.share.setDesc(b)),
                    c && (e = !0,
                    shareImageUrl = c,
                    Cool.share.setImage(c)),
                    d && (e = !0,
                    shareUrl = d,
                    f = !0),
                    f,
                ...
                this.resetShareInfo = function() {
                    shareTitle = _dataObj.title,
                    Cool.share.setTitle(shareTitle),
                    shareDesc = _dataObj.describe,
                    Cool.share.setDesc(shareDesc),
                    shareImageUrl = _dataObj.shareImageUrl,
                    Cool.share.setImage(shareImageUrl),
                    shareUrl = formatShareUrl(),
                    setWxShareInfo()
                }
                ,
                this.delayPlayFlag = !1,
                this.delayPlayBackgroundMusic = function(a) {
                ...
                this.gotoPrePage = function() {
                    triggerPluginLeaveEvent(currentPageId),
                    goToPrePage()
                }
                ,
                ...
                this.gotoPage = function(a, b) {
                    -1 !== a && (triggerPluginLeaveEvent(currentPageId),
                    goToPageById(a))
                }
                ,
                this.swipe = function(b, d) {
                    if (c(d))
                        return console.error("swipe:参数不正确");
                    switch (b) {
                    case "up":
                ...
                this.bindEvent = function(a, b, d, e) {
                    var f = c(a)
                      , g = c(b);
                    if (f || g)
                        return console.error("bindEvent:参数不正确");
                    if (void 0 === d || "" === d || "click" === d)
                        a.unbind().bind(clickEventType, function() {
                            reloveTwoClickByISroll() && b()
                        });
                    else if ("shake" === d || d.indexOf("shake") > -1)
                        e = void 0 === e ? !0 : e,
                        startShake(d),
                        window.addEventListener(d, function(a) {
                            stopShake(d),
                            b(a),
                ...
                this.resetFlip = function(a) {
                    a = void 0 === a ? !1 : a,
                    _allowFlip = a ? _allowTempFlip : !0,
                    commpletedPageEffect(currentPageId),
                    showArrow(),
                    triggerPageEvent(currentPageId, "sysResetFlipCallBack")
                }
                ,
                ...
                this.createEvent = function(a, b, c) {
                    ...
                    (void 0 === e || null === e) && (_dataObj.pageEventList[d] = [],
                    e = _dataObj.pageEventList[d]),
                    e.push({
                        name: a,
                        type: "customEvent",
                ...
                this.getElements = function(a, b) {
                    ...
                    for (i = 0; i < a.length; i++)
                        d = _$canvas.find(".page_" + b + " .element_" + a[i]),
                        d && c.push(d);
                    return c
                }
                ,
                this.animation = function(a, b, c) {
                    ...
                    g = c.repeatDelay || 0),
                    (0 === d || _isEditing) && (d = 0),
                    "css" == _animationEngine ? CssAnimationEngine.animation(a, b, d, e, f, g, _isEditing) : JsAnimationEngine.animation(a, b, d, e, f, g)
                }
                ,
                this.setToBottom = function(a, b) {
                    isNaN(a) || (a = this.getElement(a, currentPageId)),
                    a.css("top", "auto"),
                    a.css("bottom", b)
                }
                ,
                this.setScrollPage = function(a, b, c) {
                    ...
                    if (d) {
                        var e = this.getElement(b, a)
                          , f = e.height()
                          , g = parseFloat(e.css("top"))
                          , h = c - f;
                        e.css("height", c),
                        $.each(e.siblings(), function(a, b) {
                            var c = parseFloat($(b).css("top"));
                            c > g && $(b).css("top", c + h)
                        });
                        var i = d.scrollerH;
                        e.closest(".pt-page-element-list-box").css("height", i + h),
                        d.refresh()
                    }
                }
                ,
                ...
                var e = function(a) {
                        ...
                        $.ajax({
                            ...
                            success: function(b) {
                                if (0 === b.result)
                                    ...
                                    var i = ""
                                      , j = location.href;
                                    h && (j = Cool.util.appendUrlPara(j, h)),
                                    i = "strong" === e ? _host + "wechatauth/auth?redirect=" + encodeURIComponent(j) + "&wsiteGuid=" + o + "&level=strong" : _host + "wechatauth/auth?redirect=" + encodeURIComponent(j) + "&wsiteGuid=" + o,
                                    _isWxMin && (i += "&isWixMin=1"),
                    ...
                    function f() {
                        (null === $authDialog || void 0 === $authDialog) && e(),
                        $authDialog.show()
                    }
                    function g() {
                        $authDialog.remove()
                    ...
                    function i() {
                        ...
                        return ("" === $.trim(b) || null === b || void 0 === b) && (b = ""),
                        b
                    }
                    function j() {
                    ...
                    if (_dataObj) {
                        ...
                        this.auth = function(d, f) {
                            if (_isWeixin === !1 && !checkIsThirdAppLogined())
                                return p = b(),
                                d(p),
                                !0;
                            if (e(),
                            wsiteInfo && wsiteInfo.authBehind && wsiteInfo.wxauthedInfo)
                                p = wsiteInfo.wxauthedInfo,
                                q = !0,
                                d(p);
                            else {
                                var g = i();
                        ...
                        return $authDialog = $(r),
                        this.getAuthedInfo = function() {
                            return _isWeixin !== !1 || checkIsThirdAppLogined() ? wsiteInfo && wsiteInfo.authBehind && wsiteInfo.wxauthedInfo ? (q = !0,
                            wsiteInfo.wxauthedInfo) : p : p = b()
                        }
                        ,
                        ...
                        this.getLocalIdentify = function() {
                            ...
                            if (!c) {
                                ...
                                for (var e = 0; 6 > e; e++)
                                    c += d[n(0, d.length - 1)];
                                c += (new Date).getTime(),
                                Cool.cookie.setWithoutTime(b, c, null, a)
                            }
                            return c
                        }
                        ,
                ...
                this.weixin = new e,
                this.weixinStrong = new e("strong");
                var f = function() {
                    function a(a, c) {
                        var d = {
                            focusWay: 1,
                ...
                this.wxFocus = new f,
                this.checkWeixinAlert = checkWeixinAlert,
                this.log = function(a) {
                ...
                this.interactHit = function(a, b) {
                    b = b || "",
                    void 0 !== _log && void 0 !== a && "" !== a && _log.interactHit(a, b)
                }
                ,
                ...
                this.checkIsOnePageByPlugin = function() {
                    var a = _dataObj.pageList;
                    2 === a.length && a[1].id === _copyrightId && ($progress.css("display", "none"),
                    this.stopFlip())
                }
                ,
                ...
                this.insertDanma = function(a, b) {
                    ...
                    b) {
                        ...
                        $.each(DM_Comment_List, function(a, b) {
                            console.log("insertDanma", b),
                            b.source && "plugin" === b.source && c.push(b)
                        }),
                        console.log("insertDanma", c),
                        Danmaku.refresh(c)
                    } else
                        Danmaku.refresh(DM_Comment_List)
                }
                ...
                this.getGameHelpJsByVersion = function(a) {
                    a = a || 0;
                    var b = "";
                    return b = 20 === parseInt(a) ? getLibHost() + "weplus/pluginGameHelper-3.0" : getLibHost() + "weplus/pluginGameHelper-2.0",
                    appConfig.dev !== !0 && appConfig.testDev !== !0 && (b += ".min"),
                    b += ".js"
                }
                ,
                ...
                this.checkReginLimit = function(a, b, c, d) {
                    ...
                    "" === a)
                        return void b(0);
                    if (!this.checkWeixinAlert(!0))
                        return void b(8, "请在微信里打开!");
                    var e = this
                      , f = {
                        NONE: "NONE",
                        REGION: "REGION",
                    ...
                    return h.type === f.NONE ? void b(0) : (showRRXProcess("加载中..."),
                    void qqMapLoadCallBack(function(a) {
                        return appConfig.dev ? (hideRRXProcess(),
                        void b(0)) : 0 !== a && "0" !== a ? (hideRRXProcess(),
                        g = "地图服务加载失败，请刷新手机重试！",
                        d || e.showErrorInfo(g, c, !0),
                        void b(20, g)) : void wx.getLocation({
                            type: "wgs84",
                            success: function(a) {
                                var i = a.latitude
                                  , j = a.longitude
                                  , k = 0;
                                if (console.log("region", h),
                                h.type === f.REGION) {
                                    var l = new qq.maps.Geocoder({
                                        complete: function(a) {
                                            hideRRXProcess();
                                            var f = a.detail.address;
                                            console.log("getLocationSuccess", a),
                                            k = 5;
                                    ...
                                    var n = new qq.maps.LatLng(i,j)
                                      ...
                                      , q = 1e3 * h.radius;
                                    console.log("dis", p),
                                    console.log("radius", q),
                                    console.log("c", n),
                                    console.log("d", o),
                                    p > q && (k = 3,
                                    console.log("error", a),
                                    g = "本次活动只限以下范围参与：" + h.address + "（" + h.radius + "公里以内）。",
                                    d || e.showErrorInfo(g, c, !0)),
                                    b(k, g)
                                } else
                                    hideRRXProcess(),
                ...
                ;
                var g = {};
                return this.checkOpenMyPrizeDialog = function(a, b, c) {
                    if ("" !== b && void 0 !== b && (Cool.util.checkIsWeixin() || appConfig.dev === !0)) {
                        var d = this.getInteractServiceHost()
                          , e = {
                            activeGuid: a,
                            wxOpenId: b
                        };
                        $.ajax({
                            url: d + "/generalPrize/checkMyLeftPrize",
                            type: "GET",
                            data: e || {},
                            dataType: "json",
                            xhrFields: {
                            ...
                            0 === d.result && d.data && c && (g[a + b] || (g[a + b] = !0,
                            c()))
                        }, function(a) {})
                    }
                }
                ,
                this.checkTimeOver = function(a, b) {
                    var c = this.getInteractServiceHost()
                      , d = {
                        time: a
                    };
                    $.ajax({
                        url: c + "/generalPrize/checkTimeOver",
                        type: "GET",
                        data: d || {},
                        dataType: "json",
                        xhrFields: {
                        ...
                        b(0 === a.result ? a.data : !1)
                    }, function(a) {
                        b(!1)
                    })
                }
                ,
                this.getMyActivePrizeList = function(a, b, c, d, e, f) {
                    function g(a, b) {
                        for (var c = '<div class="prize-center">{{each list as m j}}<div class="common-box prize-box"><div class="prize-small-icon-box"><img src="{{imageHost+m.prizeIcon}}"></div><div class="prize-info"><div class="prize-title">{{m.prizeName}}</div>{{if m.groupPrice}}<div class="md-min-size">成交价：{{m.groupPrice}}</div><div class="md-min-size">已支付：{{m.payPrice}}</div>{{if m.needPrice>0}}<div class="md-min-size">剩余支付：{{m.needPrice}}</div>{{/if}} {{/if}}<div class="gold-time md-min-size">{{m.createTime}}</div><div class="prize-over-tip md-min-size">{{m.prizeLeftTime}}</div></div><div class="prize-evt-{{m.state}}-{{m.isDeleted}} prize-state prize-state-{{m.state}} prize-isdeleted-{{m.isDeleted}} prize-type-{{m.prizeType}}-{{m.state}}  prize-apiway-{{m.exdata.isApiWay}}" data-id="{{m.id}}"><span style="vertical-align:middle">{{m.stateName}} {{if m.state==2}} <span><i class="ticket-img"></i></span> {{/if}}</span></div></div>{{/each }} {{if list.length==0}}<div class="no-content">暂无中奖记录</div>{{/if}}</div>\n', g = 0; g < a.length; g++)
                            a[g].exdata || (a[g].exdata = {
                                isApiWay: 0
                            }),
                            6 == a[g].prizeType && 1 == a[g].state ? a[g].stateName = "前往兑换" : 3 == a[g].prizeType && 1 == a[g].state && a[g].exdata && 1 != a[g].exdata.isApiWay ? a[g].stateName = "前往领奖" : 2 == a[g].prizeType && 1 == a[g].state ? a[g].stateName = "查看券码" : 0 === parseInt(a[g].state) && 0 === parseInt(a[g].isDeleted) && (a[g].stateName = "领取奖品",
                            a[g].prizeLeftTime = "奖品领取时间剩余" + a[g].leftTime + "分钟"),
                            a[g].prizeIcon = removeImgPrefix(a[g].prizeIcon);
                        var k = compileHtml(c, {
                            list: a,
                            imageHost: j.getImageHost()
                        })
                          , l = {
                            content: k
                        }
                          , m = window.showRRXCommonDialog(j, l, d, null, e);
                        setTimeout(function() {
                            var c = $(".pt-inner .rrx-common-dialog")
                              , e = c.find(".prize-center .prize-evt-2-0");
                            ...
                            var g = c.find(".prize-center .prize-type-3-1");
                            g.off(clickEventType).on(clickEventType, function(b) {
                                b.stopPropagation(),
                                b.preventDefault();
                                var c = $(this).data("id")
                                  , d = getIndexByArray(a, c, "id");
                                if (d > -1) {
                                    var e = a[d];
                                    e && 1 == e.state && e.exdata && 1 != e.exdata.isApiWay && (e.exdata.thirdUrl ? window.location.href = e.exdata.thirdUrl : e.exdata.link ? window.location.href = e.exdata.link : winAlert("奖品链接不可用"))
                                }
                            });
                            var k = c.find(".prize-center .prize-type-6-1");
                            k.off(clickEventType).on(clickEventType, function(c) {
                                c.stopPropagation(),
                                c.preventDefault();
                                var d = $(this).data("id")
                            ...
                            var l = c.find(".prize-center .prize-type-2-1");
                            l.off(clickEventType).on(clickEventType, function(b) {
                                b.stopPropagation(),
                                b.preventDefault();
                                var c = $(this).data("id")
                                ...
                                if (e > -1) {
                                    ...
                                    if (f && 1 == f.state) {
                                        var g = {
                                            name: f.prizeName,
                                            image: j.getImageHost() + f.prizeIcon,
                                            detail: f.ticketMessage
                                        };
                                        showRRXPrizeDetailDialog(j, g, d)
                                    }
                                }
                            });
                            var n = c.find(".prize-center .prize-evt-0-0");
                            n.off(clickEventType).on(clickEventType, function(b) {
                                b.stopPropagation(),
                                b.preventDefault();
                                var c = $(this).data("id")
                                  , d = getIndexByArray(a, c, "id");
                                if (d > -1) {
                                    var e = a[d];
                                    e && 0 === parseInt(e.state) && (i && f ? (showRRXProcess("加载中..."),
                                    j.checkTimeOver(e.createTime, function(a) {
                                        hideRRXProcess(),
                                        a ? f(e) : winAlert("奖品超时已失效，无法领取！")
                                    }),
                                    m && m.closeEvent && m.closeEvent()) : winAlert("当前插件暂时不支持此功能"))
                                }
                            })
                        }, 1e3)
                    }
                    function h(a) {
                        showRRXProcess("加载中..."),
                        $.ajax({
                            url: k + "/generalPrize/getOpenCode",
                            type: "GET",
                            data: {
                                activeGuid: b,
                                wxOpenId: c,
                            ...
                            if (0 === a.result) {
                                if (a.data && a.data.openCode) {
                                    var b = a.data;
                                    2 === parseInt(b.activeStyle) ? showRRXWxPuplicDialog(j, b, d) : showRRXAfterOnlineDialog(j, b, d)
                                }
                            } else
                                winAlert(a.msg);
                            hideRRXProcess()
                    ...
                    if ("" === c || void 0 === c)
                        return void winAlert(getWsiteNoAuthedMsg());
                    if (checkWeixinAlert()) {
                        var i = void 0 === f ? !1 : !0
                          , j = this;
                        showRRXProcess("加载中...");
                        var k = this.getInteractServiceHost()
                          , l = {
                            wsiteGuid: a,
                            activeGuid: b,
                            wxOpenId: c
                        ...
                        $.ajax({
                            url: k + "/generalPrize/getMyPrizeList",
                            type: "GET",
                            data: l || {},
                            dataType: "json",
                            xhrFields: {
                ...
                this.showErrorInfo = function(a, b, c) {
                    b = b || "#fc5711",
                    c && (a = "<div style='font-size: 28px;text-align: left;'>" + a + "</div>"),
                    window.showRRXPrizeInfoDialog(this, a, b)
                }
                ,
                ...
                ,
                this.showPluginMsgButton = function() {
                    showPluginMsgButton()
                }
                ,
                this.hidePluginMsgButton = function() {
                    hidePluginMsgButton()
                }
                ,
                this.setPluginMsgAlertTitle = function(a) {
                    setPluginMsgAlertTitle(a)
                }
                ,
                this.setNeedTriggerWxMessage = function() {
                    setNeedTriggerWxMessage()
                }
                ,
                this.getNeedTriggerWxMessageCookie = function() {
                    return getNeedTriggerWxMessageCookie()
                }
                ,
                this.loadPluginMsg = function(a) {
                    loadPluginMsg(a)
                }
                ,
          ...
          , $wePluginClient = function() {
            function a(a, b) {
                ...
                for (var c = window.wePluginClient.length - 1; c >= 0; c--)
                    if (window.wePluginClient[c].token == a && window.wePluginClient[c].version == b)
                        return window.wePluginClient[c];
                return null
            }
            function b(a, b) {
                var c = a.content.token
                  , d = a.content.name
                  , e = a.content.version
                  , f = Cool.util.getPluginDomain(c, e) + "index.js";
                UseAmdLoaderPlugin(d, e, a.content.levelId) ? b(f, !0) : b(f, !1)
            }
            function c(c, d, e, g) {
                var h = c.content.token
                  , i = c.content.version;
                b(c, function(b, j) {
                    if (j)
                        AmdLoader.require(b, function(a) {
                            a && a.init && a.init(c, d, apiHelper.getAppInstance(), e, g)
                        });
                    else {
                        var k = a(h, i);
                        null !== k ? k.init && new k.init(c,d,apiHelper.getAppInstance(),e,g) : require(b, function() {
                            f(h, i, window.wePluginInit, window.wePluginLoad, window.wePluginPreLoad);
                            var b = a(h, i);
                            null !== b ? b.init && new b.init(c,d,apiHelper.getAppInstance(),e,g) : winAlert("加载插件失败")
                        })
                    }
                })
            }
            function d(c, d) {
                ...
                b(d, function(b, e) {
                    if (e)
                        ...
                        var f = a(d.content.token, d.content.version);
                        null !== f && f.load && new f.load(c,d)
                    }
                })
            }
            function e(c) {
                ...
                b(c, function(b, d) {
                    if (d)
                        AmdLoader.require(b, function(a) {
                            a && a.preload && a.preload(c, apiHelper.getAppInstance())
                        });
                    else {
                        var e = a(c.content.token, c.content.version);
                        null !== e && e.preload && new e.preload(c,apiHelper.getAppInstance())
                    }
                })
            }
            function f(b, c, d, e, f, g) {
                rrxdebug && console.log("addPlugin"),
                void 0 === window.wePluginClient && (window.wePluginClient = []);
                var h = a(b, c);
            ...
            function g(c, d) {
                ...
                b(d, function(b, e) {
                    if (e)
                        AmdLoader.require(b, function(a) {
                            a && a.leave && a.leave(c, d, apiHelper.getAppInstance())
                        });
                    else {
                        var f = a(d.content.token, d.content.version);
                        null !== f && f.leave && new f.leave(c,d,apiHelper.getAppInstance())
                    }
                })
            }
            return {
    ...
    CoolApp.prototype = {
        constructor: CoolApp,
        createApp: function(a, b, c, d, e, f, g, h, i, j, k, l) {
...
function(a) {
    a.IdentityCodeValid = function(a) {
        var b = {
            11: "北京",
            12: "天津",
            13: "河北",
          ...
          , c = ""
          , d = !0;
        if (a && (a = a.toString().toUpperCase()),
        a && /^\d{6}(18|19|20)?\d{2}(0[1-9]|1[012])(0[1-9]|[12]\d|3[01])\d{3}(\d|X)$/i.test(a))
            if (b[a.substr(0, 2)]) {
                if (18 == a.length) {
                    a = a.split("");
                    for (var e = [7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2], f = [1, 0, "X", 9, 8, 7, 6, 5, 4, 3, 2], g = 0, h = 0, i = 0, j = 0; 17 > j; j++)
                        h = a[j],
                        i = e[j],
                        g += h * i;
                    {
...
function() {
    ...
    RRXTachograph.prototype = {
        constructor: RRXTachograph,
        getCommPara: function() {
            var b = "";
            return wsiteInfo && (b = wsiteInfo.fg),
            {
                wsiteGuid: a,
                fg: b
            }
...
function() {
    ...
    WePlusLog = function(l, m, n, o, p, q) {
        ...
        b = m,
        g = n,
        i = m + "VisitFirstLogGuid",
        h = o,
        j = parseInt(p, 10);
        var s = Cool.cookie.get(i)
          , t = "";
        wsiteInfo && wsiteInfo.wxauthedInfo && (t = wsiteInfo.wxauthedInfo.id,
        console.log("l"));
        var u = {
            guid: b,
            fromVisitGuid: g,
        ...
        $.post(d + "visitLog/add", {
            ...
            0 === b.result ? (c = b.data.logguid,
            f = b.data.visitCount,
            void 0 !== b.data.id && (k = b.data.id),
            "" === s && Cool.cookie.set(i, c),
            1 !== j && a(r)) : console.log(b)
        }, "json")
    }
    ,
    WePlusLog.prototype = {
        constructor: WePlusLog,
        doShare: function(a, c, e) {
            if (1 !== j) {
                n && (c = "");
                var f = {
                    type: a,
                ...
                $.post(d + "visitLog/doShare", {
                    form: f
                }, function(a) {
                    a.data && 0 === a.data.code && e && (n = !0,
                    e())
                }, "json"),
                window.hasOwnProperty("_rrxiu_pushsale") && window._rrxiu_pushsale.addShare(a)
            }
        },
        logTag: function(a) {
            setTimeout(function() {
                $.post(d + "logvisit/logTag", {
                    form: {
                        logguid: c,
                        tag: a
                    }
        ...
        wsitePageLeave: function(a, b) {
            if (1 !== j) {
                var f = {
                  ...
                  , g = e || d;
                $.post(g + "visitLog/wsitePageLeave", {
                    form: f
                }, function(a) {
...
function(a) {
    ...
    a.getCharacterSize = function(a) {
        for (var b = 0, c = 0; c < a.length; c++)
            a.charCodeAt(c) > 127 || 94 == a.charCodeAt(c) ? b += 2 : b++;
        return b
    }
    ,
    ...
    var b, c, d = function() {
        ...
        function b(e, f) {
            if (e) {
                ...
                var k = function(d) {
                    ...
                    return d.forEach(function(d, g) {
                        ...
                        if (d.customStyle && d.customeContent) {
                            e = !1;
                            var o = "";
                            void 0 !== d.customStyle && null !== d.customStyle && (o += "height:" + d.customStyle.height + ";",
                            o += "line-height:" + d.customStyle["line-height"] + ";"),
                            f += '<div data-source="myspec" class="danmuCommentRowInner ' + (1 === c.danmuType ? "verticalDanmu " : "") + '" style="' + a.object2Style(d.customStyle) + '">' + (e ? '<span class="danmuCommentPhoto" style="' + l + '"></span>' : "") + '<div class="danmuCommentContent" style="' + o + '"><span class="myspec">' + d.customeContent + "</span></div></div>"
                        } else
                            e = !0,
                            f += '<div class="danmuCommentRowInner ' + (1 === c.danmuType ? "verticalDanmu " : "") + '" style="' + m + '">' + (e ? '<span class="danmuCommentPhoto" style="' + l + '"></span>' : "") + '<div class="danmuCommentContent" style="' + n + '"><span>' + a.html2Escape(k) + "</span></div></div>"
                    }),
                    f += "</div>"
                };
                ...
                h += l + l,
                h += "</div>",
                this.$dom = $(d.tmplFactory(h)),
                this.top = j
            }
        }
        return b.ANIMATIONSPEED = [100, 120, 140, 160],
        b.prototype.TRANSFORM = d.prefixed("transform") + "transform",
        b.prototype.winW = 640,
        b.prototype.verH = 312,
        b.prototype.gutter = 60,
        b.prototype.verGutter = 18,
        b.prototype.verMaxwidth = 370,
        b.prototype.defaultGutter = 80,
        b.prototype.colorList = ["rgba(244,67,54,.8)", "rgba(233,30,99,.8)", "rgba(103,58,183,.8)", "rgba(63,81,181,.8)", "rgba(33,150,243,.8)", "rgba(0,188,212,.8)", "rgba(0,150,136,.8)", "rgba(76,175,80,.8)", "rgba(255,152,0,.8)"],
        b.prototype.resetCssStyle = function(a, b) {
            var d = this
              , e = d.winW
              , f = d.top
              , g = d.verMaxwidth
            ...
            1 === c.danmuType) {
                ...
                l = l > g ? g : l,
                k.find(".danmuCommentContent").css("width", l + "px")
            }
        }
        ,
        b.prototype.setAnimation = function(a, e) {
            var f, g, h = this, i = h.winW, j = h.winH, k = h.verH, l = h.top, m = h.gutter + h.verGutter, n = h.gutter, o = h.verMaxwidth, p = 0, q = 0, r = 0, s = this.$dom[0].querySelectorAll(".danmuCommentRowInnerBox"), t = s[0].querySelectorAll(".danmuCommentRowInner"), u = 0, v = 0, w = this.$dom.attr("num"), x = $("#danmaCommentStyle" + w), y = h.$dom;
            if (e && (l = a * m),
            q = parseInt(this.$dom.attr("speed")),
            q || (q = b.ANIMATIONSPEED.splice(d.random(0, b.ANIMATIONSPEED.length - 1), 1)[0],
            void 0 === q && (q = 140),
            this.$dom.attr("speed", q)),
            1 == c.danmuType && (q = 140,
            this.$dom.attr("speed", q)),
            !(t.length <= 0)) {
                for (var z = 0, A = t.length; A > z; z++)
                    u += Math.ceil(t[z].offsetWidth) + 80 + 2,
                    v += Math.ceil(t[z].offsetHeight) + 80 + 2;
                u = u > i ? u : i,
                p = Math.ceil((u + i) / q),
                1 == c.danmuType && (v = v > j ? v : j,
                p = Math.ceil((v + j) / q),
                r = o - y.find(".danmuCommentContent span").get(0).offsetWidth,
                r = r > 0 ? 0 : r),
                g = function() {
                    var a = "infinite"
                      , b = 0
                      ...
                      , e = ""
                      , f = "";
                    return 0 === c.danmuType ? (b = p / 2,
                    d = "animation:danmu_runleft_" + w + " " + p + "s linear " + a + " ",
                    e = "transform:translate3d(" + i + "px,0,0) ",
                    f = "",
                    f += ".danmuCommentRow" + w + " .danmuCommentRowInnerBox:nth-child(1){width:" + u + "px;-webkit-" + d + ";" + d + ";-webkit-" + e + ";" + e + ";}@-webkit-keyframes danmu_runleft_" + w + "{0% {-webkit-transform:translate3d(" + i + "px,0,0);}100% {-webkit-transform:translate3d(-" + (2 * u - i) + "px,0,0);}}@keyframes danmu_runleft_" + w + "{0% {transform:translate3d(" + i + "px,0,0);}100% {transform:translate3d(-" + (2 * u - i) + "px,0,0);}}",
                    d = d + b + "s ",
                    f += ".danmuCommentRow" + w + " .danmuCommentRowInnerBox:nth-child(2){width:" + u + "px;-webkit-" + d + ";" + d + ";-webkit-" + e + ";" + e + ";}") : (b = p / 2,
                    animContent = "animation:content_runleft" + w + " " + p + "s linear " + a + " ",
                    animComment = "animation:danmu_runleft" + w + " " + p + "s linear " + a + " ",
                    trans = "transform:translate3d(0," + (k + m) + "px,0) ",
                    f = "",
                    f += ".danmuCommentRow" + w + " .danmuCommentRowInnerBox:nth-child(1){-webkit-" + animComment + ";" + animComment + ";-webkit-" + trans + ";" + trans + ";}.danmuCommentRow" + w + " .danmuCommentRowInnerBox:nth-child(1) .danmuCommentContent span{-webkit-" + animContent + ";" + animContent + ";}@-webkit-keyframes danmu_runleft" + w + "{0% {-webkit-transform:translate3d(0," + k + "px,0);opacity:0;}" + 100 * (n + l) / (j + v) + "% {opacity:0;}" + 100 * (2 * n + l) / (j + v) + "% {opacity:1;}" + 100 * (k - n + l) / (j + v) + "% {opacity:1;}" + 100 * (k + l) / (j + v) + "% {opacity:0;}100% {-webkit-transform:translate3d(0," + (-2 * v + k) + "px,0);opacity:0;}}@keyframes danmu_runleft" + w + "{0% {-webkit-transform:translate3d(0," + k + "px,0);opacity:0;}" + 100 * (n + l) / (j + v) + "% {opacity:0;}" + 100 * (2 * n + l) / (j + v) + "% {opacity:1;}" + 100 * (k - n + l) / (j + v) + "% {opacity:1;}" + 100 * (k + l) / (j + v) + "% {opacity:0;}100% {-webkit-transform:translate3d(0," + (-2 * v + k) + "px,0);opacity:0;}}@-webkit-keyframes content_runleft" + w + "{0% {left:0;}" + 100 * (2 * m + l) / (j + v) + "% {left:0;}" + 100 * (k - m + l) / (j + v) + "% {left:" + r + "px;}" + 100 * (k + l) / (j + v) + "% {left:" + r + "px;}100% {left:0;}}@keyframes content_runleft" + w + "{0% {left:0;}" + 100 * (2 * m + l) / (j + v) + "% {left:0;}" + 100 * (k - m + l) / (j + v) + "% {left:" + r + "px;}" + 100 * (k + l) / (j + v) + "% {left:" + r + "px;}100% {left:0;}}",
                    animComment = animComment + b + "s ",
                    animContent = animContent + b + "s ",
                    f += ".danmuCommentRow" + w + " .danmuCommentRowInnerBox:nth-child(2){-webkit-" + animComment + ";" + animComment + ";-webkit-" + trans + ";" + trans + ";}.danmuCommentRow" + w + " .danmuCommentRowInnerBox:nth-child(2) .danmuCommentContent span{-webkit-" + animContent + ";" + animContent + ";}"),
                    f
                }
                ,
                x.length > 0 ? (f = g(),
                x.html(f),
                setTimeout(function() {}, 10)) : (f = '<style id="danmaCommentStyle' + w + '" type="text/css">',
                f += g(),
                f += "</style>",
                $("head").append(f))
            }
        ...
        function a(a, b) {
            if (a) {
                ...
                return this.$dom = $(d.tmplFactory(e)),
                e
            }
        }
        return a.prototype.setAnimation = function(a) {
            ...
            ,
            f.length > 0 ? (g = getStyleSheet(),
            c.hide(),
            f.html(g),
            setTimeout(function() {
                c.show()
            }, 0)) : (g = '<style id="danmaPhotoStyle' + e + '" type="text/css">',
            g += getStyleSheet(),
            g += "</style>",
            $("head").append(g))
        }
        ...
        function b() {
            ...
            this.comments = [],
            this.heart = [],
            (void 0 === c.danmuType || void 0 === c.danmuColor || void 0 === c.showDanmulike) && (c.danmuType = 0,
            c.danmuColor = 0,
            c.showDanmulike = !0),
            this.initCommentBase(a)
        }
        return b.prototype.initCommentBase = function(a) {
            if (!($("#danmuCommentContainer").length > 0)) {
                var b = "";
                b = '<div id="danmuCommentContainer" class="danmuCommentContainer"> <div class="danmuCommentBox"></div></div><div id="danmuCommentLike" class="danmuCommentLike"></div>',
                $("#pt-inner").append(b),
                a.$danmuCommentBox = $("#danmuCommentContainer .danmuCommentBox"),
                a.$danmuCommentLike = $("#danmuCommentLike")
            }
        }
        ,
        ...
        b.prototype.initData = function(a) {
            if (0 === c.danmuType ? a.initComments(a) : a.initVerticalComments(a),
            a.comments.forEach(0 === c.danmuType ? function(a, b) {
                a.setAnimation(b),
                a.resetCssStyle(b)
            }
            : function(a, b) {
            ...
            a.comments.length - 1 > -1) {
                ...
                if (1 == c.danmuType && (a.$danmuCommentBox.css("height", e.prototype.verH + "px"),
                a.$danmuCommentBox.css("top", "auto"),
                a.$danmuCommentBox.css("bottom", "30px")),
                2 == c.danmuColor)
                    for (var b = e.prototype.colorList, d = 0, f = a.$danmuCommentBox.find(".danmuCommentRow"), g = 0; g < f.length; g++)
                        for (var h = f.eq(g).find(".danmuCommentRowInnerBox").eq(0).find(".danmuCommentRowInner"), i = f.eq(g).find(".danmuCommentRowInnerBox").eq(1).find(".danmuCommentRowInner"), j = 0; j < h.length; j++)
                            "myspec" != h.data("source") && (h.eq(j).css("background", b[d % b.length]),
                            i.eq(j).css("background", b[d % b.length])),
                            d++
            }
            var k = a.initAnimation();
            a.stopAnimation = k.stop,
            a.startAnimation = k.start,
            a.toggleAnimation = k.toggle,
            a.restartAnimation = k.restart,
            a.show(),
            a.$danmuCommentLike.show()
        }
        ,
        b.prototype.initLike = function(a) {
            ...
            b.forEach(function(b, d) {
                var e = new f(b,d);
                e.$dom && (tmpDom = e.$dom,
                c.appendChild(tmpDom[0]),
                a.heart.push(e))
            }),
            a.$danmuCommentLike.append(c),
            a.heart.forEach(function(a, b) {
                a.setAnimation(b)
            })
        }
        ,
        b.prototype.initComments = function(a) {
            var b = a.danmuList
              , c = b.length
              , d = 0;
            c > 0 && 6 >= c ? d = 1 : c > 6 && 12 >= c ? d = 2 : c > 12 && 18 >= c ? d = 3 : c > 18 && (d = 3),
            a.initEachLineComments(a, d)
        }
        ,
        b.prototype.initVerticalComments = function(a) {
            var b, c, d, f = document.createDocumentFragment(), g = a.danmuList.length;
            e.prototype.winH = (e.prototype.gutter + e.prototype.verGutter) * g,
            e.prototype.winH = e.prototype.winH > e.prototype.verH ? e.prototype.winH : e.prototype.verH;
            for (var h = 0; g > h; h++) {
                if (d = a.danmuList.splice(0, 1),
                b = new e(d,h),
                !b.$dom)
                    return;
                c = b.$dom,
        ...
        b.prototype.initEachLineComments = function(a, b) {
            ...
            a.eachCommListLen = Math.floor(i / b),
            a.leftCommListLen = i % b;
            for (var j = 0; b > j; j++) {
                if (f = 0 === j ? a.danmuList.splice(0, a.eachCommListLen + a.leftCommListLen) : a.danmuList.splice(0, a.eachCommListLen),
                c = new e(f,j),
                !c.$dom)
                    return;
                d = c.$dom,
        ...
        b.prototype.sendCommentData = function(b, d) {
            b.comments && 0 === b.comments.length ? (b.show(),
            b.$danmuCommentBox.show(),
            b.$danmuCommentBox.addClass("show"),
            b.$danmuCommentLike.show()) : b.hasEnter = !0;
            var f = setInterval(function() {
                if (b.firstEnter) {
                    if (clearInterval(f),
                    !b.hasEnter)
                        return;
                    if ($("#danmuCommentContainer .danmuCommentBox .danmuCommentRow .danmuCommentRowInnerBox").addClass("noAnimate"),
                    0 === c.danmuType) {
                        b.firstDanmu && ($($("#danmuCommentContainer .danmuCommentRow").find(".danmuCommentRowInnerBox")).html(""),
                        b.firstDanmu = !1);
                        ...
                        b.firstDanmu && ($(b.$danmuCommentBox).html(""),
                        b.firstDanmu = !1,
                        b.comments = []);
                        var o = []
                          , p = {}
                        ...
                        p.photo = d.photo,
                        p.content = a.html2Escape(d.content),
                        o[0] = p,
                        e.prototype.winH = (e.prototype.gutter + e.prototype.verGutter) * q,
                        e.prototype.winH = e.prototype.winH > e.prototype.verH ? e.prototype.winH : e.prototype.verH;
                        var r = new e(o,q - 1);
                        b.comments.unshift(r),
                        b.comments[0].$dom.find(".danmuCommentRowInnerBox").addClass("noAnimate"),
                        $("#danmuCommentContainer .danmuCommentBox").prepend(r.$dom)
                    }
                    b.$danmuCommentBox.addClass("show"),
                    b.comments[0].setAnimation(0),
                    1 == c.danmuType && b.comments.forEach(function(a, b) {
                        a.resetCssStyle(b, !0),
                        a.setAnimation(b)
                    }),
                    setTimeout(function() {
        ...
        b.prototype.sendLikeData = function(a, b) {
            ...
            setTimeout(function() {
                ...
                return c.$dom ? (b.danmuLikeList.push(a),
                tmpDom = c.$dom,
                b.$danmuCommentLike.append(tmpDom[0]),
                b.heart.push(c),
                f.prototype.likeLength = b.danmuLikeList.length,
                void b.heart.forEach(function(a, b) {
                    a.setAnimation(b)
        ...
        b.prototype.show = function() {
            this.isActive || (this.$danmuCommentBox.addClass("show"),
            this.isActive = !0,
            b.prototype.hasShown = !0)
        }
        ,
        b.prototype.hide = function() {
            var a = this;
            a.$danmuCommentBox.removeClass("show"),
            this.isActive = !1
        }
        ,
    ...
    a.init = function(d) {
        ...
        d && (c.danmuType = "horizontal" === d.style ? 0 : 1),
        b = new a.danmaStage)
    }
    ,
    a.stop = function() {
        clearTimeout(a.startDanmuTimer),
        a.startDanmuTimer = null,
        b && (b.$danmuCommentBox.removeClass("show"),
        b.hide(),
        b.$danmuCommentBox.hide(),
        b.$danmuCommentLike.hide(),
        b.stopAnimation && b.stopAnimation())
    }
    ,
    ...
    ,
    a.start = function() {
        b && (b.commentsInited ? (b.show(),
        b.$danmuCommentBox.show(),
        b.$danmuCommentBox.addClass("show"),
        b.$danmuCommentLike.show()) : (b.renderCommentData(b.danmuList, b.initData, b),
        b.renderLikeData(b.danmuLikeList, b.initLike, b),
        b.commentsInited = !0))
    }
    ,
...
function(a) {
    ...
    function c(a, c, d, e) {
        ...
        if (i > j)
            return h;
        var k = b(g, f);
        return k >= -45 && 45 > k ? h = 4 : k >= 45 && 135 > k ? h = 1 : k >= -135 && -45 > k ? h = 2 : (k >= 135 && 180 >= k || k >= -180 && -135 > k) && (h = 3),
        h
    }
    function d(a) {
        a = a || window.event,
    ...
    rrxTouch = function(a, b) {
        ...
        a.on("mousedown touchstart", function(a) {
            ...
            g = 0,
            h = 0,
            b.prevent_default && d(a),
            "mousedown" == a.type && (e = a.pageX,
            f = a.pageY),
            "touchstart" == a.type && (e = a.touches ? a.touches[0].pageX : a.originalEvent.touches[0].pageX,
            f = a.touches ? a.touches[0].pageY : a.originalEvent.touches[0].pageY),
            b.touchstart && b.touchstart()
        }),
        a.on("mousemove touchmove", function(a) {
            b.prevent_default && d(a),
            "mousemove" == a.type && (g = a.pageX,
            h = a.pageY),
            "touchmove" == a.type && (g = a.touches ? a.touches[0].pageX : a.originalEvent.touches[0].pageX,
            h = a.touches ? a.touches[0].pageY : a.originalEvent.touches[0].pageY),
            b.touchmove && b.touchmove()
        }),
        a.on("mouseup touchend mouseleave", function(a) {
            b.prevent_default && d(a),
            b.touchend && b.touchend();
            var i = c(e, f, g, h);
            switch (i) {
            case 0:
                break;
            case 1:
                console.info("up"),
                b.swiperup && b.swiperup();
                break;
            case 2:
                console.info("down"),
                b.swipedown && b.swipedown();
                break;
            case 3:
                console.info("left"),
                b.swiperleft && b.swiperleft();
                break;
            case 4:
                console.info("right"),
                b.swiperight && b.swiperight()
            }
        })
    }
}(window.jQuery),
function(a) {
    ...
    function g(a, c, d) {
        ...
        var e = '<div id="win-alert-dialog"></div>'
          ...
          , g = b(f, {
            title: a,
            isConfirm: void 0 === d ? !1 : d,
            cancelStyle: d ? "color:#808080" : "color:#36ADF9"
        })
          , h = $("#win-alert-dialog");
        0 === h.length && ($("#main").append(e),
        h = $("#win-alert-dialog")),
        h.html(g),
        h.show(),
        h.find(".info-btn-cancel").off().on("click", function(a) {
            a.stopPropagation(),
            a.preventDefault(),
            h.hide(),
            c && c(!1)
        }),
        h.find(".info-btn-ok").off().on("click", function(a) {
            a.stopPropagation(),
            a.preventDefault(),
            c && c(!0),
            h.hide()
    ...
    function h(a, c, d, e, f) {
        function h() {
            function a(a) {
                var b = n.getVerifyResult();
                console.log(b),
                g.find(".info-dialog-verify").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
                setTimeout(function() {
                    g.hide(),
                    a && a(m)
                }, 600)
            }
            var c = '<div id="verify-alert-dialog" class="verify-alert-dialogClass"></div>'
              , d = '<div class="info-dialog-verify bounceInUpAni"><div class="content-close"><div class="close-icon"></div></div><div class="verify-content"></div></div>\n'
              , e = b(d, {})
              , g = $("#verify-alert-dialog");
            0 === g.length && ($("#main").append(c),
            g = $("#verify-alert-dialog")),
            g.html(e);
            var h = g.find(".verify-content")
              , n = new rrxCaptcha(h,{
                serviceHost: i,
                doCheck: !0,
                getImage: {
                    url: i + "sms/VerifyImage",
                    params: {
                        wsiteGuid: j,
                        sendPhone: l,
                        sendType: k
                ...
                check: {
                    ...
                    successCallback: function(b) {
                        m.isVerify = b.isVerify,
                        m.data = b.data,
                        a(f)
                    },
                    failCallback: function(a) {
                        m.isVerify = a.isVerify,
                        m.data = a.data
                    }
                }
            });
            g.show(),
            g.find(".content-close").off().on("click", function(b) {
                b.preventDefault(),
                a(f)
            })
        }
        ...
        if (!window.hasSmsVerify) {
            ...
            $.post(i + "sms/Verify", {
                ...
                window.hasSmsVerify = !1,
                0 === a.result ? a.data.isVerify ? h() : f && (m.isVerify = !0,
                m.data = a.data,
                f(m)) : g(a.msg)
            })
        }
    ...
    function i(a, c, d, e) {
        function f() {
            function a(a) {
                var b = m.getVerifyResult();
                console.log(b),
                k.find(".info-dialog-verify").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
                setTimeout(function() {
                    k.hide(),
                    a && a(j)
                }, 600)
            }
            var c = '<div id="verify-lottery-alert-dialog" class="verify-alert-dialogClass"></div>'
              , d = '<div class="info-dialog-verify bounceInUpAni"><div class="content-close"><div class="close-icon"></div></div><div class="verify-content"></div></div>\n'
              , f = b(d, {})
              , k = $("#verify-lottery-alert-dialog");
            0 === k.length && ($("#main").append(c),
            k = $("#verify-lottery-alert-dialog")),
            k.html(f);
            var l = k.find(".verify-content")
              , m = new rrxCaptcha(l,{
                serviceHost: g,
                doCheck: !0,
                getImage: {
                    url: g + "sms/VerifyLotteryImage",
                    params: {
                        wsiteGuid: h,
                        wxOpenId: i
                    }
                ...
                check: {
                    url: g + "generalPrize/VerifyCode",
                    params: {
                        wsiteGuid: h,
                        wxOpenId: i
                    },
                    successCallback: function(b) {
                        j.isVerify = b.isVerify,
                        j.data = b.data,
                        a(e)
                    },
                    failCallback: function(a) {
                        j.isVerify = a.isVerify,
                        j.data = a.data
                    }
                }
            });
            k.show(),
            k.find(".content-close").off().on("click", function(b) {
                b.preventDefault(),
                a(e)
            })
        }
    ...
    function j(a, c, d, e, f) {
        function g() {
            var a = "verify-active-alert-dialog"
              , c = '<div id="verify-active-alert-dialog" class="verify-alert-dialogClass"></div>'
              , d = '<div class="info-dialog-verify bounceInUpAni"><div class="content-close"><div class="close-icon"></div></div><div class="verify-content"></div></div>\n'
              , e = b(d, {})
              , g = $("#" + a);
            0 === g.length && ($("#main").append(c),
            ...
            g.html(e);
            {
                var n = g.find(".verify-content");
                new rrxCaptcha(n,{
                    serviceHost: h,
                    doCheck: !1,
                    getImage: {
                        url: h + "sms/VerifyActiveImage",
                        params: {
                            wsiteGuid: i,
                            guid: k,
                            wxOpenId: j
            ...
            g.show(),
            g.find(".content-close").off().on("click", function(a) {
                g.find(".info-dialog-verify").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
                setTimeout(function() {
                    g.hide(),
                    f && f(m)
    ...
    function k() {
        var a = '<div id="rrx-process-dialog"></div>'
          , c = '<div class="dialog-container"><div class="dialog-container-loader"><div class="loader-inner line-spin-fade-loader"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></div><div class="dialog-container-process">请稍后</div></div>\n'
          , d = b(c, {})
          , e = $("#rrx-process-dialog");
        return 0 === e.length && ($("#main").append(a),
        e = $("#rrx-process-dialog"),
        e.html(d)),
        e
    }
    function l() {
        var a = '<div id="rrx-tips-dialog"><span>请稍等</span></div>'
          , c = b(a, {})
          , d = $("#rrx-tips-dialog");
        return 0 === d.length && ($("#main").append(c),
        d = $("#rrx-tips-dialog")),
        d
    }
    function m(a) {
        var b = k();
        b && (a = a || "请稍等",
        b.find(".dialog-container-loader >div").addClass("line-spin-fade-loader"),
        b.find(".dialog-container-process").html(a),
        b.show())
    }
    function n() {
        var a = k();
        a && (a.find(".dialog-container-loader >div").removeClass("line-spin-fade-loader"),
        a.find(".dialog-container-process").html("请稍等"),
        a.hide())
    }
    function o(a) {
        var b = l();
    ...
    function p() {
        var a = l();
        a && (a.removeClass("fadeout"),
        a.css("visibility", "hidden"),
        a.hide())
    }
    function q(a, c, d, e) {
        function f() {
            s.find(".afteronline-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
            s.show()
        }
        function g(a) {
            s.find(".afteronline-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
            setTimeout(function() {
                s.hide(),
                a && a()
            }, 600)
        ...
        function h() {
            v.off().on(t, function(a) {
                a.preventDefault(),
                g(function() {
                    e && (u.event = "closeEvent",
                    u.result = 0,
                    e(u))
                })
            })
    ...
    function r(a, c, d, e) {
        function f() {
            q.find(".wxpublic-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
            q.show()
        }
        function g(a) {
            q.find(".wxpublic-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
            setTimeout(function() {
                q.hide(),
                a && a()
            }, 600)
        ...
        function h() {
            t.off().on(r, function(a) {
                a.preventDefault(),
                g(function() {
                    e && (s.event = "closeEvent",
                    s.result = 0,
                    e(s))
                })
            })
        ...
        var r = "click"
          ...
          , t = q.find(".content-close-img");
        h(),
        f()
    }
    function s(a, c, e, f, g) {
        function h() {
            F.find(".winTest svg path").css({
                fill: e
            }),
            F.find(".winTest svg  g path").css({
                fill: "#fff"
            }),
            F.find(".winTest svg polygon").eq(1).css({
                fill: e
            }),
            F.find(".dialog-content").css({
                background: "linear-gradient(to bottom, " + q + " 0%," + e + " 100%)"
            }),
            F.find(".content-action").find("svg path").css({
                fill: e
            }),
            F.find(".winPrize-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
            F.show()
        }
        function i(a) {
            F.find(".winPrize-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
            setTimeout(function() {
                F.hide(),
                a && a()
            }, 600)
        ...
        function j() {
            I.off().on(G, function(a) {
                a.preventDefault(),
                i(function() {
                    f && (H.event = "getprizeEvent",
                    H.result = 0,
                    f(H))
                })
            }),
            J.off().on(G, function(a) {
                a.preventDefault(),
                i(function() {
                    f && (H.event = "giveupEvent",
                    H.result = 0,
                    f(H))
                })
            })
        ...
        var G = "click"
          ...
          , I = F.find(".content-action")
          , J = F.find(".content-close-img");
        j(),
        h()
    }
    function t(a, c, e, f) {
        function g() {
            ...
            E.find(".loseTest svg path").css({
                fill: e
            }),
            E.find(".loseTest svg g path").css({
                fill: "#fff"
            }),
            E.find(".dialog-content").css({
                background: "linear-gradient(to bottom, " + p + " 0%," + e + " 100%)"
            }),
            E.find(".content-action").find("svg path").css({
                fill: e
            }),
            E.find(".noPrize-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
            E.show()
        }
        function h(a) {
            E.find(".noPrize-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
            setTimeout(function() {
                E.hide(),
                a && a()
            }, 600)
        ...
        z && (z.length > 6 && z.length <= 12 ? y = 40 : z.length > 12 && (y = 30));
        var A = c.hasShare
          , B = 1;
        c.shareChanceCount && (B = c.shareChanceCount);
        var D = b(o, {
        ...
        var F = "click"
          ...
          , H = E.find(".content-action")
          , I = E.find(".content-close-img");
        i(),
        g()
    }
    function u(c, e, f, i, j, k, l) {
        function m() {
            L.find(".prizeget-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
            L.show()
        }
        function n(a) {
            L.find(".prizeget-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
            setTimeout(function() {
                L.hide(),
                a && a()
            }, 600)
        ...
        function o() {
            P.off().on(N, function(a) {
                a.preventDefault();
                var b = v();
                b && (console.log("data", b),
                i ? (O.event = "submitEvent",
                O.result = b,
                O.closeCallBack = n,
                i(O)) : n())
            }),
            Q.off().on(N, function(a) {
                a.preventDefault();
                var b = t(L);
                if (s(b)) {
                    var c = L.find(".btn-smscode")
                      , d = L.find(".input-award-smscode");
                    r(b, c, d)
                } else
                    g("请输入正确的手机号码！")
            }),
            R.off().on(N, function(a) {
                a.preventDefault(),
                n(function() {
                    i && (O.event = "giveupEvent",
                    O.result = 0,
                    i(O))
                })
            })
        ...
        function q(a) {
            M && clearInterval(M),
            a.html("获取验证码"),
            a.css("background-color", f),
            a.css("color", "#fff")
        }
        function r(a, b, c) {
            if (0 === S) {
                var d = w.getInteractServiceHost()
                  , e = w.getWsiteGuid();
                h(d, e, a, "", function(a) {
                    a.isVerify && p(b)
                })
        ...
        function u(a) {
            ...
            if (a) {
                ...
                for (var d = 0; d < c.length; d++)
                    ("true" == c[d].display || c[d].display === !0) && b.push(c[d])
            }
            return b
        }
        function v() {
            for (var a = [], b = G, c = "", d = 0; d < b.length; d++) {
                var e = L.find(".input-award-" + b[d].id)
                  , f = e.val().trim();
                if (!f)
                    return g(b[d].name + "不能为空"),
                    !1;
                if ("telephone" === b[d].type) {
                    if (!s(f))
                        return g("输入的手机号码格式不正确！"),
                        !1;
                    if ("true" === b[d].smscode) {
                        var h = L.find(".input-award-smscode");
                        if ("" === $.trim(h.val()))
                            return g("验证码不能为空！"),
                            !1;
                        c = {},
                        c.sendPhone = f,
                        c.codeValue = h.val().trim()
                    }
                }
                if ("mail" === b[d].type) {
                    var i = /^(\S)+@([a-zA-Z0-9_-])+((\.[a-zA-Z0-9_-]{2,3}){1,2})$/;
                    if (!i.test(f))
                        return g("输入的邮箱格式不正确！"),
                        !1
                }
        ...
        var J = l.leftTime || ""
          ...
          , L = x.find("." + z);
        0 === L.length && (x.append(A),
        L = x.find("." + z)),
        L.html(K);
        var M, N = "click", O = {
            event: "closeEvent",
            result: 0
        }, P = L.find(".submit-form"), Q = L.find(".btn-smscode"), R = L.find(".closeBtn"), S = 0;
        o(),
        m(),
        a.wxInputFocusEvent(L.find("input[type=text],input[type=tel]")),
        a.wxInputFocusEvent(L.find("textarea"))
    }
    function v(a, b, c, d, e, f, g) {
        function h(c) {
            if ("submitEvent" == c.event) {
                var d = c.result
                  , f = a.getInteractServiceHost()
                  , g = a.getWsiteGuid()
                  , h = a.weixinStrong.getIdentifyId()
                  , i = {
                    wsiteGuid: g,
                    activeGuid: b,
                    identify: h,
                ...
                "giveupEvent" == c.event && e && (k.event = "closeEvent",
                k.result = 0,
                e(k))
        }
        function j(b, c, g, h) {
            h && (h.fg = a.getFg());
            var l = {
                wsiteGuid: h.wsiteGuid,
                activeGuid: h.activeGuid,
                identify: h.identify,
                awardInfo: h.awardInfo,
                smsData: h.smsData
            };
            $.post(b + "generalPrize/PresetApply", {
                form: l
            }, function(l) {
                if (0 === l.result)
                    e && (k.event = "okEvent",
                    k.result = 0,
                    e(k)),
                    h.closeCallBack && h.closeCallBack();
                else {
                    if (4500 == l.result) {
                        var m = a.getInteractServiceHost();
                        return void i(m, g, c, function(a) {
                            a && a.isVerify ? j(b, c, g, h) : (k.event = "closeEvent",
                            e(k))
                        })
                    }
                    k.result = l.msg,
                    f || w(a, l.msg, d),
                    e && (k.event = "errorEvent",
                    e(k))
                }
            })
        }
    ...
    function w(a, c, e, f, g, h) {
        function i() {
            y.find(".content-info-inner").html(c),
            y.find(".dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
            y.show()
        }
        function j(a) {
            y.find(".dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
            setTimeout(function() {
                y.hide(),
                a && a()
            }, 600)
        ...
        function k() {
            ...
            D.off().on(z, function(a) {
                a.preventDefault(),
                j(function() {
                    f && (A.event = "closeEvent",
                    A.result = 0,
                    f(A))
                })
            })
        ...
        var l = a;
        l.checkIsThirdAppNoLogin() && (c.indexOf("微信授权失败") > -1 || c.indexOf("请在微信里打开") > -1) && (c = l.getWsiteNoAuthedMsg());
        var m = l.getWsiteCanvas().find(".pt-inner")
          , n = a.getLibHost()
          , o = "rrx-prizeinfo-dialog"
          , p = '<div class="' + o + '"></div>'
          , q = '<div class="dialog-content" style="{{dialogBorder}}"><div class="content-close"><img class="content-close-img" src="{{closeImage}}"></div><div class="content-info"><div class="content-info-inner" style="color:{{textColor}}"></div></div><div class="content-action btn-border-40" style="{{actionCss}}">{{btn}}</div></div>\n'
          , r = "background-color:#fff;border:4px solid  " + e + " ;"
          , s = d(e, .4)
          , t = "background-color:" + e + ";box-shadow: 2px 12px 1Px " + s + " ;"
          , u = n + "weplus/image/close.png"
          , v = e
          , w = C.knowBtn;
        g && h ? w = b(C.changeLinkBtn, {
            linkUrl: h,
            linkName: g
        }) : g && (w = b(C.customerBtn, {
            linkName: g
        ...
        var z = "click"
          ...
          , B = y.find(".content-action")
          , D = y.find(".content-close-img");
        k(),
        i()
    }
    function x(a, e, f, g) {
        function h() {
            z.find(".dialog-content-left svg path").css({
                fill: f
            }),
            z.find(".dialog-content-left svg  g path").css({
                fill: "#fff"
            }),
            z.find(".dialog-content-info-text-title").css({
                color: f
            }),
            x && (z.find(".detail-text")[0].innerText = x),
            z.find(".prizedetail-dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
            z.show()
        }
        function i(a) {
            z.find(".prizedetail-dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
            setTimeout(function() {
                z.hide(),
                a && a()
            }, 600)
        ...
        function j() {
            D.off().on(A, function(a) {
                a.preventDefault(),
                i(function() {
                    g && (B.event = "closeEvent",
                    B.result = 0,
                    g(B))
                })
            })
    ...
    function y(a, d, e, f, g) {
        function h() {
            p.find(".dialog-content").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
            p.find(".content-close").removeClass("bounceOutUpAni").addClass("bounceInUpAni"),
            p.show()
        }
        function i(a) {
            p.find(".dialog-content").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
            p.find(".content-close").removeClass("bounceInUpAni").addClass("bounceOutUpAni"),
            setTimeout(function() {
                p.hide(),
                a && a()
            }, 600)
        ...
        var k = a.getWsiteCanvas().find(".pt-inner")
          , l = a.getLibHost()
          , m = l + "weplus/image/close.png"
          , n = "rrx-common-dialog"
          , o = '<div class="{{basicCss}}"><div class="content-close"><img class="content-close-img" src="{{closeIcon}}"></div><div class="dialog-content bounceInUpAni"><div class="dialog-content-head" style="color:{{baseColor}}">{{name}}</div><div class="dialog-content-box"><div class="scroll-list"><div class="content-list">  {{content}}</div></div></div></div></div>'
          , p = k.find("." + n)
          , q = g || "我的奖品";
        if (0 === p.length) {
            var r = b(o, {
            ...
            p.find(".scroll-list .content-list").html(d.content);
        var s = "click"
          , t = p.find(".content-close");
        return j(),
        h(),
        c(p.find(".dialog-content-box").get(0)),
        {
            closeEvent: i
        }
    }
    function z(a, c) {
        var d = !0
          , e = '<div id="win-alert-plugin-msg-dialog"></div>'
          , f = '<div class="info-dialog-box"><div class="info-content">{{title}}</div><div class="info-btn"><a style="{{cancelStyle}}" class="info-btn-cancel" href="javascript:void(0)">不开启</a> {{if isConfirm}} <a class="info-btn-ok" href="javascript:void(0)">开启</a> {{/if}}</div></div>\n'
          , g = b(f, {
            title: a,
            isConfirm: void 0 === d ? !1 : d,
            cancelStyle: d ? "color:#808080" : "color:#36ADF9"
        })
          , h = $("#win-alert-plugin-msg-dialog");
        0 === h.length && ($("#main").append(e),
        h = $("#win-alert-plugin-msg-dialog")),
        h.html(g),
        h.show(),
    ...
    function B(a, c, d) {
        ...
        l && -1 === l.indexOf("://") && (l = k + l);
        var m = c.callback;
        (null === m || void 0 === m) && (m = function() {
            a.showPluginMsgButton()
        }
        );
        var n = "rrx-plugin-msg-dialog"
          , o = '<div  class="rrx-plugin-msg-dialog"><div class="content-close"><img class="content-close-img" src="{{closeIcon}}"></div><div class="dialog-content bounceInUpAni"><div class="dialog-content-head" style="color:{{baseColor}}">开启提醒</div><div class="dialog-content-box"><div class="tips1">关注公众号，活动消息提醒</div><div class="qr-box"><img src="{{qr}}" alt="二维码"></div><div class="tips2">长按识别图中二维码关注</div></div></div></div>'
          , p = h.find("." + n);
        if (0 === p.length) {
            var q = b(o, {
                closeIcon: j,
    ...
    a.wxInputFocusEvent = function(a) {
        var b = navigator.userAgent.toLowerCase();
        b.indexOf("iphone") > -1 && a.off("blur").on("blur", function() {
            var a = "__wx-reset-input"
            ...
            b.id = a,
            void 0 !== document.body && void 0 !== document.body.prepend && document.body.prepend(b)),
            b.focus(),
            b.blur()
        })
    }
    ...
    a.winAlert = g,
    a.verifyAlert = h,
    a.verifyLotteryAlert = i,
    a.verifyActiveAlert = j,
    a.showRRXProcess = m,
    a.hideRRXProcess = n,
    a.showRRXTips = o,
    a.hideRRXTips = p,
    a.showRRXAfterOnlineDialog = q,
    a.showRRXWxPuplicDialog = r,
    a.showRRXWinPrizeDialog = s,
    a.showRRXNoPrizeDialog = t,
    a.showRRXGetPrizeDialog = u,
    a.showRRXPresetFormDialog = v,
    a.showRRXPrizeInfoDialog = w,
    a.showRRXPrizeDetailDialog = x,
    a.showRRXCommonDialog = y,
    a.showRRxPluginMsgDialog = A,
    a.createRRxPluginMsgDialog = B,
    a.showAlertPluginMsg = z,
    a.fnColorThin = d,
    a.compileHtml = b;
    var C = {
        customerBtn: '<a href="javascript:void(0)" target="_blank" style="color: #fff;font-weight: bold;font-size: 44px;text-decoration: none;">{{linkName}}</a>',
...
function() {
    function a(a) {
        if (a) {
            if (a.indexOf(".qlogo.cn") > -1)
                return a.indexOf("?") > -1 ? a + "&v=" + c() : a + "?v=" + c();
            var b = a.indexOf("?");
            b > -1 && (a = a.substr(0, b));
            var d = a.indexOf("@!");
            return d > -1 && (a = a.substr(0, d)),
            a + K + "?v=" + c()
        }
        return x
    }
    ...
    function d() {
        ...
        y.setAttribute("id", "rrxiuSharePosterBgCanvas"),
        z = y.getContext("2d")
    }
    function e() {
        D = {
    ...
    function i() {
        L = !0,
        L ? (G = b(G),
        Cool.util.loadImage(G, function(a) {
            return a ? void Cool.util.loadImage(x, function(b) {
                return b ? void j(b, a) : (console.error("load image error !!"),
                void (u.callback && u.callback({
                    code: 1,
                    msg: "load image error !!"
                })))
            }) : (console.error("load bgImg error !!"),
            void (u.callback && u.callback({
                code: 1,
                msg: "load bgImg error !!"
            })))
        })) : Cool.util.loadImage(x, function(a) {
            return a ? void j(a, a) : (console.error("load image error !!"),
            void (u.callback && u.callback({
                code: 1,
                msg: "load image error !!"
            })))
    ...
    function j(a, b) {
        if (!a)
            return console.error("load image error !!"),
            void (u.callback && u.callback({
                code: 1,
                msg: "load image error !!"
            }));
        if (!b)
            return console.error("load bgImg error !!"),
            void (u.callback && u.callback({
                code: 1,
                msg: "load bgImg error !!"
            }));
        ...
        y.height = D.height * w,
        y.fillStyle = "#fff",
        y.style = "display:none;left:0;bottom:0;position:absolute;",
        z.drawImage(b, 0, 0, y.width, y.height),
        H && (bgHandle = StackBlur.canvasRGB(y, 0, 0, y.width, y.height, 50)),
        H && (z.fillStyle = "rgba(0,0,0,0.6)",
        z.fillRect(0, 0, y.width, y.height)),
        u.sharePosterBgImgCustomed || (k(c, a, y.width, y.height),
        l(c, y.width, y.height)),
        p(c, y.width, y.height),
        m(c, y.width, y.height)
    }
    function k(a, b, c, d) {
        var e = 216 * a * w
          , f = 216 * a * w
          , h = 113 * a * w
          , i = (c - e) / 2;
        z.fillStyle = "rgba(255,255,255,0.25)",
        z.fillRect(i, h, e, f);
        var j = 8 * a * w
          , k = 200 * a * w
          , l = 200 * a * w
        ...
        if (o.needHandle) {
            ...
            if ("cut" === o.handType) {
                var s = o.width
                  , t = o.width;
                o.width > o.height && (s = o.height,
                t = o.height),
                z.drawImage(p, 0, r, s, t, m, n, k, l)
            } else
                r = (o.width - k) / 2,
                z.drawImage(p, r, 0, k, l, m, n, k, l);
            q.clearRect(0, 0, o.width, o.height)
        } else
            z.drawImage(b, m, n, k, l)
    }
    function l(a, b, c) {
        var d = 36 * a * w
          , e = "Arial"
    ...
    function m(a, b, c) {
        ...
        z.fillRect(i, g, d, e);
        {
            var j = 150 * a * w
              ...
              , p = g + l;
            r(C, j, k, function(a) {
                a ? (z.drawImage(a, m, p, j, k),
                u.base64 ? u.callback && u.callback({
                    code: 0,
                    msg: "ok",
                    imgFormat: "base64",
    ...
    function p(a, b, c) {
        ...
        for (var l = 0; l < d.length; l++)
            g += z.measureText(d[l]).width;
        var m = b - h - g / 2;
        z.fillText(d, m, k)
    }
    function q(a, b, c, d, e, f, g) {
        for (var h = 0, i = 0, j = 0; j < b.length; j++)
            h += a.measureText(b[j]).width,
            h > f && (a.fillText(b.substring(i, j), c, d),
            d += e + g,
            h = 0,
            i = j),
            j == b.length - 1 && a.fillText(b.substring(i, j + 1), c, d);
        return d
    }
    function r(a, b, c, d) {
        var e = s(a, b, c)
          , f = new Image;
        return f.src = e,
        f.complete ? void d(f) : (f.onload = function() {
            d(f)
        }
        ,
    ...
    var u, v = 4, w = 3, x = "https://file2.rrxh5.cc/logo_blue_200x200.jpg", y = null, z = null, A = "", B = "", C = "https://www.rrxiu.net", D = {}, E = $("#main"), F = "", G = "", H = !1, I = "", J = "", K = "@!300x300", L = !0;
    rrxSharePosterCreator = function(b) {
        ...
        C = b.shareUrl || C,
        x = a(b.shareImg),
        b.sharePosterBgImg ? (G = b.sharePosterBgImg,
        H = !1) : (G = x,
        H = !0),
        console.log("ss", x),
        console.log("sp", G),
        J = b.wsiteGuid,
        I = hex_md5(v + J + A + B + x + C + G),
        d(),
        e(),
        f()
    }
