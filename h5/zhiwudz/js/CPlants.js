var CPlants = NewO({
    ...
    oStarfruit = InheritO(CPlants, {
        ...
        beAttackedPointR: 57,
        SunNum: 125,
        PicArr: ["images/Card/Plants/Starfruit.png", "images/Card/Plants/StarfruitG.png",
                "images/Plants/Starfruit/Starfruit.gif", "images/Plants/Starfruit/Star.gif"],
        Tooltip: "向五个方向发射小杨桃",
        ...
        PrivateBirth: function (d) {
            ...
            d.BulletEle = NewImg(0, "images/Plants/Starfruit/Star.gif", "left:" + b + "px;top:" + a + "px;z-index:" + (
                d.zIndex + 2))
        },
        PrivateDie: function (a) {
            a.BulletEle = null
    ...
    oPeashooter = InheritO(CPlants, {
        ...
        SunNum: 100,
        BKind: 0,
        PicArr: ["images/Card/Plants/Peashooter.png", "images/Card/Plants/PeashooterG.png",
                "images/Plants/Peashooter/Peashooter.gif", "images/Plants/PB00.gif", "images/Plants/PeaBulletHit.gif"],
        Tooltip: "向敌人射出豌豆",
        ...
        PrivateBirth: function (c) {
            ...
            c.BulletEle = NewImg(0, c.PicArr[3], "left:" + a + "px;top:" + (c.pixelTop + 3) +
                "px;display:none;z-index:" + (c.zIndex + 2))
        },
        PrivateDie: function (a) {
            a.BulletEle = null
        },
    ...
    oSnowPea = InheritO(oPeashooter, {
        ...
        SunNum: 175,
        BKind: -1,
        PicArr: ["images/Card/Plants/SnowPea.png", "images/Card/Plants/SnowPeaG.png",
                "images/Plants/SnowPea/SnowPea.gif", "images/Plants/PB-10.gif", "images/Plants/PeaBulletHit.gif"],
    ...
    oRepeater = InheritO(oPeashooter, {
        ...
        beAttackedPointR: 53,
        SunNum: 200,
        PicArr: ["images/Card/Plants/Repeater.png", "images/Card/Plants/RepeaterG.png",
                "images/Plants/Repeater/Repeater.gif", "images/Plants/PB00.gif", "images/Plants/PeaBulletHit.gif"],
        Tooltip: "一次发射两颗豌豆",
    ...
    oThreepeater = InheritO(oPeashooter, {
        ...
        beAttackedPointR: 53,
        SunNum: 325,
        PicArr: ["images/Card/Plants/Threepeater.png", "images/Card/Plants/ThreepeaterG.png",
                "images/Plants/Threepeater/Threepeater.gif", "images/Plants/PB00.gif", "images/Plants/PeaBulletHit.gif"],
        Tooltip: "一次射出三行的豌豆",
        ...
        PrivateBirth: function (f) {
            ...
            for (b in c) {
                ...
                f.BulletEle.push(NewImg(0, "images/Plants/PB00.gif", "left:" + d + "px;top:" + (GetY(b) - 50) +
                    "px;display:none;z-index:" + (3 * b + 2)))
            }
        },
        PrivateDie: function (a) {
    ...
    oGatlingPea = InheritO(oPeashooter, {
        ...
        SunNum: 250,
        coolTime: 50000,
        PicArr: ["images/Card/Plants/GatlingPea.png", "images/Card/Plants/GatlingPeaG.png",
                "images/Plants/GatlingPea/GatlingPea.gif", "images/Plants/PB00.gif", "images/Plants/PeaBulletHit.gif"],
        ...
        PrivateBirth: function (c) {
            ...
            c.BulletEle = NewImg(0, c.PicArr[3], "left:" + a + "px;top:" + (c.pixelTop + 8) +
                "px;display:none;z-index:" + (c.zIndex + 2))
        },
    ...
    oSplitPea = InheritO(oPeashooter, {
        ...
        beAttackedPointR: 72,
        SunNum: 125,
        PicArr: ["images/Card/Plants/SplitPea.png", "images/Card/Plants/SplitPeaG.png",
                "images/Plants/SplitPea/SplitPea.gif", "images/Plants/PB00.gif", "images/Plants/PB01.gif",
    ...
    oSunFlower = InheritO(CPlants, {
        ...
        beAttackedPointR: 53,
        SunNum: 50,
        PicArr: ["images/Card/Plants/SunFlower.png", "images/Card/Plants/SunFlowerG.png",
        ...
        PrivateBirth: function (a) {
            oSym.addTask(600, function (d, c, b) {
                $P[d] && (AppearSun(Math.floor(c + Math.random() * 41), b, 25, 0), oSym.addTask(2400, arguments.callee, [
                        d, c, b]))
    ...
    oTwinSunflower = InheritO(oSunFlower, {
        ...
        SunNum: 150,
        coolTime: 50000,
        PicArr: ["images/Card/Plants/TwinSunflower.png", "images/Card/Plants/TwinSunflowerG.png",
        ...
        PrivateBirth: function (a) {
            ...
            oSym.addTask(600, function (f, d, c, e) {
                $P[f] && (AppearSun(d, e, 25, 0), AppearSun(c, e, 25, 0), oSym.addTask(2400, arguments.callee, [f, d, c,
                        e]))
    ...
    oPumpkinHead = InheritO(CPlants, {
        ...
        coolTime: 30000,
        zIndex: 1,
        PicArr: ["images/Card/Plants/PumpkinHead.png", "images/Card/Plants/PumpkinHeadG.png",
                "images/Plants/PumpkinHead/PumpkinHead.gif", "images/Plants/PumpkinHead/PumpkinHead1.gif",
                "images/Plants/PumpkinHead/PumpkinHead2.gif", "images/Plants/PumpkinHead/pumpkin_damage1.gif",
                "images/Plants/PumpkinHead/pumpkin_damage2.gif", "images/Plants/PumpkinHead/Pumpkin_back.gif"],
        Tooltip: "能保护种在里面的植物",
        ...
        getHurt: function (e, c, b) {
            ...
            case d.HP < 2667:
                d.HurtStatus < 1 && (d.HurtStatus = 1, a.childNodes[1].src =
                    "images/Plants/PumpkinHead/pumpkin_damage1.gif", $(f + "_2").src =
        ...
        BirthStyle: function (c, d, b, a) {
            ...
            NewImg(d + "_2", "images/Plants/PumpkinHead/PumpkinHead2.gif", "left:" + c.pixelLeft + "px;top:" + c.pixelTop +
                "px;z-index:" + (c.zIndex - 2), EDAll)
        },
        PrivateDie: function (a) {
            ClearChild($(a.id + "_2"))
        }
    ...
    oFlowerPot = InheritO(CPlants, {
        ...
        beAttackedPointR: 52,
        SunNum: 25,
        PicArr: ["images/Card/Plants/FlowerPot.png", "images/Card/Plants/FlowerPotG.png",
        ...
        CanGrow: function (e, d, f) {
            var c = d + "_" + f,
                b = oGd.$LF[d],
                a = f < 1 || f > 9;
            return b % 2 ? b < 3 ? !(a || e[1] || e[2] || e[0] || oGd.$Crater[c] || oGd.$Tombstones[c]) : !(a || e[0] ||
                oGd.$Crater[c]) : 0
        },
        Tooltip: "可以让植物栽种在屋顶上",
    ...
    oLilyPad = InheritO(oFlowerPot, {
        ...
        height: 58,
        beAttackedPointR: 59,
        PicArr: ["images/Card/Plants/LilyPad.png", "images/Card/Plants/LilyPadG.png",
    ...
    oPotatoMine = InheritO(CPlants, {
        ...
        CanGrow: function (d, c, e) {
            var b = c + "_" + e,
                a = oGd.$LF[c];
            return a % 2 ? a < 3 ? !(e < 1 || e > 9 || d[1] || oGd.$Crater[b] || oGd.$Tombstones[b]) : d[0] && !d[1] :
                0
        },
        PicArr: ["images/Card/Plants/PotatoMine.png", "images/Card/Plants/PotatoMineG.png",
                "images/Plants/PotatoMine/PotatoMine.gif", "images/Plants/PotatoMine/PotatoMineNotReady.gif",
                "images/Plants/PotatoMine/PotatoMine_mashed.gif", "images/Plants/PotatoMine/ExplosionSpudow.gif"],
        ...
        PrivateBirth: function (a) {
            oSym.addTask(1500, function (c) {
                var b = $P[c];
                b && ($(c).childNodes[1].src = "images/Plants/PotatoMine/PotatoMine.gif", b.Status = 1, b.canTrigger =
                    1, b.getHurt = function (g, e, d) {
                    var f = this;
        ...
        TriggerCheck: function (e, c) {
            var a = this.R,
                b = this.C;
            e.beAttacked && e.Altitude < 2 && !oGd.$[a + "_" + b + "_2"] && this.NormalAttack(this.pixelLeft, this.pixelLeft +
                this.width, this.R)
        },
    ...
    oTorchwood = InheritO(CPlants, {
        ...
        beAttackedPointR: 53,
        SunNum: 175,
        PicArr: ["images/Card/Plants/Torchwood.png", "images/Card/Plants/TorchwoodG.png",
                "images/Plants/Torchwood/Torchwood.gif", "images/Plants/PB00.gif", "images/Plants/PB01.gif",
                "images/Plants/PB10.gif", "images/Plants/PB11.gif", "images/Plants/Torchwood/SputteringFire.gif"],
    ...
    oWallNut = InheritO(CPlants, {
        ...
        HP: 4000,
        coolTime: 30000,
        PicArr: ["images/Card/Plants/WallNut.png", "images/Card/Plants/WallNutG.png",
                "images/Plants/WallNut/WallNut.gif", "images/Plants/WallNut/Wallnut_cracked1.gif",
        ...
        CanGrow: function (c, b, e) {
            var a = b + "_" + e,
                d = c[1];
            return d && d.EName == "oWallNut" ? 1 : oGd.$LF[b] == 1 ? !(e < 1 || e > 9 || oGd.$Crater[a] || oGd.$Tombstones[
                a] || d) : c[0] && !d
        },
        InitTrigger: function () {},
        HurtStatus: 0,
        getHurt: function (e, b, a) {
            ...
            !(b % 3) ? (c.HP -= a) < 1 ? c.Die() : c.HP < 1334 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src =
                "images/Plants/WallNut/Wallnut_cracked2.gif") : c.HP < 2667 && c.HurtStatus < 1 && (c.HurtStatus = 1, d
                .src = "images/Plants/WallNut/Wallnut_cracked1.gif") : c.Die(1)
        }
    }),
    oTallNut = InheritO(oWallNut, {
        ...
        SunNum: 125,
        HP: 8000,
        PicArr: ["images/Card/Plants/TallNut.png", "images/Card/Plants/TallNutG.png",
        ...
        CanGrow: function (c, b, e) {
            var a = b + "_" + e,
                d = c[1];
            return d && d.EName == "oTallNut" ? 1 : oGd.$LF[b] == 1 ? !(e < 1 || e > 9 || oGd.$Crater[a] || oGd.$Tombstones[
                a] || d) : c[0] && !d
        },
        Stature: 1,
        getHurt: function (e, b, a) {
            var c = this,
                d = $(c.id).childNodes[1];
            !(b % 3) ? (c.HP -= a) < 1 ? c.Die() : c.HP < 2667 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src =
                "images/Plants/TallNut/TallnutCracked2.gif") : c.HP < 5333 && c.HurtStatus < 1 && (c.HurtStatus = 1, d.src =
                "images/Plants/TallNut/TallnutCracked1.gif") : c.Die(1)
        }
    }),
    oCherryBomb = InheritO(CPlants, {
        ...
        SunNum: 150,
        coolTime: 50000,
        PicArr: ["images/Card/Plants/CherryBomb.png", "images/Card/Plants/CherryBombG.png",
                "images/Plants/CherryBomb/CherryBomb.gif", "images/Plants/CherryBomb/Boom.gif"],
    ...
    oJalapeno = InheritO(oCherryBomb, {
        ...
        height: 89,
        beAttackedPointR: 48,
        PicArr: ["images/Card/Plants/Jalapeno.png", "images/Card/Plants/JalapenoG.png",
                "images/Plants/Jalapeno/Jalapeno.gif", "images/Plants/Jalapeno/JalapenoAttack.gif"],
        Tooltip: "消灭整行的敌人",
    ...
    oSpikeweed = InheritO(CPlants, {
        ...
        Stature: -1,
        canEat: 0,
        PicArr: ["images/Card/Plants/Spikeweed.png", "images/Card/Plants/SpikeweedG.png",
        ...
        getHurt: function (d, b, a) {
            var c = this;
            !(b % 3) ? (c.HP -= a) < 1 && c.Die() : b < 2 ? (d.getHurt(1, 0, 20, 0, 0, 0, 0), c.Die(1)) : (d.HP = d.BreakPoint,
                d.GoingDie(), c.Die())
        },
        ...
        TriggerCheck: function (i, h) {
            var c = i.id,
                g = this.ArZ,
                a, b, e, f;
            !g[c] && (a = i.AttackedLX, b = i.AttackedRX, e = this.AttackedLX, f = this.AttackedRX, a <= f && a >= e ||
                b <= f && b >= e || a <= e && b >= f) && this.AttackCheck2(i) && (g[c] = 1, this.NormalAttack(c), oSym.addTask(
                100, function (d, j) {
                var k = $P[d];
                k && delete k.ArZ[j]
            }, [this.id, c]))
    ...
    oSpikerock = InheritO(oSpikeweed, {
        ...
        SunNum: 125,
        coolTime: 50000,
        PicArr: ["images/Card/Plants/Spikerock.png", "images/Card/Plants/SpikerockG.png",
    ...
    oGarlic = InheritO(CPlants, {
        ...
        SunNum: 50,
        HP: 400,
        PicArr: ["images/Card/Plants/Garlic.png", "images/Card/Plants/GarlicG.png", "images/Plants/Garlic/Garlic.gif",
                "images/Plants/Garlic/Garlic_body2.gif", "images/Plants/Garlic/Garlic_body3.gif"],
        Tooltip: "将僵尸赶到其它的横行",
        ...
        CanGrow: function (c, b, e) {
            var a = b + "_" + e,
                d = c[1];
            return d && d.EName == "oGarlic" ? 1 : oGd.$LF[b] == 1 ? !(e < 1 || e > 9 || oGd.$Crater[a] || oGd.$Tombstones[
                a] || d) : c[0] && !d
        },
        InitTrigger: function () {},
        HurtStatus: 0,
        getHurt: function (e, b, a) {
            var c = this,
                d = $(c.id).childNodes[1];
            !(b % 3) ? (c.HP -= 20) < 1 ? c.Die() : (c.ChangeR(c, e), c.HP < 134 ? c.HurtStatus < 2 && (c.HurtStatus =
                2, d.src = "images/Plants/Garlic/Garlic_body3.gif") : c.HP < 267 && c.HurtStatus < 1 && (c.HurtStatus =
                1, d.src = "images/Plants/Garlic/Garlic_body2.gif")) : c.Die(1)
        },
    ...
    oSquash = InheritO(CPlants, {
        ...
        SunNum: 50,
        coolTime: 30000,
        PicArr: ["images/Card/Plants/Squash.png", "images/Card/Plants/SquashG.png", "images/Plants/Squash/Squash.gif",
    ...
    oChomper = InheritO(CPlants, {
        ...
        beAttackedPointR: 70,
        SunNum: 150,
        PicArr: ["images/Card/Plants/Chomper.png", "images/Card/Plants/ChomperG.png",
                "images/Plants/Chomper/Chomper.gif", "images/Plants/Chomper/ChomperAttack.gif",
        ...
        NormalAttack: function (a, b) {
            ...
            oSym.addTask(70, function (c, d) {
                ...
                $P[c] && ((e = $Z[d]) && e.beAttacked ? oSym.addTask(18, function (f) {
                    ...
                    }, [f]), "images/Plants/Chomper/ChomperDigest.gif") : (g.canTrigger = 1,
    ...
    oFumeShroom = InheritO(CPlants, {
        ...
        SunNum: 75,
        SleepGif: 3,
        PicArr: ["images/Card/Plants/FumeShroom.png", "images/Card/Plants/FumeShroomG.png",
                "images/Plants/FumeShroom/FumeShroom.gif", "images/Plants/FumeShroom/FumeShroomSleep.gif",
                "images/Plants/FumeShroom/FumeShroomAttack.gif", "images/Plants/FumeShroom/FumeShroomBullet.gif"],
        Tooltip: "喷射可以穿过门板的气液",
        ...
        PrivateBirth: function (b) {
            var a = b.id;
            NewEle(a + "_Bullet", "div", "position:absolute;display:none;width:343px;height:62px;left:" + b.AttackedRX +
                "px;top:" + (b.pixelTop + 5) +
                "px;background:url(images/Plants/FumeShroom/FumeShroomBullet.gif);z-index:" + (b.zIndex + 1), 0, EDAll)
        },
        PrivateDie: function (a) {
        ...
        NormalAttack: function () {
            ...
            SetBlock($(a));
            ImgSpriter(a, c, [["0 0", 90, 1], ["0 -62px", 90, 2], ["0 -124px", 90, 3], ["0 -186px", 90, 4], ["0 -248px",
                        90, 5], ["0 -310px", 90, 6], ["0 -372px", 90, 7], ["0 -434px", 90, -1]], 0, function (i, j) {
                var h = $(j);
    ...
    oCoffeeBean = InheritO(CPlants, {
        ...
        PKind: 3,
        canEat: 0,
        PicArr: ["images/Card/Plants/CoffeeBean.png", "images/Card/Plants/CoffeeBeanG.png",
        ...
        PrivateBirth: function (a) {
            oSym.addTask(240, function (c) {
                var d = oGd.$[c],
                    b;
                d && (b = d.WakeUP, (!b ? ($(d.id).childNodes[1].src = d.PicArr[d.NormalGif], d.canTrigger = 1, d.Sleep =
                    0) : b(d)));
                a.Die()
            }, [a.R + "_" + a.C + "_1"])
        }
    ...
    oGloomShroom = InheritO(oFumeShroom, {
        ...
        SunNum: 150,
        coolTime: 50000,
        PicArr: ["images/Card/Plants/GloomShroom.png", "images/Card/Plants/GloomShroomG.png",
                "images/Plants/GloomShroom/GloomShroom.gif", "images/Plants/GloomShroom/GloomShroomSleep.gif",
                "images/Plants/GloomShroom/GloomShroomAttack.gif", "images/Plants/GloomShroom/GloomShroomBullet.gif"],
        ...
        PrivateBirth: function (b) {
            var a = b.id;
            NewEle(a + "_Bullet", "div", "position:absolute;display:none;width:210px;height:200px;left:" + (b.pixelLeft -
                60) + "px;top:" + (b.pixelTop - 65) +
                "px;background:url(images/Plants/GloomShroom/GloomShroomBullet.gif);z-index:" + (b.zIndex + 1), 0,
                EDAll)
        },
        PrivateDie: function (a) {
            ClearChild($(a.id + "_Bullet"))
        ...
        NormalAttack: function () {
            ...
            SetBlock($(l));
            ImgSpriter(l, j, [["0 0", 90, 1], ["0 -200px", 90, 2], ["0 -400px", 90, 3], ["0 -600px", 90, 4], [
                        "0 -800px", 90, 5], ["0 -1000px", 90, 6], ["0 -1200px", 90, 7], ["0 -1400px", 90, 8], [
                        "0 -1600px", 90, 9], ["0 -1800px", 90, 10], ["0 -2000px", 90, 11], ["0 -2200px", 90, -1]], 0, function (
                m, n) {
                var i = $(n);
    ...
    oPuffShroom = InheritO(oFumeShroom, {
        ...
        SunNum: 0,
        Stature: -1,
        PicArr: ["images/Card/Plants/PuffShroom.png", "images/Card/Plants/PuffShroomG.png",
                "images/Plants/PuffShroom/PuffShroom.gif", "images/Plants/PuffShroom/PuffShroomSleep.gif",
                "images/Plants/ShroomBullet.gif", "images/Plants/ShroomBulletHit.gif"],
        Tooltip: "向敌人发射短程孢子",
        ...
        PrivateBirth: function (c) {
            ...
            c.BulletEle = NewImg(0, "images/Plants/ShroomBullet.gif", "left:" + a + "px;top:" + (c.pixelTop + 40) +
                "px;display:none;z-index:" + (c.zIndex + 2))
        },
        PrivateDie: function (a) {
            a.BulletEle = null
    ...
    oScaredyShroom = InheritO(oFumeShroom, {
        ...
        ArZ: [],
        Attacking: 0,
        PicArr: ["images/Card/Plants/ScaredyShroom.png", "images/Card/Plants/ScaredyShroomG.png",
                "images/Plants/ScaredyShroom/ScaredyShroom.gif", "images/Plants/ScaredyShroom/ScaredyShroomSleep.gif",
                "images/Plants/ScaredyShroom/ScaredyShroomCry.gif", "images/Plants/ShroomBullet.gif",
        ...
        TriggerCheck: function (e, c) {
            var b = this,
                a = b.id;
            Math.abs(e.ZX - b.MX) < 121 && e.beAttacked ? (b.ArZ.push(e.id), !b.Cry && (b.Cry = 1, $(a).childNodes[1].src =
                "images/Plants/ScaredyShroom/ScaredyShroomCry.gif", b.CryCheck(a))) : (!b.Cry && !b.Attacking && e.Altitude >
                0 && e.Altitude < 3 && b.NormalAttack())
        },
        PrivateBirth: function (c) {
            var b = c.AttackedLX,
                a = b - 46;
            ...
            c.BulletEle = NewImg(0, "images/Plants/ShroomBullet.gif", "left:" + a + "px;top:" + (c.pixelTop + 35) +
                "px;display:none;z-index:" + (c.zIndex + 2));
            c.MX = b + 9
        },
        PrivateDie: function (a) {
        ...
        CryCheck: function (a) {
            oSym.addTask(140, function (b) {
                ...
                if (d) {
                    ...
                    f.length ? d.CryCheck(b) : (d.Cry = 0, $(b).childNodes[1].src =
    ...
    oSunShroom = InheritO(oFumeShroom, {
        ...
        Stature: -1,
        Status: 0,
        PicArr: ["images/Card/Plants/SunShroom.png", "images/Card/Plants/SunShroomG.png",
                "images/Plants/SunShroom/SunShroom2.gif", "images/Plants/SunShroom/SunShroomSleep.gif",
        ...
        BirthStyle: function (c, d, b, a) {
            oS.DKind ? (c.canTrigger = 0, c.Sleep = 1, b.childNodes[1].src =
                "images/Plants/SunShroom/SunShroomSleep.gif") : (oSym.addTask(600, function (h, g, f) {
                var e = $P[h];
        ...
        ProduceSun: function (a, c, b) {
            AppearSun(Math.floor(c + Math.random() * 41), b, !a.Status ? 15 : 25, 0), oSym.addTask(2400, function (g, f,
                e) {
                var d = $P[g];
