		...
		div#form-dialog-body.dlg-body
			...
			section
				div#form-dialog-cont
					label(for='form-dialog-uname' id="form-dialog-uname-label" v-html='userName')
					input(type='text' maxlength='20'  v-bind:placeholder='namePlaceholder' id='form-dialog-uname')
					br
					label(for='form-dialog-phone' v-html='userPhone')
					input(type='text' maxlength='12'  v-bind:placeholder='phonePlaceholder' id='form-dialog-phone' required='required')
					br
					label(for='form-dialog-address' v-html='userAddress')
					input(type='text'  v-bind:placeholder='addressPlaceholder' id='form-dialog-address' required='required')
					br
...
export default {
    ...
    methods: {
        showFormDialog: function(dlgMsgObj){
            ...
            this.message = dlgMsgObj.message
            ...
            if(this.message){
                setTimeout(function(){
                    if( $("#form-dialog-body-aware-title").length == 0 ){
                        $("<div id='form-dialog-body-aware-title' class='reponse-text' style='width: 100%;text-align: center;margin: 0 auto;'>" + _this.message + "</div>").insertBefore( $("#form-dialog-uname-label") );
                    }
                }, 100);
            }
